...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "성과급은 별도 분리과세가 아닌 연간 근로소득에 합산되어 누진세율(6~45%)이 적용됩니다. 여기에 지방소득세(소득세의 10%)와 4대보험(국민연금·건강·고용)이 추가로 부과됩니다. 단 국민연금은 보수월액 상한(2026년 기준 연 7,644만원) 이상은 추가 부과 없음. 본 계산기는 연봉+성과급 합산 세금에서 연봉만 기준 세금을 뺀 marginal 방식으로 정확하게 계산합니다.",
  },
  {
