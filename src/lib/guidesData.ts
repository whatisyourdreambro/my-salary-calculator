...
export const guides: Guide[] = [
  ...
  { slug: "year-end-tax-monthly-rent", title: "연말정산 월세 세액공제, A to Z 완벽정리", description: "1년치 월세를 돌려받는 연말정산 월세 세액공제, 조건부터 신청 방법까지 모두 알려드립니다.", category: "세금", tags: ["연말정산", "월세", "세액공제"], level: "중급", publishedDate: "2025-10-29", views: 110456 },
  ...
  { slug: "housing-subscription-savings-priority", title: "주택청약 1순위 조건, 5분 만에 완벽 정복", description: "내 집 마련의 첫걸음, 주택청약 1순위가 되기 위한 모든 조건을 쉽고 빠르게 알려드립니다.", category: "부동산", tags: ["주택청약", "1순위", "내집마련"], level: "초급", publishedDate: "2025-10-28", views: 120345 },
