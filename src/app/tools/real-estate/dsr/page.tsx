...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "변동금리·혼합금리 대출에서 미래 금리 인상 위험을 미리 한도에 반영하는 제도. 2026년 기준 수도권·규제지역 주담대는 3단계(스트레스 금리 3.0%, 적용비율 100%), 비규제 지방 주담대는 2단계(1.5%)입니다. 신용대출 등 기타대출의 스트레스 금리는 1.5%. 즉 명목 금리 4%인 수도권 주담대는 DSR 계산 금리가 7.0%가 되어 한도가 크게 줄어듭니다. 고정금리는 가산 부담이 작습니다. (같은 사이트 /home-loan 안내와 동일 기준 — 2026-09-06 정합)",
  },
  {
