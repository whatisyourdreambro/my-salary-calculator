...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "네, 정기든 비정기든 근로의 대가로 지급되는 모든 금품에는 4대보험이 부과됩니다. 단, 국민연금은 월 637만원 상한이 있어 연봉이 이미 상한을 넘었다면 보너스에 추가 부과되지 않습니다. 산재보험은 사업주 전액 부담이라 근로자가 직접 부담하는 것은 국민연금·건강보험·고용보험 3가지입니다.",
  },
  {
