...
export default function TrafficEnginesNav() {
  return <section className="ms-section border-t border-border bg-card" aria-labelledby="home-salary-research"><div className="page-width">
    <div className="mb-8 max-w-2xl"><p className="ms-eyebrow">보상 정보 탐색</p><h2 id="home-salary-research" className="text-2xl font-semibold tracking-tight sm:text-3xl mt-3">회사·직업·산업·지역별 연봉</h2><p className="ms-description mt-3">비교의 범위를 넓혀 보세요. 실제 제안 금액과 같지 않은 참고 정보이며, 원자료와 추정 여부를 확인해야 합니다.</p></div>
