...
export default function LunchRoulettePage() {
 ...
 {result ? (
 <>
 <p className="text-sm font-bold text-faint-blue uppercase tracking-widest mb-4">RECOMMENDED MENU</p>
 <h2 className={`text-4xl font-black ${isSpinning ? 'text-faint-blue' : 'text-primary'}`}>
 {result}
 </h2>
 </>
 ) : (
 <p className="text-xl font-medium text-faint-blue">버튼을 눌러 추천을 받아보세요.</p>
 )}
 </motion.div>
 </div>
