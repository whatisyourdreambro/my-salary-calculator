            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-20 space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="h-[300px] w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <AreaChart data={salaryData}>
                                        ...
                                        <Area type="monotone" dataKey="base" stroke="#94a3b8" fillOpacity={0.5} fill="transparent" strokeDasharray="5 5" name="기본급" />
                                    </AreaChart>
                                </ResponsiveContainer>
                            </div>
                        ...
                        {/* Life Simulator */}
                        <section className="bg-gradient-to-br from-indigo-900 to-primary/80 text-slate-900 rounded-2xl p-8 shadow-xl relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <p className="text-indigo-200 mb-6">
                                    ...
                                    <span className="text-slate-900 font-bold">테슬라 Model 3</span>를 사는데 얼마나 걸릴까요?
                                </p>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="pt-4 border-t border-border">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <p className="text-xs font-bold text-blue-500 mb-2">PROS 👍</p>
