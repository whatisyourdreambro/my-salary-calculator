...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "벤처기업 임직원이 2027년 12월 31일 이전에 부여받은 스톡옵션의 행사이익은 연 2억원, 벤처기업별 누적 5억원까지 소득세가 비과세됩니다(조세특례제한법 제16조의2, 2023년 행사분부터 적용). 한도를 넘는 행사이익은 근로소득 등으로 합산되어 누진세율이 적용되며, 5년 분할납부 특례(같은 법 제16조의3)를 신청할 수 있습니다. 요건을 갖춘 적격 주식매수선택권은 행사 때 과세하지 않고 주식을 팔 때 양도소득세로 낼 수도 있습니다(제16조의4 과세이연). 이때 세율은 주식 종류와 대주주 여부에 따라 달라, 예컨대 대주주가 아닌 사람이 파는 중소기업 주식은 10%, 그 밖의 주식은 20%입니다(소득세법 제104조, 지방소득세 별도). 일반 기업의 스톡옵션은 이런 특례 없이 근로소득 등으로 합산 과세됩니다.",
  },
  {
        ...
        <div className="max-w-3xl mx-auto">
          <header className="text-center mb-10">
            ...
            <p className="text-lg font-medium text-muted-blue dark:text-canvas-300">
              일반 인센티브 vs <strong className="text-electric">벤처 스톡옵션 과세특례</strong> 비교
            </p>
          </header>
          ...
          <article className="prose prose-sm sm:prose-base dark:prose-invert max-w-none mb-10 mt-10">
            ...
            <p className="text-muted-blue dark:text-canvas-300 leading-relaxed">
              ...
              적용됩니다. 반면 <strong>분리과세</strong>는 인센티브 자체에만 별도 세율을
              적용해 다른 소득과 분리합니다. 한국에서는 적격 벤처 스톡옵션의 과세이연(양도 때
              양도소득세, 예: 20%)이나 퇴직소득처럼 매우 제한된 경우에만 합산에서 빠집니다.
            </p>

            <h2 className="text-2xl font-black text-navy dark:text-canvas-50 mt-8 mb-4">
              벤처기업 스톡옵션 비과세 특례 (조특법 제16조의2)
            </h2>
            <p className="text-muted-blue dark:text-canvas-300 leading-relaxed">
              <strong>벤처기업이 임직원에게 부여한 스톡옵션</strong>의 행사이익은 다음 한도까지
              소득세 비과세 혜택을 받습니다(2023년 행사분부터).
            </p>
            <ul className="space-y-2 text-muted-blue dark:text-canvas-300">
              <li>
                <strong>연 2억원 한도</strong> 비과세 (행사 시점 시가 - 실제 매수가액)
              </li>
              <li>
                <strong>누적 5억원 한도</strong> · 초과분은 합산과세
              </li>
