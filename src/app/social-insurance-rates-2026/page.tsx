...
const FAQ_ITEMS = [
 ...
 {
 question: "건강보험료는 왜 4월에 갑자기 늘어나나요?",
 answer:
 "건강보험료는 작년 보수 기준으로 미리 떼는 임시 금액입니다. 연초에 작년 실제 보수총액이 확정되면 차액이 4월분 보험료에 일시 정산·반영됩니다(직장가입자 연말정산). 작년 임금 인상·성과급이 컸다면 4월 정산금이 큽니다 — 정산액이 당월 보험료 이상이면 12회 이내 분할 납부를 신청할 수 있습니다. 참고로 7월에 월급 공제액이 달라졌다면 건보가 아니라 국민연금 기준소득월액 재산정(매년 7월) 때문입니다.",
 },
 {
 question: "지역가입자 보험료는 어떻게 계산되나요?",
 answer:
 "지역가입자(직장인이 아닌 사람)는 소득에 정률, 재산에 점수제를 적용해 산정합니다(자동차 부과 점수는 2024년 2월 폐지). 자가 1채 + 예금 있으면 월 30~80만 부담. 직장가입자보다 부담 큰 경우가 많아 배우자 피부양자 등재가 유리합니다.",
 },
];
