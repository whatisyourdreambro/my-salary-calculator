...
<li><strong>Q. 국민연금 없어질 수 있나요?</strong> → 제도 자체가 소멸할 가능성은 낮지만, 기금 고갈(보험료율 13% 인상 개혁을 반영한 정부 추계 기준 2064년경) 후에도 부과 방식으로 지속될 예정.</li>
...
`
 },
 {
  ...
  category: "기초",
  tags: ["청년지원", "청년도약계좌", "청년취업지원", "소득세감면", "청년월세", "2026"],
  level: "초급" as const,
  publishedDate: "2026-05-16",
  views: 0,
  content: `
...
<div class="bg-secondary/30 p-6 rounded-xl mt-4 border border-primary/10">
<ul>
<li><strong>대상:</strong> 만 19~34세, 총급여 7,500만원 이하, 가구 중위소득 250% 이하 — <strong>2025년 12월 신규 가입 종료</strong>(아래는 기존 가입자 기준, 새로 시작한다면 2026년 6월 출시 청년미래적금 참고)</li>
<li><strong>납입:</strong> 월 70만원 한도 안에서 자유 납입, 5년 만기</li>
<li><strong>혜택:</strong> 비과세 + 정부 기여금 (소득 낮을수록 더 많이)</li>
<li><strong>정부 기여금:</strong> 총급여 2,400만원 이하는 월 40만원까지 6.0%, 40~70만원 구간 3.0% 매칭 → 월 70만원 납입 시 월 최대 3.3만원 (2025년 1월 납입분부터, 이전에는 월 최대 2.4만원)</li>
<li><strong>특별중도해지 사유:</strong> 퇴직·폐업, 혼인·출산, 생애최초 주택 구입, 장기 치료가 필요한 질병, 사망·해외이주, 천재지변. 2026년 6월부터는 청년미래적금으로 갈아탈 때도 특별중도해지(미래적금 먼저 가입)</li>
</ul>
</div>
...
<h2>💼 청년내일채움공제 — 2024년 신규 가입 중단 (종료)</h2>
<ul>
<li><strong>현황:</strong> 청년내일채움공제는 <strong>2024년부터 신규 가입이 중단</strong>되어 종료된 제도입니다 (기존 가입자는 만기까지 유지)</li>
<li><strong>기존 구조 (참고):</strong> 청년 400만원 + 정부 400만원 + 기업 400만원 = 2년 1,200만원</li>
<li><strong>대체 제도:</strong> 2026년 6월 22일 출시된 청년미래적금(2차 모집 2026년 12월 예정)과 아래의 중소기업 취업 청년 소득세 감면을 확인하세요. 청년도약계좌 신규 가입은 끝났고, 기존 가입자가 갈아타려면 청년미래적금 계좌를 먼저 개설한 뒤 도약계좌를 해지해야 합니다</li>
</ul>
...
<li>산후조리원 비용 (소득 무관, 출산 1회당 200만원 한도)</li>
<li>대중교통·전통시장·문화체육 사용분 (추가 한도 합산 300만원, 총급여 7천만원 초과는 대중교통·전통시장 200만원)</li>
