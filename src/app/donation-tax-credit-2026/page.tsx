...
// 고향사랑 10만원 초과 20만원 이하 40%(2026-01-01 이후 기부분, 법률 제21223호 부칙 제13조) 반영 2026-09-25 —
//   본문 고향사랑 항목(GuideMidAd 위)은 기존 렌더 높이 이하(320~1280px 전 폭 실측, '전액공제' 제거로 폭 확보).
//   FAQ 9 는 5자 늘었으나 기본 접힘 <details> 안이라 초기 레이아웃 불변.
...
const FAQS = [
  ...
  },
  {
    ...
    a: "두 가지 혜택이 겹칩니다. ① 세액공제 — 10만원까지 100/110 전액공제(지방소득세 포함 10만원 전액 환급 효과), 10만원 초과 20만원 이하 40%, 20만원 초과분 15%, ② 답례품 — 기부액의 30% 이내 지역 특산품 등을 포인트로 받습니다. 즉 10만원을 기부하면 10만원 환급 + 3만원 상당 답례품으로 사실상 3만원 이득입니다. 주민등록 주소지 관할 지자체에는 기부할 수 없고, 연간 기부 상한은 2,000만원입니다.",
  },
  {
  ...
  },
  {
    ...
    a: "소득세법 제59조의4(15%·30%, 유형별 한도), 조세특례제한법 제76조(정치자금 100/110·15%·25%), 조세특례제한법 제58조(고향사랑 100/110·40%·15%) 및 고향사랑 기부금에 관한 법률(연 2,000만원 한도·답례품 30%)의 2026년 9월 기준 현행 규정을 반영했습니다. 근로소득만 있는 근로자를 가정한 간이 계산으로, 우리사주조합기부금·전년도 이월분은 반영하지 않으며 실제 공제액은 연말정산 결과로 확정됩니다.",
  },
];
        ...
        <section className="my-10 prose prose-slate dark:prose-invert max-w-none text-[15px] leading-7 text-muted-blue dark:text-canvas-300">
          ...
          <ol>
            ...
            <li>
              ...
              기부. 연간 <strong>2,000만원 한도</strong>, 10만원까지 100/110,
              20만원까지 40%·초과 15% + <strong>기부액 30% 이내 답례품</strong>을
              별도로 받습니다.
            </li>
          </ol>
