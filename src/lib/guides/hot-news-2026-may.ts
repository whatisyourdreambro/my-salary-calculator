...
<p class="lead">LG에너지솔루션은 2025년 실적 성과급으로 <strong>기본급의 ${LGES_Y25}%</strong>를 2026년 2월 6일 지급했습니다. 2024년 실적분 ${LGES_Y24}%보다 늘었지만, 세 자릿수였던 2022~2023년 실적분에는 크게 못 미칩니다. 2025년 사업보고서 기준 직원 평균 급여는 약 1억 1,200만원(직원 1만2,922명)으로 2023년부터 2년 연속 줄었습니다. 2026년 임금 인상률은 회사나 노조의 공식 발표, 복수 보도로 확인되지 않았습니다. 기준일은 2026년 9월 26일입니다.</p>
...
<tbody>
<tr><td>2025</td><td>1억 1,168만원</td><td>12,922명</td><td>${LGES_Y25}% (2026년 2월 6일 지급)</td></tr>
...
<li><strong>성과급의 바탕이 된 실적</strong> — 회사가 발표한 2025년 연간 실적은 매출 23조 6,718억원, 영업이익 1조 3,461억원입니다. 2026년 2월에 지급된 ${LGES_Y25}%는 이 실적에 대한 성과급입니다.</li>
</ul>
<p>2026년 실적 성과급은 2027년 초 회사 발표로 정해집니다. 그 전에 나오는 지급률 숫자는 전망이므로, 가늠이 필요하면 아래 계산기에서 지급률을 바꿔 보는 편이 안전합니다.</p>

<h2>성과급 ${LGES_Y25}%, 세후로는 얼마인가요</h2>
<p>LG에너지솔루션 성과급은 월 기본급 대비 %입니다. 아래 표는 사이트 <a href="/calc/lg-energy-bonus">LG에너지솔루션 성과급 계산기</a>와 같은 가정(연봉 = 월 기본급 × ${LGES_SALARY_X})으로, 성과급 엔진(2026년 요율, 국민연금 기준소득월액 상한 반영)이 계산한 세후 금액입니다. 본인 기본공제 외의 공제는 넣지 않았습니다.</p>
<div class="overflow-x-auto"><table class="w-full text-sm">
...
<h2>자주 묻는 질문</h2>
<ul>
<li><strong>Q. LG에너지솔루션 성과급은 언제 나오나요?</strong> — 전년 실적 성과급이 이듬해 2월 초에 지급됩니다. 2026년에는 2월 4일 임직원 설명회에서 ${LGES_Y25}%가 안내됐고 2월 6일 지급됐습니다(보도).</li>
<li><strong>Q. 2026년 실적 성과급은 얼마로 예상되나요?</strong> — 아직 정해지지 않았습니다. 2027년 초 회사 발표 전의 숫자는 전망일 뿐이며, 계산기에서 지급률을 바꿔 가며 가늠할 수 있습니다.</li>
<li><strong>Q. 평균 급여가 왜 2년 연속 줄었나요?</strong> — 사업보고서 급여총액에는 그해 지급된 전년 실적 성과급이 포함됩니다. 2022년 실적분 870~900%가 지급된 2023년 평균이 가장 높았고, 성과급이 ${LGES_Y24}%·${LGES_Y25}%로 줄면서 평균도 내려간 것으로 볼 수 있습니다.</li>
...
export const hotNewsMay2026: Guide[] = [
  ...
  },
  {
    ...
    description:
      "2025년 실적 성과급 기본급 75%(2026-02-06 지급), 2025년 평균 급여 약 1억 1,200만원. 연도별 추이·세후·2026 임금협상 확인 현황.",
    metaDescription:
      "LG에너지솔루션 2025년 실적 성과급 기본급 75%(2026년 2월 6일 지급), 사업보고서 평균 급여 추이(2023~2025년), 성과급 세후, 2026년 임금협상에서 확인된 것과 안 된 것을 정리했습니다.",
    category: "연봉",
