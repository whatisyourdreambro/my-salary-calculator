...
import { ArrowLeft, Building2, TrendingUp, Users, Wallet, CheckCircle } from "lucide-react";
...
export default function CompanyProfileContent({ id }: CompanyProfileContentProps) {
