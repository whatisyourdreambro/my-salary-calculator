...
function buildSalaryFaq(amount: number, monthlyNet: number, totalDeduction: number) {
 ...
 {
 // G9 (2026-09-25): 종전 답변의 "2024년 국세청 통계 기준 평균 약 4,200만원·중위 약 3,200만원"은
 // 원문(기준연도·집계 대상) 확인 전이라 연도·수치 주장을 뺐다. 표현은 같은 페이지
 // SalaryTierCard 의 "자체 참고표에 따른 분류 · 공식 전국 순위가 아닙니다"와 맞춘다.
 question: questions[2],
 answer: `연봉 ${amountLabel}의 위치는 이 페이지의 연봉 티어 카드에서 확인할 수 있습니다. 티어와 상위 비율은 머니샐러리 자체 참고표에 따른 분류이며 공식 전국 순위가 아닙니다. 공식 통계와 비교할 때는 발표 기관의 기준연도와 집계 대상을 함께 확인하세요.`,
 },
 {
