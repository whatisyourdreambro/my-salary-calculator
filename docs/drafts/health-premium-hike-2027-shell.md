...
> **★폐기 (2026-09-25)** — 2026-09-08 건정심이 2027년 건강보험료율을 7.19%로 **동결** 의결(보건복지부 보도자료 2026-09-08). 아래 체크리스트 1에 따라 이 셸은 폐기한다: `/calc/health-premium-hike-2027` 라우트를 만들지 말 것(인상 슬러그로 동결 콘텐츠 발행 금지). 동결 반영은 `health-rate-2027-kit.md` 분기 B로 실행 완료. 문서는 기록용으로만 남긴다 — 차년(2028) 인상 의결 시 재사용 여부는 그때 운영자 승인으로 별도 판단.
