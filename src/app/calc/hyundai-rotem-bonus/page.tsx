...
const PAGE_DESC =
  "현대로템 임단협 성과급 계산기. 월 기본급만 입력하면 2025년 타결안(기본급 450% + 정액 1,620만원 + 온누리상품권 20만원, 조합원 평균 3,380만원)과 2024년(500% + 1,800만원) 세전·세후 실수령액을 즉시 계산. 2026년 성과배분 논의 현황 정리.";
    ...
    <>
      ...
      <main className="w-full min-h-screen bg-canvas pt-24 pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-8">
            <CalcResultAd />
            <BonusNextLinks slug="hyundai-rotem-bonus" />
          </div>
