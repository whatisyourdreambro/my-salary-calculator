...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "(1) 총급여 8,000만원 이하 무주택자는 월세 세액공제 15~17%(연 1,000만원 한도) 가능. (2) 전세는 보증금 회수 가능하지만 자금이 묶임. (3) 금리가 낮으면 전세 자금 운용 수익보다 비용이 적어 전세 유리, 금리 높으면 월세도 합리적. 본 계산기로 두 시나리오 비교 가능.",
  },
  {
