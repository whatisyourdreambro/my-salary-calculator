...
export default function RichDNAClient() {
 ...
 <div className="w-24 h-2 bg-canvas-dark rounded-full overflow-hidden">
 <motion.div
 ...
 <span className="text-sm font-medium text-faint-blue">
 {step + 1} / {questions.length}
 </span>
 </div>
 </div>

 <h2 className="text-3xl sm:text-4xl font-bold mb-10 leading-tight text-navy">
 ...
 <span className="text-lg font-medium text-muted-blue group-hover:text-primary transition-colors">
 {answer.text}
 </span>
 <ArrowRight className="w-5 h-5 text-muted-blue group-hover:text-primary opacity-0 group-hover:opacity-100 transition-all transform group-hover:translate-x-1" />
 </div>
 </motion.button>
 ))}
 </div>
 ...
 <ResultIcon className="w-96 h-96 text-navy" />
 </div>
 ...
 <div className="mb-8">
 <p className="text-xs font-bold tracking-[0.3em] uppercase text-faint-blue mb-3">
 ...
 <div className="flex items-center justify-between text-xs text-faint-blue font-mono border-t border-white/10 pt-6">
