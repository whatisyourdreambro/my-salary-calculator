...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "국민연금 5.0%(법정 인상 스케줄)·최저임금 10,700원·건강보험 3.595%(2026년 9월 8일 건정심 동결 의결)는 확정입니다. 장기요양보험료율은 아직 2027년분이 발표되지 않았고, 고용보험 실업급여 요율은 2027년 인상안(근로자 0.9%→1.0%, 2026년 9월 1일 고용보험위원회 심의)이 법령 개정 전이라 두 항목은 2026년 기준을 준용했으며, 확정 즉시 표를 갱신합니다. 미확정분이 오르면 실수령액은 표보다 조금 더 줄어들 수 있습니다. 소득세는 현행 근로소득 간이세액표(2026년 3월 1일 지급분부터)를 준용한 월 원천징수액이며, 2027년 표가 개정되면 갱신합니다.",
  },
  {
...
const tableJsonLd = [
  datasetLd({
    ...
    description:
      "2027년 국민연금 5.0% 인상을 반영한 연봉 2400만원~2억 구간별 월 실수령액과 4대보험 공제 내역 데이터셋 (건강보험 2027 동결 확정 반영, 장기요양·고용보험은 2026 준용)",
    ...
    <main className="w-full bg-background min-h-screen pb-20">
      ...
      <div className="page-width -mt-20 relative z-10">
        ...
        <section className="mt-12 mb-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-faint-blue leading-relaxed mb-4">
              ...
              월 209시간 기준 2,236,300원입니다. 건강보험료율은 2026년 9월 8일 건정심에서
              2026년과 같은 근로자 3.595%로 동결 확정됐고, 장기요양(2027년분 미발표)·고용보험(2027
              인상안 심의 중) 요율은 2026년 기준을 준용했으며, 확정 시 이 표를 바로 갱신합니다. 위 표의 <strong className="text-navy">변화값(2026比)</strong>은
              연금 인상 효과만 반영한 순수 감소액입니다. 소득세는 현행 근로소득 간이세액표(2026년 3월 1일 지급분부터)를 준용한 월 원천징수액입니다.
            </p>
          </div>
        </section>
        ...
        <div className="mt-4 text-center text-faint-blue text-sm pb-8">
          * 비과세 식대 월 20만원·본인 1인 공제 기준. 국민연금 5.0%·최저임금 10,700원·건강보험
          3.595%(2027 동결)는 확정, 장기요양·고용보험은 2026 기준 준용(확정 시 갱신). 소득세는 2026년 근로소득 간이세액표 준용입니다. 각 행의 상세 페이지는
          2026년 기준입니다.
        </div>
      </div>
    </main>
