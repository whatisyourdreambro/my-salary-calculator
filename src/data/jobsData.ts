...
export const jobsData: JobProfile[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "요양보호사 월급 실수령액은 얼마인가요?", a: "시설 근무 요양보호사 월급은 세전 200~250만원 수준이 많으며, 야간·연장근무 수당이 붙으면 더 올라갑니다. 연봉 2,750만원 기준 세후 월 실수령액은 약 205만원 안팎입니다. 정확한 금액은 머니샐러리 연봉 계산기에 직접 입력해 확인하세요." },
