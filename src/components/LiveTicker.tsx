...
export default function LiveTicker() {
 ...
 exit={{ opacity: 0, y: -20 }}
 className="bg-electric/90 backdrop-blur-md text-white px-4 py-3 rounded-full shadow-2xl border border-white/10 flex items-center gap-3 pointer-events-auto max-w-sm w-full sm:w-auto"
 >
 ...
 <Bell className="w-3 h-3 text-navy" />
 </div>
 </div>
 ...
 className="text-faint-blue hover:text-navy transition-colors text-xs"
 >
 닫기
 </button>
 </motion.div>
