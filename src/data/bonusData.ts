    ...
    payouts: [
      ...
      },
      {
        ...
        note:
          ...
          "2026년분(2027년 초 지급) 지급 방식: 현금 40%+자사주 60% 첫 잠정합의안은 " +
          "2026-08-25 총투표 부결(전임직 반대 50.08%·25표 차) → 9/9 수정안(현금 50%+자사주 30%+이연 주식 10%p×2)이 " +
          "2026-09-16 총투표 가결(찬성 57.08%·약 2,165표 차)로 최종 타결",
        source:
          "SK하이닉스 사업보고서(2026-03)·한국경제 2026-08-20·머니투데이 등 2026-08-25 부결 보도·헤럴드경제/파이낸셜뉴스 2026-09-16 가결 보도 (psData.ts SOURCES)",
      },
      {
        year: 2024,
        scheme: "PI",
