...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "내 시간이 돈이 되는 순간을 확인하세요. 연봉·월급·시급으로 오늘 번 돈과 예상 세금·보험 공제액을 실시간 환산하고, 출퇴근·유급/무급 휴게·화장실 시간과 월별 기록, 주휴수당을 확인하는 무료 월급 시계입니다.",
  path: "/work-clock",
...
const FAQ = [
  ...
  { question: "이번 달 누적과 자정을 넘긴 근무는 어떻게 계산하나요?", answer: "오늘과 조회 월은 한국시간(Asia/Seoul)을 기준으로 합니다. 자정이나 월 경계를 넘긴 근무와 휴게는 각 날짜·월에 해당하는 시간으로 나누어 계산합니다. 새로 바꾼 급여 설정은 새 근무에 적용되며, 진행 중이거나 이미 끝난 근무의 급여 기준은 바뀌지 않습니다." },
  ...
  { question: "연봉과 근무 기록이 다른 사람에게 보이나요?", answer: "이 도구의 입력 금액과 근무 기록은 서버로 전송하지 않습니다. 기본은 저장하지 않으며, 저장을 선택하면 현재 브라우저의 로컬 저장소에 최대 500개 근무를 보관합니다. 다른 기기와 동기화되지 않고 같은 브라우저를 쓰는 사람이 볼 수 있으므로 공용 기기에서는 저장을 끄세요. 기록 삭제와 실행 취소 기능도 제공합니다." },
];
  ...
  return (
    <div className={styles.page}>
      <JsonLd data={[
        ...
        faqLd(FAQ),
        softwareApplicationLd({ name: "실시간 월급 시계", description: "출퇴근과 휴게시간을 기록하고 오늘·월별 급여 환산액을 확인하는 무료 개인용 도구", url: "/work-clock", featureList: ["실시간 급여 환산", "출퇴근·유급/무급 휴게 기록", "월별 근무 기록", "선택형 브라우저 저장", "주휴수당 참고 추정", "25분 집중 타이머"] }),
      ]} />
