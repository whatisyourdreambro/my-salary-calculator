  ...
  return <EnglishPageShell eyebrow="Working in Korea · English tools" title="Korea Salary Calculator 2026" description="Estimate average monthly take-home pay in KRW, understand insurance and tax deductions, then explore tools for bonuses, job offers and everyday money decisions.">
    ...
    <section aria-labelledby="english-method" className="rounded-2xl border border-border bg-background p-6 sm:p-8">
      ...
      <div className="mt-6 space-y-3">
        <details className="rounded-xl border border-border p-4"><summary className="cursor-pointer py-2 font-bold">How do I enter a Korean job offer?</summary><p className="mt-3 text-sm leading-6 text-muted-foreground">Start with the written annual gross amount and check which bonuses and allowances it includes. KRW 60 million divided by twelve is KRW 5 million per month before deductions; it is not KRW 5 million of take-home pay. Keep a one-time signing payment separate when comparing recurring offers. <Link href="/en/guides/samsung-vs-hynix-employee-comparison" className="font-bold text-primary underline">Use the job-offer comparison checklist.</Link></p></details>
