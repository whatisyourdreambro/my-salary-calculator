...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "과세 대상 상여는 근로소득에 포함되며, 소득세 기본세율은 연봉 자체가 아닌 공제 후 과세표준에 적용됩니다. 이 계산기는 추정 연봉만 있을 때와 성과급 합산 시의 연간 세액(근로소득공제·보험료 공제·근로소득세액공제 반영) 차이를 비교하며, 추가 세액공제 가정은 기본 0%입니다. 보험료 반영 옵션과 주식·포인트를 합산 소득처럼 취급하는 가정도 사용합니다. 실제 비현금 항목의 과세 처리, 상여 지급대상기간에 따른 원천징수, 개인별 공제와 보험료 정산을 재현하지 않으므로 결과는 비교용 추정치입니다.",
  },
  {
    question: "기아와 비교하면?",
    answer:
            ...
            <p className="flex items-start gap-2">
              ...
              <span>
                ...
                <span className="text-amber-800">
                  ...
                  세후 계산에는 월 기준금액 × 18의 연봉과 합산 세액 차이를 씁니다.
