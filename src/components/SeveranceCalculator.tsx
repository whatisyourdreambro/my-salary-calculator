...
export default function SeveranceCalculator() {
 ...
 <div className="flex justify-between"><span>과세대상 퇴직금:</span><span className="tabular-nums">{result.details?.retirementIncome.toLocaleString('ko-KR')}원</span></div>
 <div className="flex justify-between"><span>└ 근속연수공제:</span><span className="tabular-nums">-{result.details?.serviceYearDeduction.toLocaleString('ko-KR')}원</span></div>
 <div className="flex justify-between"><span>환산급여:</span><span className="tabular-nums">{result.details?.convertedSalary.toLocaleString('ko-KR')}원</span></div>
 <div className="flex justify-between"><span>└ 환산급여공제:</span><span className="tabular-nums">-{result.details?.convertedSalaryDeduction.toLocaleString('ko-KR')}원</span></div>
 <div className="flex justify-between font-bold"><span>과세표준:</span><span className="tabular-nums">{result.details?.taxBase.toLocaleString('ko-KR')}원</span></div>
 <div className="flex justify-between"><span>산출세액:</span><span className="tabular-nums">{result.details?.calculatedTax.toLocaleString('ko-KR')}원</span></div>
 </div>
