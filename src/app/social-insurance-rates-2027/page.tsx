...
// - 건강보험: 2027 동결 — 총 7.19%·근로자 3.595% (2026과 동일), 건정심 2026-09-08 의결
//   (보건복지부 보도자료 2026-09-08 보험정책과. 정본: generateData2027.ts
//    NET_SALARY_RATES_2027.health = INSURANCE_RATES_2026.HEALTH_INSURANCE 참조 유지)
// 미확정 (2026 기준 준용, 페이지 내 고지 배너 필수 유지):
// - 장기요양(통상 10~11월 장기요양위원회 의결)·산재(12월 고용노동부 고시)
// - 고용보험 실업급여: 현행 총 1.8%(근로자 0.9%, 2022-07-01 이후). 2027년 2.0%(근로자·회사 각
//   0.9%→1.0%) 인상안 — 고용노동부 보도자료 2026-09-01(고용보험위원회 「고용보험 제도개편 방안」 심의,
//   moel.go.kr news_seq=19866). 연내 법률·하위법령 개정 목표 → 개정 전이라 계산은 현행 0.9% 유지.
//
// ★갱신 슬롯 (완료 2026-09-25): 건보 2027 동결 확정 반영 (카드·배너·FAQ·generateData2027.ts 주석 동기화)
// ★갱신 슬롯: 2026년 10~12월 — 장기요양(10~11월 의결)·산재(12월 고시)·고용보험(법령 개정 공포 시)
//   2027 요율 확정 시 해당 카드·FAQ·배너 갱신. 고용보험 확정 시 generateData2027.ts employment 도 함께.
...
export const metadata: Metadata = buildPageMetadata({
  title: "2027 4대보험 요율표 — 국민연금 10.0% 확정·건강보험 7.19% 동결 확정",
  description:
    "2027년 4대보험 요율 총정리. 국민연금 총 10.0%(근로자 5.0%) 1월 시행, 건강보험료율 7.19%(근로자 3.595%) 동결 확정(9월 8일 건정심), 최저임금 시급 10,700원 확정. 장기요양·산재는 고시 전까지 2026 요율 준용 — 연봉별 월 보험료까지 한 페이지에서.",
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "2026년 9월 25일 기준 확정된 것은 세 가지입니다. 첫째, 국민연금 보험료율이 2027년 1월 1일부터 총 10.0%(근로자 5.0%·회사 5.0%)로 오릅니다 — 2025년 통과된 국민연금법 개정(연금개혁)에 법정 스케줄로 명시된 인상입니다. 둘째, 2027년 최저임금이 시급 10,700원(주휴 포함 월 2,236,300원)으로 확정 고시됐습니다(고용노동부 고시 제2026-60호, 2026-08-05). 셋째, 건강보험료율은 2026년 9월 8일 건강보험정책심의위원회(건정심) 의결로 2027년에도 2026년과 같은 총 7.19%(근로자 3.595%)로 동결됐습니다. 고용보험 실업급여 요율은 2027년 2.0%(근로자 1.0%) 인상안이 2026년 9월 1일 고용보험위원회에서 심의돼 법령 개정을 앞두고 있고, 장기요양·산재 요율은 아직 확정 전입니다.",
  },
  {
  ...
  {
    question: "2027년 건강보험료율은 오르나요?",
    answer:
      "오르지 않습니다. 2026년 9월 8일 보건복지부 건강보험정책심의위원회(건정심)가 2027년 건강보험료율을 2026년과 같은 총 7.19%(근로자 3.595%·회사 3.595%)로 동결 의결했습니다. 건강보험료에 정률(2026년 13.14%)로 붙는 장기요양보험료의 2027년 비율은 장기요양위원회에서 별도로 결정하며, 확정 전까지 이 페이지의 장기요양 수치는 2026 비율을 준용한 참고치입니다.",
  },
  {
    question: "고용보험료는 2027년에 오르나요?",
    answer:
      "인상안이 나와 있지만 아직 확정 전입니다. 고용노동부는 2026년 9월 1일 고용보험위원회에서 「고용보험 제도개편 방안」을 심의하고, 2027년 실업급여 계정 보험료율을 현행 1.8%(2022년 7월부터 적용)에서 2.0%로(근로자·회사 각 0.9%→1.0%) 올리는 안을 발표했습니다. 요율은 법률·하위법령 개정을 거쳐야 확정되며(정부는 연내 개정 목표), 확정 전까지 이 페이지의 계산에는 현행 1.8%(근로자 0.9%)를 적용합니다. 인상안대로 확정되면 월급 300만원 근로자의 고용보험료는 매달 27,000원에서 30,000원으로 3,000원 늘어납니다. 회사는 이와 별도로 고용안정·직업능력개발사업 보험료 0.25~0.85%(기업 규모별)를 추가 부담하며, 이 부분은 근로자 월급에서 공제되지 않습니다.",
  },
  {
    question: "2027년 4대보험 본인 부담은 월급의 몇 %인가요?",
    answer:
      "확정된 국민연금 5.0%·건강보험 3.595%(2027 동결)에 장기요양 약 0.472%(2026 비율 준용)·고용보험 0.9%(현행)를 더하면 약 9.97% 수준입니다. 2026년(약 9.7%)보다 약 0.25%포인트 높아지며, 현재 확정분 기준 증가는 국민연금 인상분입니다. 장기요양 비율 인상이나 고용보험 실업급여 요율 인상안(근로자 0.9%→1.0%, 2026년 9월 1일 고용보험위원회 심의·법령 개정 전)이 확정되면 이 비율은 더 올라갑니다. 산재보험은 회사가 100% 부담합니다.",
  },
];

// 요율 카드 — 계산 로직은 아래 calculateInsurance2027()이 정본 상수
// (NET_SALARY_RATES_2027·INSURANCE_RATES_2026)를 직접 사용. 카드의 표시 문자열은
// 그 상수와 정합 (국민연금 5.0%=NET_SALARY_RATES_2027.pension, 건보 3.595%=2027 동결 확정(2026 정본 참조)).
// ★갱신 슬롯 (완료 2026-09-25): 건보 동결 확정 반영. 건강보험 카드는 광고(InArticleAd) 위라
//   totalRate·purpose·status 문자열 폭을 기존 이하로 유지 (카드 높이 증가 금지 — 2026-08-16 규칙).
//   2026-09-25 고용보험 status(인상안 심의)·장기요양 status(통상 10~11월)도 같은 원칙으로 기존보다 짧게 교체.
// ★갱신 슬롯: 2026년 10~12월 — 장기요양·산재·고용보험 확정 시 해당 카드 status 갱신 (폭 기존 이하 유지).
const INSURANCE_RATES_2027_CARDS = [
  ...
  {
    name: "건강보험",
    totalRate: "7.19% (2027 동결)",
    selfRate: "3.595%",
    companyRate: "3.595%",
    base: "보수월액",
    purpose: "의료비 보장",
    status: "확정 — 2027 동결(2026-09-08 건정심 의결)",
  },
  {
    name: "장기요양보험",
    ...
    base: "건강보험료 기준",
    purpose: "노인 장기요양 서비스",
    status: "미확정 — 통상 10~11월 장기요양위원회 의결, 확정 시 갱신",
  },
  {
    name: "고용보험",
    ...
    base: "보수월액",
    purpose: "실업급여·고용안정",
    status: "인상안 심의 — 2027 실업급여 2.0%(근로자 1.0%), 법령 개정 전",
  },
  {
    name: "산재보험",
    totalRate: "업종별 차등",
...
// 연금 5.0%는 NET_SALARY_RATES_2027, 건보 3.595%는 2027 동결 확정(2026 정본 참조), 장기요양·고용은 2026 준용값,
      ...
      <div className="page-width">
        <div className="text-center mb-12">
          <p className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-electric-10 text-electric font-bold text-sm mb-6">
            ...
            2027년 기준 · 2026-09-08 확정분 반영
          </p>
          <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-navy mb-4">
            2027 4대보험 <span className="text-electric">요율표</span>
          </h1>
          <PublishedMeta publishedDate="2026-08-31" updatedDate="2026-09-25" className="mb-2" />
          {/* 광고(InArticleAd) 위 문단 — 문구 길이를 기존 이하로 유지 (2026-08-16 규칙) */}
          <p className="text-base sm:text-lg text-muted-blue leading-relaxed max-w-2xl mx-auto">
            국민연금 총 10.0% 인상·최저임금 시급{" "}
            {MIN_WAGE_2027.toLocaleString("ko-KR")}원·건강보험 동결은 확정, 장기요양·산재는
            고시 전. 무엇이 정해졌고 무엇이 남았는지 한 페이지에서.
          </p>
        </div>
        ...
        {/* 연봉별 시뮬 — 2027 요율 (건보 동결 확정, 장기요양 비율은 2026 준용) */}
