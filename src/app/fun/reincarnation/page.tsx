...
const getRarityColor = (rarity: Rarity) => {
 ...
 case "B": return "text-electric font-bold";
 case "C": return "text-primary font-bold";
 case "F": return "text-faint-blue font-medium";
...
export default function ReincarnationPage() {
 ...
 <p className="mt-2 text-lg text-faint-blue font-medium max-w-xl mx-auto">
 ...
 <motion.div
 className="absolute inset-0 border-4 border-electric rounded-full"
 />
 <motion.div
 className="absolute inset-0 border-4 border-t-electric border-r-purple-500 border-b-pink-500 border-l-transparent rounded-full"
 animate={{ rotate: 1080 }}
 ...
 <h2 className="text-2xl font-bold text-navy mb-2">영혼 데이터 재구성 중...</h2>
 <p className="text-primary font-medium">당신의 카르마를 분석하고 있습니다.</p>
 </motion.div>
 )}
 </AnimatePresence>
 ...
 <h2 className="text-3xl font-black text-navy ">당신의 다음 생은?</h2>
 </div>
 ...
 <p className="text-xs text-faint-blue uppercase tracking-wider font-bold">Nationality</p>
 <h3 className={`text-base font-bold ${getRarityColor(result.country.rarity)}`}>{result.country.name}</h3>
 <p className="text-xs text-faint-blue mt-0.5">{result.country.description}</p>
 </div>
 ...
 <div className="flex-1">
 <p className="text-xs text-faint-blue uppercase tracking-wider font-bold">Class</p>
 <h3 className={`text-base font-bold ${getRarityColor(result.spoon.rarity)}`}>{result.spoon.name}</h3>
 <p className="text-xs text-faint-blue mt-0.5">{result.spoon.description}</p>
 </div>
 ...
 <div className="flex-1">
 <p className="text-xs text-faint-blue uppercase tracking-wider font-bold">Talent</p>
 <h3 className={`text-base font-bold ${getRarityColor(result.talent.rarity)}`}>{result.talent.name}</h3>
 <p className="text-xs text-faint-blue mt-0.5">{result.talent.description}</p>
 </div>
 ...
 <div className="flex-1">
 <p className="text-xs text-faint-blue uppercase tracking-wider font-bold">Occupation</p>
 <h3 className={`text-base font-bold ${getRarityColor(result.occupation.rarity)}`}>{result.occupation.name}</h3>
 <p className="text-xs text-faint-blue mt-0.5">{result.occupation.description}</p>
 </div>
 ...
 <div>
 <p className="text-xs text-faint-blue uppercase tracking-wider font-bold">Life Span</p>
 <h3 className="text-base font-bold text-muted-blue ">{result.lifeSpan}세</h3>
 </div>
 </div>
 </div>
