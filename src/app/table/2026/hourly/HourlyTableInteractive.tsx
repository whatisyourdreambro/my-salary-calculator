      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <div className="bg-card p-6 sm:p-8 rounded-2xl shadow-xl border border-border">
            <h2 className="text-2xl font-bold mb-6">시급별 실수령액 시뮬레이터 (2026년 예상)</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="space-y-6">
                  <div>
                    <Label htmlFor="hourly-wage" className="text-lg">시급: {hourlyWage.toLocaleString()}원</Label>
                    <Slider
                      id="hourly-wage"
                      min={10000}
                      max={50000}
        ...
        <div className="space-y-8">
            <div className="bg-card p-6 rounded-2xl shadow-xl border border-border">
                ...
                <div className="mt-4 space-y-2 text-muted-foreground">
                    <div className="flex justify-between"><span>세전 월급 (환산)</span><span>{(hourlyWage * 8 * 209 / 12).toLocaleString()}원</span></div>
