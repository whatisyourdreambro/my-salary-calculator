...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "2026년 9월 8일 기준 확정된 것은 세 가지입니다. 첫째, 국민연금 보험료율이 2027년 1월 1일부터 총 10.0%(근로자 5.0%·회사 5.0%)로 오릅니다 — 2025년 통과된 국민연금법 개정(연금개혁)에 법정 스케줄로 명시된 인상입니다. 둘째, 2027년 최저임금이 시급 10,700원(주휴 포함 월 2,236,300원)으로 확정 고시됐습니다(고용노동부 고시 제2026-60호, 2026-08-05). 셋째, 건강보험료율은 2026년 9월 8일 건강보험정책심의위원회(건정심) 의결로 2027년에도 2026년과 같은 총 7.19%(근로자 3.595%)로 동결됐습니다. 장기요양·산재 요율은 아직 확정 전입니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "오르지 않습니다. 2026년 9월 8일 보건복지부 건강보험정책심의위원회(건정심)가 2027년 건강보험료율을 2026년과 같은 총 7.19%(근로자 3.595%·회사 3.595%)로 동결 의결했습니다. 따라서 현재까지 확정된 2027년 근로자 요율 인상은 국민연금(4.75%→5.0%)뿐입니다. 건강보험료에 정률(2026년 13.14%)로 붙는 장기요양보험료의 2027년 비율은 장기요양위원회에서 별도로 결정하며, 확정 전까지 이 페이지의 장기요양 수치는 2026 비율을 준용한 참고치입니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "확정된 국민연금 5.0%·건강보험 3.595%(2027 동결)에 장기요양 약 0.472%(2026 비율 준용)·고용보험 0.9%를 더하면 약 9.97% 수준입니다. 2026년(약 9.7%)보다 약 0.25%포인트 높아지는데, 이는 전액 국민연금 인상분입니다. 장기요양 비율이 인상 확정되면 이 비율은 소폭 올라갑니다. 산재보험은 회사가 100% 부담합니다.",
  },
];
      ...
      <div className="page-width">
        ...
        <div className="mt-8 mb-12">
          <p className="rounded-xl bg-electric/5 border border-electric/20 px-4 py-3 text-xs leading-5 text-muted-blue">
            ...
            <strong className="text-navy">미확정(2026 기준 준용):</strong> 장기요양·산재 —
            확정 고시 즉시 갱신합니다. 고용보험
        ...
        <section className="mb-12 p-6 sm:p-8 bg-white rounded-3xl border border-canvas-200">
          ...
          <div className="mt-4 p-3 bg-canvas rounded-xl">
            <p className="text-xs text-muted-blue">
              ...
              동결 확정(3.595%), 장기요양은 2026 비율 준용 참고치이며 확정 시 갱신. 국민연금은 기준소득월액
