...
export default function AboutPage() {
 ...
 <li>월 급여에서 비과세를 뺀 월급여액과 공제대상가족 수로 근로소득 간이세액표(소득세법 시행령 별표2, 2026년 3월 1일 지급분부터)의 월 소득세를 찾습니다. 표에는 근로소득공제·기본공제·연금보험료공제, 건강·고용보험료 등 특별소득공제와 특별세액공제 일부, 근로소득세액공제가 반영돼 있습니다.</li>
 <li>8세 이상 20세 이하 자녀 수에 따라 표에 정해진 금액을 빼고, 월 소득세의 10%인 지방소득세와 보험료를 합해 공제합니다.</li>
 <li>홈 계산기의 장애인·경로우대 추가공제와 중소기업 청년 감면은 간이세액표에 없는 항목이라, 같은 표 산식에 공제·감면을 더한 추정치로 보여 줍니다.</li>
 </ol>
