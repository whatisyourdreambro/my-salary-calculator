...
const FAQ_ITEMS = [
 ...
 answer:
 "간접적으로 영향이 있습니다. 최저임금 인상 → 신입 초봉 인상 압력 → 전체 연봉 테이블 동반 인상 사례 많음. 특히 유통·외식·서비스업은 직접 영향. 본인 연봉이 최저임금 × 209시간(약 월 209만원) 미만이면 즉시 인상 청구 가능.",
 },
];
...
export default function MinimumWage2026Page() {
 ...
 연봉 4,360만원 미만이면 시급으로는 최저임금 수준일 수 있으므로 머니샐러리 연봉
 계산기로 실제 시급을 확인해보세요. 또한 최저임금 인상은 신입 초봉·전 직급 연봉
 테이블에 간접 영향을 주므로 매년 1월 인상분 파악이 필수입니다.
 </p>
 </section>
 ...
 ※ 2026 시급은 2025년 8월 고시 기준 추정. 정확한 최종 수치는{" "}
 <a
 href="https://www.minimumwage.go.kr/"
 className="text-electric font-bold hover:underline"
 target="_blank"
