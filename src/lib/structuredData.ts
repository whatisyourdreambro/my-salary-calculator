...
const NON_PAGE_PATHS: ReadonlySet<string> = new Set([
 ...
 "/tools/health",
 "/pro",
 // /company 는 404 가 아니라 next.config 308(→/salary-db) — 인덱스 page.tsx 는 2026-09-25 B8(결정 10
 // 2단계)에서 삭제돼 라우트가 아니다. /company/compare·/company/simulator 단계에 리다이렉트 URL 을 싣지 않는다.
 "/company",
]);
