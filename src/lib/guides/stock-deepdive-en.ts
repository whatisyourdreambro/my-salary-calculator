...
<div class="overflow-x-auto focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary" tabindex="0" role="region" aria-label="Illustrative job-offer comparison"><table class="min-w-[30rem] [&_th]:!text-foreground [&_th]:normal-case [&_th]:tracking-normal"><caption class="pb-3 text-left font-semibold text-foreground">Illustrative offers in KRW, before tax and insurance</caption><thead><tr><th scope="col">Component</th><th scope="col">Offer A</th><th scope="col">Offer B</th></tr></thead><tbody>
