...
| M07 | 연말정산 클러스터 title 연도 프레임 상수화(`YEAR_END_SEASON_LABEL`, '2027 (2026년 귀속)') — ~~값 교체 12/15~~ **12/15 슬롯 취소(2026-09-26 R3 W1-A)**: 2026년 귀속을 2027-03-10 까지 유지, 전환은 2027-03-11 부터(`yearEndSeasonGuard.test.ts`) | [코드] | ×1.00~1.02 | L14'와 같은 배치. 1월 초 교체 금지 |
