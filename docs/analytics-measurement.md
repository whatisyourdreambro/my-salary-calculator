...
| GA4 맞춤 측정기준 `dest_tpl`(이벤트 범위) 등록 | GA4 관리 → 맞춤 정의 | ☐ 9/29 배포 당일 등록일 기입(아래 '내비 표면' 절) | 운영자 | 10/19 모듈별 목적지 판독 |
| `autoads_seen` 측정기준·측정항목 등록 | GA4 관리 → 맞춤 정의 | ☐ 9/29 배포 당일(아래 '자동광고 관측' 절 'GA4 등록') | 운영자 | 10/2·10/9 판독 |
