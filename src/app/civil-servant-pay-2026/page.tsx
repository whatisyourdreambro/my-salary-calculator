...
// ─────────────────────────────────────────────────────────────
// 데이터 — 인사혁신처 2026년 공무원 봉급표 공표 원문
// (mpm.go.kr/mpm/info/resultPay/bizSalary/2026/) 수치 그대로.
// [호봉, 9급, 8급, 7급, 6급, 5급] 월 봉급액(원)
// ─────────────────────────────────────────────────────────────
const GENERAL_PAY_ROWS: ReadonlyArray<
...
// 경찰(순경)·소방(소방사) 1~5호봉 월 봉급액(원) — 동일 출처
const POLICE_FIRE_ROWS: ReadonlyArray<readonly [number, number]> = [
  [1, 2133000],
  [2, 2155600],
  [3, 2187500],
  [4, 2229200],
...
// 직급보조비 월액(원) — 법제처 공무원수당규정(2026 현행 유지)
const POSITION_ALLOWANCE: ReadonlyArray<{ grade: string; amount: number }> = [
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "매년 12월 말 국무회의에서 이듬해 공무원 보수규정 개정안이 의결되면서 인상률과 봉급표가 확정·발표되고, 다음 해 1월 1일부터 시행됩니다. 2026년 봉급표도 2025년 12월 30일 국무회의 의결을 거쳐 확정됐습니다. 2027년 봉급표는 2026년 12월 말 인사혁신처 발표를 확인하세요.",
  },
];
