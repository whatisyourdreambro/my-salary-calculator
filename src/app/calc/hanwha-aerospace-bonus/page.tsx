...
const PAGE_DESC =
  "한화에어로스페이스 성과급(BPI·VEI) 계산기. 사업부와 월 기본급만 입력하면 지상방산 725%·유도무기 702.8%·MRO 510.6%·항공 494.8% 차등 지급률 + 정액 400만원 합산 세전·세후 실수령액 즉시 계산. 2026년 2월 지급과 전년(710%+500만원) 비교.";
    ...
    <>
      ...
      <main className="w-full min-h-screen bg-canvas pt-24 pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-8">
            <CalcResultAd />
            <BonusNextLinks slug="hanwha-aerospace-bonus" />
          </div>
