...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "LTV(Loan to Value, 담보인정비율)는 주택 가격 대비 대출 가능 비율입니다. 예) LTV 70%는 5억 주택의 경우 3.5억까지 대출 가능. 규제지역 50%, 비규제지역 70%가 기본이며, 생애최초는 6·27 대책(2025-06-28 시행) 이후 수도권·규제지역 70%(주담대 최대 6억 한도)·비수도권 80%. 다만 LTV 한도여도 DSR이 더 작으면 DSR이 결정.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "본인·배우자 모두 주택 보유 이력이 없는 생애최초 구입자 대상. 단, 2025년 6·27 대책(6.28 시행)으로 수도권·규제지역은 생애최초도 LTV 70%로 축소되고 주담대 최대 6억원 한도가 함께 적용되며, 비수도권은 80% 유지. 신혼부부 디딤돌·보금자리론은 별도 저금리 상품 옵션.",
  },
  {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <article className="prose prose-sm sm:prose-base max-w-none mb-10">
          ...
          <ul className="space-y-1 text-muted-blue leading-relaxed">
            ...
            <li>
              • <strong>생애최초 주택구입</strong>: 비수도권 80% / 수도권·규제지역 70% + 주담대 최대 6억 한도 (6·27 대책)
            </li>
            <li>
