...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "성과급은 근로소득에 합산되어 누진세율(6~45%) + 지방세(소득세의 10%) + 4대보험(국민연금 4.75%, 건강 3.595%, 장기요양·고용) 부과. 국민연금은 보수월액 상한(2026 연 7,644만원) 적용. 본 계산기는 marginal 방식(연봉만 vs 연봉+성과급 합산 세금 차이)으로 정확하게 계산.",
  },
  {
