...
export default function MbtiSalaryPage() {
  ...
  return (
    <main className="w-full min-h-screen bg-gray-900 text-white overflow-hidden relative">
      {/* Animated Background */}
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        {step === "intro" && (
          <div className="text-center animate-fade-in-up">
            ...
            <button
              onClick={handleStart}
              className="mt-10 px-12 py-4 bg-white text-black font-bold rounded-full text-lg hover:bg-gray-200 transition-transform transform hover:scale-105 shadow-lg shadow-violet-500/30"
            >
              운명 확인하기
            </button>
          </div>
        ...
        {step === "quiz" && (
          <div className="w-full max-w-2xl bg-black/30 backdrop-blur-md p-6 sm:p-10 rounded-2xl shadow-2xl border border-white/20 animate-fade-in-up">
            <div className="w-full bg-gray-700 rounded-full h-2.5 mb-8">
              <div
                className="bg-gradient-to-r from-violet-400 to-indigo-400 h-2.5 rounded-full transition-all duration-500"
                style={{
                  width: `${
            ...
            <div className="mt-8 space-y-4 max-w-md mx-auto">
              {questions[currentQuestionIndex].options.map((option, index) => (
                <button
                  ...
                  className="w-full text-left p-5 border-2 border-gray-700 rounded-lg bg-gray-800/50 hover:border-violet-400 hover:bg-violet-900/30 transition-all transform hover:scale-105"
                >
        ...
        {step === "loading" && (
          <div className="text-center animate-fade-in-up">
            ...
            <p className="text-gray-400">운명의 그래프가 그려지고 있습니다.</p>
          </div>
        )}
        ...
        {step === "result" && result && (
          <div className="w-full max-w-4xl animate-fade-in-up">
            <div
              ref={resultRef}
              className="bg-gradient-to-br from-gray-900 to-slate-800 p-8 rounded-2xl shadow-2xl border border-white/20"
            >
              <p className="text-center font-semibold text-indigo-300">
                당신의 인생 연봉 그래프는...
              </p>
              <h2 className="text-4xl font-bold text-center my-2 bg-clip-text text-transparent bg-gradient-to-r from-violet-300 to-indigo-300">
              ...
              <div className="h-72 w-full my-6">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    />
                    <XAxis dataKey="age" stroke="rgba(255,255,255,0.5)" />
                    <YAxis
              ...
              <div className="space-y-4">
                {result.growthPlan.map((plan) => {
                  ...
                  return (
                    <div
                      key={plan.step}
                      className="p-4 border border-white/20 rounded-xl bg-white/5 hover:bg-white/10 transition-colors"
                    >
                      <div className="flex items-start gap-4">
                        <div className="bg-violet-500/20 text-violet-300 p-3 rounded-full">
                        ...
                        <div>
                          ...
                          <Link
                            href={plan.link}
                            className="inline-flex items-center gap-2 mt-3 text-sm font-bold text-violet-300 hover:underline"
                          >
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <button
                ...
                className="w-full py-3 bg-gray-700 font-semibold rounded-lg flex items-center justify-center gap-2 hover:bg-gray-600 transition"
              >
                {" "}
                <Download size={18} />
                이미지 저장
              ...
              <button
                onClick={handleShare}
                className="w-full py-3 bg-yellow-500 font-bold rounded-lg flex items-center justify-center gap-2 hover:bg-yellow-600 transition"
              >
                {" "}
                <Share2 size={18} />
                결과 공유
