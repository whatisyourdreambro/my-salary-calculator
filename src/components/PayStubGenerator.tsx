...
export default function PayStubGenerator() {
 ...
 <div className="flex justify-between items-center py-2 border-b border-dashed border-canvas last:border-0 group relative">
 <div className="flex items-center gap-1">
 <span className="text-muted-blue">{label}</span>
 <div className="relative">
 <HelpCircle className="w-3 h-3 text-faint-blue cursor-help opacity-0 group-hover:opacity-100 transition-opacity" />
 <div className="absolute left-full top-1/2 -translate-y-1/2 ml-2 w-48 p-2 bg-electric text-white text-xs rounded shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none z-50 transition-opacity">
 {tooltip}
 </div>
 </div>
 </div>
 ...
 <div className="bg-canvas 900/20 p-4 rounded-xl text-sm text-electric 300 leading-relaxed">
 ...
 {/* Header */}
 <div className="border-b-2 border-canvas pb-4 mb-6 flex justify-between items-end">
 <div>
 <h1 className="text-3xl font-black tracking-widest text-navy">급여명세서</h1>
 ...
 {/* User Info Grid */}
 <div className="grid grid-cols-2 gap-x-8 gap-y-2 mb-6 text-sm border border-canvas bg-canvas p-4 rounded-lg">
 <div className="flex justify-between">
 <span className="text-faint-blue">사원번호</span>
 <span className="font-bold">2025001</span>
 </div>
 <div className="flex justify-between">
 <span className="text-faint-blue">성명</span>
 <span className="font-bold">김머니</span>
 </div>
 <div className="flex justify-between">
 <span className="text-faint-blue">부서</span>
 <span className="font-bold">재무기획팀</span>
 </div>
 <div className="flex justify-between">
 <span className="text-faint-blue">직위</span>
 ...
 {/* Income Section */}
 <div>
 <h3 className="font-bold border-b-2 border-canvas pb-2 mb-3 flex justify-between items-center">
 지급 내역 <span className="text-xs font-normal text-faint-blue">(Income)</span>
 </h3>
 <div className="space-y-1 text-sm">
 <div className="flex justify-between py-2 border-b border-dashed border-canvas">
 <span className="text-muted-blue">기본급</span>
 <span className="font-medium">{formatNumber(monthlyTaxable)}</span>
 </div>
 <div className="flex justify-between py-2 border-b border-dashed border-canvas">
 <span className="text-muted-blue">비과세 수당</span>
 <span className="font-medium">{formatNumber(monthlyNonTaxable)}</span>
 </div>
 <div className="flex justify-between py-2 border-b border-dashed border-canvas">
 <span className="text-muted-blue">직책수당</span>
 <span className="font-medium">0</span>
 </div>
 <div className="flex justify-between py-2 border-b border-dashed border-canvas">
 <span className="text-muted-blue">식대</span>
 <span className="font-medium">0</span>
 </div>
 </div>
 <div className="mt-4 pt-2 border-t border-canvas flex justify-between font-bold text-electric">
 <span>지급 총액</span>
 ...
 {/* Net Pay Section */}
 <div className="bg-electric text-white p-6 rounded-xl flex justify-between items-center relative overflow-hidden">
 <div className="absolute inset-0 bg-gradient-to-r from-[#EDF1F5] to-[#DDE4EC] z-0" />
 <div className="relative z-10">
 <p className="text-faint-blue text-sm mb-1">실 수령액 (Net Pay)</p>
 <p className="text-xs text-faint-blue">귀하의 노고에 감사드립니다.</p>
 </div>
 <div className="relative z-10 text-right">
 <span className="text-3xl font-black tracking-tight text-primary">
 {formatNumber(result.monthlyNet)}
 </span>
 <span className="text-lg font-medium ml-1 text-faint-blue">원</span>
 </div>
 </div>

 {/* Footer & Stamp */}
 <div className="mt-8 flex justify-between items-end relative">
 <div className="text-xs text-faint-blue">
