...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "성과급은 연간 근로소득에 합산되어 누진세율(6~45%) + 지방세(소득세의 10%) + 4대보험(국민연금·건강·고용)이 부과됩니다. 국민연금은 보수월액 상한(2026.7~2027.6 연 7,908만원) 적용. 본 계산기는 marginal 방식(연봉+성과급 합산 세금에서 연봉만 기준 세금 차이)으로 정확하게 계산합니다.",
  },
  {
