            ...
            <section className="relative py-16 text-center overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-zinc-400 text-lg">
                        Í≥ÑÍ∏â???ºÍ≥† Î∂ôÏñ¥Î≥¥Ïûê! ?ÅÎÇò?ºÌïú ?∞Î¥â/Î≥µÏ? ?∞Ïä§Îß§Ïπò
                    </p>
                </div>
            </section>
                ...
                <div className="bg-zinc-900/50 backdrop-blur-md border border-zinc-800 rounded-2xl p-6 mb-12 shadow-2xl">
                    <div className="flex flex-col md:flex-row gap-6 items-center">
                        ...
                        <div className="flex flex-col items-center gap-4 min-w-[120px]">
                            ...
                            >
                                <option value="entry">?†ÏûÖ (Entry)</option>
                                <option value="junior">Ï£ºÎãà??(Junior)</option>
                                <option value="senior">?úÎãà??(Senior)</option>
                                <option value="lead">Î¶¨Îìú (Lead)</option>
                                <option value="executive">?ÑÏõê (Exec)</option>
                            </select>
                ...
                {result && (showResult ? (
                                ...
                                <div className="space-y-4">
                                    <div className="bg-zinc-950/50 p-3 rounded-xl">
                                        ...
                                        <p className="text-xl font-bold text-white">
                                            {(result.metrics.totalComp.a / 10000).toLocaleString()}ÎßåÏõê
                                        </p>
                                    </div>
                                    <div className="bg-zinc-950/50 p-3 rounded-xl">
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    <div className="bg-zinc-950/50 p-3 rounded-xl">
                                        <p className="text-xs text-zinc-500 uppercase">Total Comp</p>
                                        <p className="text-xl font-bold text-white">
                                            {(result.metrics.totalComp.b / 10000).toLocaleString()}ÎßåÏõê
                                        </p>
                                    </div>
                                    <div className="bg-zinc-950/50 p-3 rounded-xl">
                                        <p className="text-xs text-zinc-500 uppercase">Real Hourly</p>
                    ...
                    <div className="text-center py-20 animate-pulse">
                        <p className="text-2xl text-zinc-500 font-bold">
                            ?†ÏàòÎ•??†ÌÉù?òÍ≥† <span className="text-red-500">FIGHT!</span> Î≤ÑÌäº???ÑÎ•¥?∏Ïöî.
                        </p>
                    </div>
                ))}
