...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "국민연금 5.0%·최저임금·건강보험 3.595%(2027 동결)는 확정, 장기요양(2027년분 미발표)·고용보험(2027 인상안 심의 중, 법령 개정 전)은 2026년 기준을 준용한 예상표입니다. 소득세는 2026년 누진세액 모델로 추정한 연간 금액을 12개월로 나눈 값이며, 실제 월별 간이세액표를 조회한 결과는 아닙니다. 확정 발표 시 즉시 갱신하며, 올해 확정 기준은 2026 월급 실수령액 표에서 볼 수 있습니다.",
  },
  {
      ...
      <div className="page-width -mt-20 relative z-10">
        ...
        <section className="mt-12 mb-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-faint-blue leading-relaxed mb-4">
              ...
              확정됐고, 장기요양(2027년분 발표 전)·고용보험(2027 인상안 심의 중) 요율은 2026년 기준을 준용했습니다. 소득세는 연간 누진세액 추정의 월 환산액으로 실제 월별 원천징수액과 다를 수 있습니다. 내 월급의 연금 인상 부담만 따로 보려면{" "}
        ...
        <div className="mt-4 text-center text-faint-blue text-sm pb-8">
          * 비과세 식대 월 20만원·본인 1인 공제 기준. 국민연금 5.0%·최저임금·건강보험
          3.595%(2027 동결)는 확정, 장기요양·고용보험은 2026 기준 준용(확정 시 갱신). 소득세는 2026년 연간 세액 추정의 월 환산입니다. 각 행의 상세 페이지는 2026년
          기준입니다.
        </div>
      </div>
    </main>
