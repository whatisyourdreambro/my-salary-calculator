...
const FAQS = [
  ...
  },
  {
    ...
    a: "40년 가입 시 가입 중 평균소득의 약 43%(2026년 적용, 연금개혁 반영)를 연금으로 받게 된다는 의미입니다. 즉 평균소득 400만원이라면 월 약 172만원이 노령연금으로 지급됩니다. 가입기간이 짧을수록 비례 감소하며, 30년이면 약 32.25%, 20년이면 약 21.5% 수준입니다.",
  },
  {
    q: "국민연금 보험료는 얼마를 내나요?",
    a: "직장가입자는 보수월액의 9.5%(본인 4.75% + 회사 4.75%)를 분담합니다. 지역가입자(자영업·프리랜서)는 본인이 9.5% 전액 부담합니다. 보수월액 상한 659만원(2026.7~2027.6)까지 적용되어 월 최대 보험료는 약 62.6만원(본인 부담 약 31.3만원)이며, 그 이상 소득은 추가 보험료 없습니다.",
  },
  {
