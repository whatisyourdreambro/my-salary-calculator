...
export const metadata: Metadata = buildPageMetadata({
 ...
 description:
 "2026 최저시급 10,320원(전년 대비 +290원, 2.9% 인상). 주휴수당 포함 월급 2,156,880원, 연봉 25,882,560원. 시급·월급·연봉 환산표, 적용 시점, 위반 시 처벌 + 2027 최저임금 확정(10,700원) 안내까지 한 번에.",
...
export default function MinimumWage2026Page() {
 ...
 <p className="text-sm leading-7 text-muted-blue mt-4">
 직장인이라면 본인 시급(월급 ÷ 209시간, 연봉 기준이면 ÷ 2,508시간)이 최저임금 이상인지 확인하는 게 중요합니다.
 ...
 className="mt-4 flex items-center justify-between gap-3 p-5 bg-electric rounded-2xl text-white hover:bg-blue-600 transition-colors no-underline"
 >
 <span>
 <span className="block text-base font-black">
 2027 최저임금 10,700원 확정 — 환산표·표결 결과 보기
 </span>
 <span className="block text-sm opacity-90 mt-1">
 주휴 포함 월 2,236,300원 · 실수령액 참고치까지 한 번에
 </span>
 </span>
