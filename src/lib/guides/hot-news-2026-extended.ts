...
<p class="lead">청년우대형 주택청약종합저축은 만 19~34세 청년이 가입하던 청약통장. 2024년 2월 청년주택드림 청약통장 출시로 청년우대형은 신규 가입 불가. 기존 가입자는 별도 신청 없이 청년주택드림으로 자동 전환.</p>

<h2 class="mt-12 text-2xl font-bold text-primary">📋 청년우대형 vs 청년주택드림 비교</h2>
<ul class="space-y-2 mt-4">
<li>· 청년우대형: 신규 가입이 끝난 옛 상품 — 기존 가입자는 청년주택드림으로 자동 전환</li>
<li>· 청년주택드림: 만 19~34세·연소득 5,000만원 이하 무주택자, 출시 발표 최고 연 4.5% + 소득공제 40% × 연 300만원(최대 120만원) + 이자소득 500만원까지 비과세(소득 요건) + 청약 당첨 시 분양대금 최대 80%·2%대 금리 전용 대출 연계</li>
</ul>
<p>청년우대형 기존 가입자는 출시일(2024년 2월 21일)에 별도 신청 없이 청년주택드림으로 전환됐습니다. 우대금리·비과세 요건 충족 여부는 가입 은행에서 확인하세요.</p>
...
<p class="lead">의료비·교육비·기부금은 모두 <strong>15% 세액공제</strong>이고 한도 구조만 다릅니다. 2026년 귀속 기준 의료비는 총급여 3%를 넘는 금액부터 공제되며 일반 부양가족분은 연 700만원 한도, 본인·6세 이하·65세 이상·장애인·중증질환자 등의 의료비는 한도가 없습니다(미숙아·선천성이상아 20%, 난임시술 30%). 교육비는 본인 한도 없이, 취학 전 아동·초중고생 1명당 연 300만원, 대학생 900만원까지이고, 기부금은 1천만원을 넘는 부분에 30%를 적용하며 일반기부금은 소득금액의 30%(종교단체 기부가 있으면 10%에 추가분)가 한도입니다. 기준일은 2026년 9월 26일, 근거는 소득세법 제59조의4입니다.</p>

<h2>세 항목 한도·공제율 한 표</h2>
<table class="w-full text-sm">
<thead><tr><th>구분</th><th>대상</th><th>한도</th><th>공제율</th></tr></thead>
<tbody>
<tr><td>의료비 — 일반</td><td>아래에 해당하지 않는 기본공제대상자 (나이·소득 무관)</td><td>연 700만원 (총급여 3% 초과분)</td><td>15%</td></tr>
<tr><td>의료비 — 본인 등</td><td>본인, 6세 이하, 65세 이상, 장애인, 중증질환자 등</td><td>없음</td><td>15%</td></tr>
<tr><td>의료비 — 미숙아·선천성이상아</td><td>해당 치료비</td><td>없음</td><td>20%</td></tr>
<tr><td>의료비 — 난임시술</td><td>보조생식술과 관련 처방 의약품</td><td>없음</td><td>30%</td></tr>
<tr><td>교육비 — 본인</td><td>대학·대학원, 직업능력개발훈련, 학자금대출 상환</td><td>없음</td><td>15%</td></tr>
<tr><td>교육비 — 취학 전·초중고</td><td>1명당</td><td>연 300만원</td><td>15%</td></tr>
<tr><td>교육비 — 대학생</td><td>1명당 (가족의 대학원은 제외)</td><td>연 900만원</td><td>15%</td></tr>
<tr><td>교육비 — 장애인 특수교육비</td><td>직계존속 포함</td><td>없음</td><td>15%</td></tr>
<tr><td>기부금 — 특례</td><td>국방헌금·위문금품 등</td><td>근로소득금액 전액</td><td>15% (1천만원 초과분 30%)</td></tr>
<tr><td>기부금 — 일반 (종교단체 외)</td><td>지정된 사회복지·문화·예술단체 등</td><td>소득금액 30%</td><td>15% (1천만원 초과분 30%)</td></tr>
<tr><td>기부금 — 종교단체</td><td>주무관청에 등록된 종교단체</td><td>소득금액 10% + 종교 외 기부액 중 소득금액 20% 이내</td><td>15% (1천만원 초과분 30%)</td></tr>
</tbody>
</table>
<p>세액공제는 소득세에서 바로 빼는 금액이고, 지방소득세(10%)는 그에 맞춰 따로 줄어듭니다.</p>

<h2>의료비 — 3% 문턱과 700만원 한도 계산 순서</h2>
<p>의료비는 실손보험금 등으로 돌려받은 금액을 먼저 빼고, 다음 순서로 계산합니다(소득세법 제59조의4 제2항).</p>
<ol>
<li>일반 부양가족 의료비에서 총급여의 3%를 뺍니다. 남은 금액은 연 700만원까지만 인정됩니다.</li>
<li>일반 부양가족 의료비가 3%에 못 미치면, 모자란 금액을 본인·6세 이하·65세 이상·장애인·중증질환자 등 한도가 없는 의료비에서 뺍니다.</li>
<li>그래도 모자라면 미숙아·선천성이상아 의료비, 그다음 난임시술비에서 뺍니다.</li>
<li>남은 금액에 공제율(일반·본인 등 15%, 미숙아·선천성이상아 20%, 난임시술 30%)을 곱합니다.</li>
</ol>
<table class="w-full text-sm">
<thead><tr><th>총급여 5,000만원 (문턱 150만원)</th><th>공제 대상</th><th>세액공제</th></tr></thead>
<tbody>
<tr><td>60세 부모님 의료비 900만원</td><td>750만원 → 한도 700만원</td><td>105만원</td></tr>
<tr><td>60세 부모님 400만원 + 본인 100만원</td><td>250만원 + 100만원</td><td>52만5,000원</td></tr>
<tr><td>본인 400만원 + 60세 부모님 100만원</td><td>본인분에서 모자란 문턱 50만원을 빼 350만원</td><td>52만5,000원</td></tr>
</tbody>
</table>
<p>65세 이상(2026년 귀속은 1961년 12월 31일 이전 출생) 부모님이었다면 첫 줄은 한도 없이 750만원 전체가 대상이 돼 112만5,000원입니다. 임플란트·안경·한약·간병비 같은 항목별 공제 여부는 <a href="/guides/implant-dental-medical-deduction-2026">의료비 세액공제 항목 정리</a>에서, 금액 계산은 <a href="/medical-tax-credit-2026">의료비 세액공제 계산기</a>에서 확인하세요.</p>

<h2>교육비 — 한도 안에 드는 지출과 빠지는 지출</h2>
<ul>
<li><strong>포함</strong>: 학교 수업료·입학금, 급식비, 교과서대, 방과후 수업료(학교에서 산 교재 포함), 중·고등학생 교복 구입비(1명당 연 50만원), 초·중·고 현장체험학습비(1명당 연 30만원), 취학 전 아동의 학원·체육시설 수강료(월 단위·주 1회 이상 과정)</li>
<li><strong>2026년 신설</strong>: 과세기간 종료일 현재 9세 미만이거나 초등 2학년 이하인 자녀의 예능 학원·체육시설 수강료(월 단위·주 1회 이상 과정)가 1명당 300만원 한도 안에서 공제됩니다(2026년 1월 1일 이후 지출분).</li>
<li><strong>제외</strong>: 자녀·배우자의 대학원 교육비, 부모님 교육비(장애인 특수교육비는 가능), 자녀가 학자금대출로 낸 등록금(본인이 대출을 갚을 때 본인 교육비로 공제), 소득세·증여세가 비과세되는 교육비(근로자 본인의 비과세 학자금 등)</li>
<li><strong>대상 가족 요건</strong>: 교육비는 원래 가족의 나이를 따지지 않고, 2025년 12월 개정으로 2026년 지급분부터는 조문의 소득 제한 문구도 빠졌습니다(소득세법 제59조의4 제3항). 실제 적용 범위는 2027년 초 국세청 연말정산 안내로 한 번 더 확인하세요.</li>
</ul>
<p>자녀 학년별 한도와 예시는 <a href="/guides/child-education-deduction-limit-2026">자녀 교육비 공제 한도</a>에서 이어서 볼 수 있습니다.</p>

<h2>기부금 — 종류별 한도와 10년 이월</h2>
<ul>
<li><strong>공제율</strong>: 기부금 합계의 15%, 1천만원을 넘는 부분은 30%입니다. 2024년 한 해에만 있던 '3천만원 초과분 10%p 추가 공제'는 2026년에는 없습니다.</li>
<li><strong>종교단체 한도</strong>: 종교단체 기부만 있으면 소득금액의 10%까지, 종교단체 외 일반기부금도 있으면 10%에 '종교 외 기부액과 소득금액 20% 중 작은 금액'을 더한 금액까지입니다.</li>
<li><strong>부양가족 기부금</strong>: 소득 요건을 갖춘 배우자·부양가족이 낸 기부금도 나이와 관계없이 합칩니다(다른 사람이 기본공제한 가족은 제외). 정치자금·고향사랑기부금·우리사주조합기부금은 근로자 본인 기부분만 공제됩니다.</li>
<li><strong>정치자금·고향사랑기부금</strong>: 10만원까지는 110분의 100을 세액공제해 지방소득세까지 합치면 사실상 전액 돌아옵니다. 10만원을 넘는 부분의 공제율은 기부처마다 달라 <a href="/donation-tax-credit-2026">기부금 세액공제 계산기</a>로 확인하세요.</li>
<li><strong>이월</strong>: 한도를 넘었거나 산출세액이 모자라 공제받지 못한 기부금(정치자금·고향사랑·우리사주조합기부금 제외)은 다음 해부터 10년 동안 넘겨 공제합니다(소득세법 제61조).</li>
</ul>

<h2>성과급 받는 해에도 공제율은 그대로</h2>
<p>세 항목은 모두 세액공제라서 성과급으로 세율 구간이 올라가도 공제율이 커지지 않습니다. 의료비 100만원을 인정받으면 한계세율이 15%든 35%든 소득세는 15만원 줄어듭니다. 대신 성과급은 다음 세 가지를 바꿉니다.</p>
<ul>
<li><strong>의료비 문턱 상승</strong>: 총급여가 6,000만원에서 7,000만원으로 늘면 문턱도 180만원에서 210만원으로 올라갑니다.</li>
<li><strong>기부금 한도 확대</strong>: 소득금액이 늘어 일반기부금 한도(소득금액 30%)도 함께 커집니다.</li>
<li><strong>공제를 다 쓸 여유</strong>: 보험료·의료비·교육비·월세 세액공제 합계가 근로소득 산출세액을 넘으면 넘는 부분은 사라지는데(소득세법 제61조), 성과급으로 산출세액이 커지면 이렇게 사라지는 금액이 줄어듭니다.</li>
</ul>
<p>챙길 항목이 거의 없다면 표준세액공제 13만원이 적용됩니다. 다만 건강보험료 등 특별소득공제, 보험료·의료비·교육비·기부금 특별세액공제, 월세 세액공제를 하나라도 받으면 표준세액공제는 받을 수 없고, 홈택스 모의계산은 유리한 쪽을 자동으로 적용합니다. 부부가 나눠 받을 때의 기준은 <a href="/guides/couple-split-bonus-year-2026">맞벌이 몰아주기 정리</a>에서 볼 수 있습니다.</p>

<h2>자주 묻는 질문</h2>
<ul>
<li><strong>Q. 부모님 의료비도 700만원 한도인가요?</strong> — 65세 이상(2026년 귀속은 1961년 12월 31일 이전 출생) 부모님 의료비는 한도가 없고, 65세 미만이면 일반 부양가족으로 연 700만원 한도가 적용됩니다.</li>
<li><strong>Q. 대학원 등록금은 공제되나요?</strong> — 근로자 본인의 대학원 등록금은 한도 없이 15% 공제되지만, 자녀·배우자 등 가족의 대학원 교육비는 대상이 아닙니다.</li>
<li><strong>Q. 교회·절에 낸 헌금도 공제되나요?</strong> — 주무관청에 등록된 종교단체에 낸 기부금은 일반기부금으로 15%(1천만원 초과분 30%) 공제되고, 한도는 소득금액의 10%(종교 외 기부가 있으면 추가)입니다. 기부금 영수증이 필요합니다.</li>
<li><strong>Q. 실손보험금을 다음 해에 받았다면 어떻게 하나요?</strong> — 보험금을 받게 된 원인이 된 연도의 의료비에서 뺍니다. 이미 그 의료비로 공제를 받았다면 보험금을 받은 해의 종합소득세 확정신고 기한까지 수정신고하면 가산세가 면제됩니다.</li>
</ul>
<p>근거: <a href="https://www.law.go.kr/법령/소득세법/제59조의4" target="_blank" rel="noopener noreferrer">소득세법 제59조의4(특별세액공제)</a> · <a href="https://www.law.go.kr/법령/소득세법/제61조" target="_blank" rel="noopener noreferrer">제61조(세액공제의 산출세액 초과 시 적용)</a> · <a href="https://www.law.go.kr/법령/소득세법시행령/제118조의6" target="_blank" rel="noopener noreferrer">시행령 제118조의6(교육비)</a> · <a href="https://www.nts.go.kr/nts/cm/cntnts/cntntsView.do?cntntsId=7874&amp;mi=6595" target="_blank" rel="noopener noreferrer">국세청 특별세액공제 안내</a> · <a href="https://call.nts.go.kr/call/qna/selectQnaInfo.do?mi=1318&amp;ctgId=CTG11909" target="_blank" rel="noopener noreferrer">국세상담센터 의료비 상담사례</a>. 기준일: 2026년 9월 26일.</p>
<p>함께 보기: <a href="/guides/year-end-tax-2026">2026년 귀속 연말정산 공제 총정리</a> · <a href="/guides/donation-tax-credit">기부금 세액공제 가이드</a> · <a href="/year-end-tax">연말정산 계산기</a></p>
`;
...
<p class="lead">보장성 보험료 세액공제는 만기에 돌려받는 금액이 낸 보험료보다 많지 않은 보험의 보험료에 대해 <strong>연 100만원 한도로 12%</strong>를 공제합니다. 장애인전용 보장성보험은 별도로 연 100만원 한도에 15%라, 둘을 합친 최대 공제액은 27만원(지방소득세 포함 29만7,000원)입니다. 피보험자는 나이·소득 요건을 모두 갖춘 기본공제대상자여야 하고, 맞벌이 부부가 소득 있는 배우자를 피보험자로 한 보험은 둘 다 공제받지 못합니다. 기준일은 2026년 9월 26일, 근거는 소득세법 제59조의4 제1항입니다.</p>

<h2>공제 한도와 공제율</h2>
<table class="w-full text-sm">
<thead><tr><th>구분</th><th>대상</th><th>한도</th><th>공제율</th><th>최대 공제</th></tr></thead>
<tbody>
<tr><td>일반 보장성보험</td><td>생명·상해보험, 가계 손해보험(자동차·화재 등), 수협·신협·새마을금고 공제, 군인·교직원 등 공제회 공제</td><td>연 100만원</td><td>12%</td><td>12만원</td></tr>
<tr><td>장애인전용 보장성보험</td><td>계약서·납입영수증에 장애인전용으로 표시된 보험 (장애인이 피보험자 또는 수익자)</td><td>연 100만원 (별도)</td><td>15%</td><td>15만원</td></tr>
<tr><td>주택 임차보증금 반환보증</td><td>보증대상 보증금이 3억원 이하인 보험·보증</td><td>일반 보장성 한도에 포함</td><td>12%</td><td>일반 보장성과 합산</td></tr>
</tbody>
</table>
<p>최대 공제액은 소득세 기준이고, 지방소득세(10%)가 따로 줄어듭니다. 공제 대상인지는 보험 이름이 아니라 <strong>만기에 돌려받는 금액이 낸 보험료보다 많지 않은지</strong>로 가립니다. 연말정산 간소화 자료의 보장성 보험료 항목에서 먼저 확인하세요.</p>

<h2>계약자·피보험자 조합별 공제 여부</h2>
<p>근로자가 보험료를 실제로 내고, 피보험자가 <strong>나이·소득 요건을 모두 갖춘</strong> 본인의 기본공제대상자여야 합니다. 계약자도 근로자 본인이거나 그 기본공제대상자여야 합니다. 국세상담센터 사례로 정리하면 다음과 같습니다.</p>
<table class="w-full text-sm">
<thead><tr><th>계약자</th><th>피보험자</th><th>공제</th><th>이유</th></tr></thead>
<tbody>
<tr><td>근로자 본인</td><td>본인</td><td>O</td><td>본인은 기본공제대상자</td></tr>
<tr><td>근로자 본인</td><td>소득 요건(소득금액 100만원 이하)을 갖춘 배우자, 20세 이하 자녀, 60세 이상 부모님</td><td>O</td><td>나이·소득 요건을 갖춘 기본공제대상자</td></tr>
<tr><td>근로자 본인</td><td>본인과 배우자 공동 (주·종피보험자)</td><td>O</td><td>종피보험자도 피보험자에 포함</td></tr>
<tr><td>소득 없는 배우자·부모님</td><td>기본공제대상자</td><td>O</td><td>근로자가 보험료를 실제로 부담한 경우</td></tr>
<tr><td>근로자 본인 (맞벌이)</td><td>소득 있는 배우자</td><td>X</td><td>배우자가 기본공제대상자가 아니어서 부부 모두 공제 불가</td></tr>
<tr><td>배우자 (맞벌이)</td><td>남편이 기본공제한 자녀</td><td>X</td><td>남편은 보험료를 내지 않았고, 아내에게는 자기 기본공제대상자가 아님</td></tr>
<tr><td>근로자 본인</td><td>20세를 넘은 대학생 자녀</td><td>X</td><td>나이 요건 미충족</td></tr>
<tr><td>근로자 본인</td><td>태아</td><td>X</td><td>출생 전이라 기본공제대상자가 아님</td></tr>
<tr><td>동생</td><td>형이 기본공제한 부모님</td><td>X</td><td>동생의 기본공제대상자가 아니고, 형은 보험료를 내지 않음</td></tr>
</tbody>
</table>
<p>맞벌이 부부라면 자기를 피보험자로 하는 보험은 자기가 계약하고 자기 돈으로 내는 것이 공제 누락을 막는 가장 단순한 방법입니다.</p>

<h2>공제되는 보험과 안 되는 보험</h2>
<ul>
<li><strong>공제</strong>: 실손의료보험, 암·종신·정기·상해보험, 어린이보험 같은 보장성보험, 개인 자동차보험·운전자보험, 주택 화재보험, 보증금 3억원 이하 전세보증금 반환보증 보험료</li>
<li><strong>제외</strong>: 만기환급금이 낸 보험료보다 많은 저축성 보험, 자동차 리스료에 포함돼 리스회사에 내는 자동차보험료, 근로소득으로 보지 않는 회사 단체보장성보험 보험료</li>
<li><strong>따로 공제되는 보험료</strong>: 국민연금·건강보험·고용보험료는 이 세액공제가 아니라 소득공제로 따로 빠지고, 연금저축·IRP 납입액은 연금계좌 세액공제로 따로 계산합니다.</li>
<li><strong>카드 공제와 중복 안 됨</strong>: 보험료는 카드로 내도 신용카드 사용액에 들어가지 않습니다(조세특례제한법 시행령 제121조의2 제6항).</li>
</ul>
<p>회사가 대신 내 준 보장성 보험료는 그만큼 급여에 더해진 경우에만 공제받을 수 있습니다.</p>

<h2>납입액별로 줄어드는 세금</h2>
<table class="w-full text-sm">
<thead><tr><th>연간 보장성 보험료</th><th>공제 대상</th><th>세액공제</th><th>지방소득세 포함</th></tr></thead>
<tbody>
<tr><td>월 5만원 (연 60만원)</td><td>60만원</td><td>7만2,000원</td><td>7만9,200원</td></tr>
<tr><td>월 8만원 (연 96만원)</td><td>96만원</td><td>11만5,200원</td><td>12만6,720원</td></tr>
<tr><td>월 10만원 (연 120만원)</td><td>100만원 (한도)</td><td>12만원</td><td>13만2,000원</td></tr>
<tr><td>일반 연 120만원 + 장애인전용 연 100만원</td><td>100만원 + 100만원</td><td>27만원 (12만원 + 15만원)</td><td>29만7,000원</td></tr>
</tbody>
</table>
<p>세액공제는 낼 세금이 있을 때만 효과가 있습니다. 보험료·의료비·교육비·월세 세액공제 합계가 근로소득 산출세액을 넘으면 넘는 부분은 사라집니다(소득세법 제61조). 또 보험료 같은 특별세액공제를 신청하면 표준세액공제 13만원은 받을 수 없는데, 홈택스 모의계산은 둘 중 유리한 쪽을 자동으로 적용합니다.</p>

<h2>납입 시점·해지·연중 변동</h2>
<ul>
<li><strong>낸 해에 공제</strong>: 보험료는 실제로 낸 해에 공제합니다. 다음 해분을 12월에 미리 냈다면 낸 해에, 12월분을 다음 해 1월에 냈다면 다음 해에 공제합니다.</li>
<li><strong>중도 해지</strong>: 해지한 해에도 그해 낸 보장성 보험료는 100만원 한도 안에서 공제됩니다. 해지하면 그해 공제가 안 되는 연금저축과 다릅니다.</li>
<li><strong>가족이 연중 취업·혼인</strong>: 자녀가 취업해 기본공제대상자에서 빠져도 그 사유가 생긴 날까지 낸 보험료는 공제됩니다(소득세법 제59조의4 제5항).</li>
<li><strong>근로 기간</strong>: 입사 전·퇴사 후에 낸 보험료는 빠지고, 휴직 기간에 낸 보험료는 포함됩니다.</li>
</ul>
<p>부모님을 피보험자로 할 때의 요건은 <a href="/guides/parent-support-deduction-integration-2026">부모님 부양가족 공제</a>에서, 다른 공제와 합친 환급은 <a href="/year-end-tax">연말정산 계산기</a>에서 확인하세요.</p>

<h2>자주 묻는 질문</h2>
<ul>
<li><strong>Q. 실손보험료도 공제되나요?</strong> — 네. 실손의료보험은 보장성보험이라 다른 보장성 보험료와 합쳐 연 100만원 한도 안에서 12% 공제됩니다. 실손보험금을 받았다면 의료비 세액공제에서는 그 금액을 빼야 합니다.</li>
<li><strong>Q. 자동차보험료도 되나요?</strong> — 근로자 본인이나 기본공제대상자를 피보험자로 한 자동차보험료는 가계 손해보험이라 대상입니다. 다만 리스료에 포함돼 리스회사에 내는 보험료는 리스료의 일부라 공제되지 않습니다.</li>
<li><strong>Q. 부모님 보험료를 대신 내 드리면 공제되나요?</strong> — 부모님이 본인의 기본공제대상자(60세 이상·소득금액 100만원 이하)이고 본인이 보험료를 실제로 냈다면 공제됩니다. 형제가 부모님을 기본공제하고 있다면 누구도 공제받지 못합니다.</li>
<li><strong>Q. 보험료를 카드로 내면 카드 공제도 받나요?</strong> — 아닙니다. 보험료는 신용카드 사용액에서 빠지므로 보험료 세액공제만 받습니다.</li>
</ul>
<p>근거: <a href="https://www.law.go.kr/법령/소득세법/제59조의4" target="_blank" rel="noopener noreferrer">소득세법 제59조의4 제1항</a> · <a href="https://www.law.go.kr/법령/소득세법시행령/제118조의4" target="_blank" rel="noopener noreferrer">시행령 제118조의4(보험료세액공제)</a> · <a href="https://call.nts.go.kr/call/qna/selectQnaInfo.do?mi=1318&amp;ctgId=CTG11908" target="_blank" rel="noopener noreferrer">국세상담센터 보험료 세액공제 상담사례</a> · <a href="https://www.nts.go.kr/nts/cm/cntnts/cntntsView.do?cntntsId=7874&amp;mi=6595" target="_blank" rel="noopener noreferrer">국세청 특별세액공제 안내</a>. 기준일: 2026년 9월 26일.</p>
...
// ── executive-severance-limit-2026 (2026-09-26 키퍼 재작성, GUIDES-05) ──
...
export const hotNewsExtended: Guide[] = [
  ...
  // 직장인 세부 절세 10편
  { slug: "earned-income-deduction-2026", title: "근로소득공제·근로소득세액공제 2026 구간표와 한도", description: "근로소득공제는 총급여 구간별 70~2%(한도 2,000만원), 세액공제는 산출세액의 55%·30%에 한도 74만~20만원.", metaDescription: "근로소득공제는 총급여 5,000만원이면 1,225만원, 한도 2,000만원입니다. 근로소득세액공제 55%·30% 산식과 총급여별 한도 74만~20만원, 1인 가구 계산 예시를 정리했습니다.", category: "세금", tags: ["근로소득공제", "근로소득세액공제", "직장인", "절세", "2026"], level: "중급", publishedDate: "2026-05-23", modifiedDate: "2026-09-26", views: 0, content: earnedIncomeDeduction, lang: "ko" },
  { slug: "standard-vs-special-deduction-2026", title: "표준세액공제 13만원 vs 특별공제 — 건보료까지 비교", description: "표준세액공제 13만원은 건강보험료 공제와 의료비·교육비 등 특별공제를 하나도 신청하지 않을 때만 받습니다.", metaDescription: "표준세액공제 13만원은 건강·고용보험료 소득공제와 의료비·교육비·보험료·기부금 세액공제를 모두 포기할 때 받습니다. 1인 가구 총급여별 유불리와 의료비 80만원 사례를 계산했습니다.", category: "세금", tags: ["표준세액공제", "특별세액공제", "의료비", "절세", "2026"], level: "초급", publishedDate: "2026-05-23", modifiedDate: "2026-09-26", views: 0, content: standardDeductionVsSpecial, lang: "ko" },
  // W3-A 1차 키퍼 재작성 — 소득세법 §59의4·§61, 시행령 §118의6, 국세청 안내 (사실 원장 docs/guides-facts-2026-10-G1A.md)
  { slug: "medical-edu-donation-limits-2026", title: "의료비·교육비·기부금 세액공제 한도 2026", description: "의료비 15%(총급여 3% 초과, 일반 700만), 교육비 초중고 300만·대학 900만, 기부금 1천만 초과분 30%.", metaDescription: "2026년 귀속 의료비·교육비·기부금 세액공제 한도를 한 표로 정리했습니다. 의료비는 총급여 3% 초과분의 15%, 교육비는 초중고 300만·대학생 900만원, 기부금은 1천만원 초과분 30%입니다.", category: "세금", tags: ["의료비공제", "교육비공제", "기부금공제", "한도", "2026"], level: "중급", publishedDate: "2026-05-23", modifiedDate: "2026-09-26", views: 0, content: medicalEduDonation, lang: "ko" },
