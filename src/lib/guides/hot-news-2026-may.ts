...
<li>일반 부양가족 의료비(본인·6세 이하·65세 이상·장애인 외)에서 총급여의 3%를 빼고, 남은 금액은 연 700만원까지만 인정합니다.</li>
<li>일반 부양가족 의료비가 3%에 못 미치면 모자란 금액을 본인·6세 이하·65세 이상·장애인 의료비에서 빼고, 그래도 남으면 미숙아·선천성이상아 의료비, 그다음 난임시술비에서 뺍니다.</li>
