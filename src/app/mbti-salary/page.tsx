...
export default function MbtiSalaryPage() {
 ...
 <div className="absolute inset-0 z-0 opacity-10 40">
 {[...Array(50)].map((_, i) => (
 <div
 key={i}
 ...
 <h1 className="text-4xl sm:text-6xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-[#3D7FF5] 300">
 당신의 부(富)는
 <br />
 어떤 모습일까요?
 </h1>
 ...
 <p className="text-center text-light-text-secondary 300 max-w-md mx-auto">
 {result.description}
 </p>
 ...
 <div>
 <p className="font-semibold text-faint-blue ">
 STEP {plan.step}
 </p>
 <h4 className="font-bold text-lg mt-1">
 {plan.title}
 </h4>
 <p className="text-sm text-light-text-secondary 300 mt-2">
 {plan.description}
 </p>
 <Link
 href={plan.link}
