...
export default function AnnualTableInteractive({
  ...
  const [nonTaxableAmount, setNonTaxableAmount] = useState(2400000);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <div className="bg-card p-6 sm:p-8 rounded-2xl shadow-xl border border-border">
            <h2 className="text-2xl font-bold mb-6">연봉별 실수령액 시뮬레이터 (2026년 예상)</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="space-y-6">
                  <div>
                    <Label htmlFor="annual-salary" className="text-lg">연봉: {annualSalary.toLocaleString()}원</Label>
                    <Slider
                      id="annual-salary"
                      min={10000000}
                      max={200000000}
        ...
        <div className="space-y-8">
            <div className="bg-card p-6 rounded-2xl shadow-xl border border-border">
                ...
                <div className="mt-4 space-y-2 text-muted-foreground">
                    <div className="flex justify-between"><span>세전 월급</span><span>{(annualSalary / 12).toLocaleString()}원</span></div>
