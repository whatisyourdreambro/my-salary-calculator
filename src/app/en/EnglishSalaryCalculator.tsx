      ...
      <div className="rounded-3xl border border-border bg-background p-5 sm:p-8">
        ...
        <details className="mt-5 rounded-xl border border-border p-4">
          ...
          <div className="mt-3 space-y-3 text-sm text-muted-foreground">
            <p>The annual salary is spread over twelve equal months. National tax is the official monthly withholding-table amount for the modeled pay, not a year-end settlement result or refund. Bonuses, irregular pay and actual year-end deductions can change each payslip and final tax.</p>
