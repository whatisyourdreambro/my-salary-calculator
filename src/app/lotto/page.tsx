...
const getNumberColorClass = (number: number): string => {
 ...
 return "bg-canvas-deeper text-white shadow-inner shadow-black/20";
 ...
 return "bg-canvas-deeper text-navy shadow-inner shadow-black/20";
};
...
export default function LottoPage() {
 ...
 disabled={isLoading}
 className="flex-1 py-4 bg-gradient-to-r from-green-500 to-primary/80 text-navy font-bold rounded-xl hover:brightness-110 transition-all shadow-lg shadow-green-500/20 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transform active:scale-95"
 >
 ...
 <div className="flex flex-col items-center">
 <span>ODD</span>
 <span className="text-electric">{set.analysis.oddCount}</span>
 </div>
 <div className="w-px h-full bg-border" />
 <div className="flex flex-col items-center">
 <span>HIGH</span>
 <span className="text-electric">{set.analysis.highCount}</span>
 </div>
 </div>
 </div>
 </div>
