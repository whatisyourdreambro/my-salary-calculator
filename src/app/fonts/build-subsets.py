...
definitions = ['// Generated by build-subsets.py from reviewed korean-subsets.json.\n// Keep every subset ahead of system fallbacks; an automatic Latin fallback can\n// intercept Korean glyphs before their matching subset is considered.\nimport localFont from "next/font/local";\n']
variables = []
for label, selected in parts.items():
    ...
    preload = "true" if label in ("Latin", "Korean") else "false"
