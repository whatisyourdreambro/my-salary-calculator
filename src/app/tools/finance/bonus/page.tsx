...
/**
 * 성과급에 대한 4대보험 계산
 * - 국민연금: 4.75% (상한: 월 637만원 기준 → 연 7,644만원 이상이면 상한 적용)
...
function calcInsurance(bonus: number, annualSalary: number): {
  ...
  // 국민연금: 연 소득 상한 6,370만원×12월×4.75% 기준
  //   → 연봉이 이미 상한 초과 시 성과급에는 추가 부과 없음
  const pensionCeiling = 76_440_000; // 637만×12
              ...
              >
                ...
                <div className="px-6 py-4 flex gap-3" style={{ backgroundColor: "#F8FAFB", borderTop: "1px solid #DDE4EC" }}>
                  ...
                  <p className="text-xs leading-relaxed" style={{ color: "#7A9AB5" }}>
                    ...
                    국민연금 상한액(월 637만원)은 연봉 기준으로 적용되어 이미 상한을 초과하면
...
const GLOSSARY_TERMS = [
  ...
  { term: "4대보험 (성과급 부과)",          emoji: "🔐", def: "성과급도 근로소득이므로 국민연금·건강보험·고용보험이 부과됩니다. 단, 국민연금은 월 637만원 상한이 있어 연봉이 이미 초과하면 추가 없습니다.", tip: "산재보험료는 사업주 전액 부담이므로 근로자 부담 4대보험은 3가지입니다." },
];
