...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "현재 연봉 5,000만원 + 10% 인상 = 5,500만원 기준 세후 연 실수령은 약 377만원 증가, 월 약 31만원 늘어납니다(비과세 식대 월 20만원·본인 1인 기준). 누진세 구간 진입 정도에 따라 다르며, 본 계산기에서 정확한 본인 케이스를 시뮬레이션할 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "누진세율 구간 진입 여부가 핵심입니다. 연봉 5,000만→5,500만 인상은 15% 구간 내라 인상분의 약 75%가 남지만, 연봉이 약 1억 1천만원을 넘어 과세표준 8,800만원 초과분에 35% 세율이 붙으면 세금·4대보험을 빼고 인상분의 약 57%만 남습니다. 본 계산기의 '실수령 유지율' 지표로 인상액 중 본인 몫이 얼마인지 즉시 확인 가능합니다.",
  },
  {
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <article className="prose prose-sm sm:prose-base dark:prose-invert max-w-none mb-10">
            ...
            <p className="text-muted-blue dark:text-canvas-300 leading-relaxed">
              ...
              비율을 보여줍니다. 예) 24% 구간 내 인상은 유지율 65~70%, 35% 구간
              진입 후 인상은 54~57% 수준입니다.
            </p>
            ...
            <p className="text-muted-blue dark:text-canvas-300 leading-relaxed">
              ...
              차이가 약 3,300만원에 달합니다. 본 계산기에서 본인 인상률 시나리오의
              5년 효과를 정량 확인하세요.
            </p>
          ...
          <div className="rounded-2xl p-5 mb-8 flex gap-3 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800">
            ...
            <div>
              ...
              <p className="text-xs text-amber-800 dark:text-amber-300 leading-relaxed">
                세후 계산은 4대보험·간이세액표 기준(식대 비과세 월 20만원·본인
                1인) 추정치. 실제 금액은 부양가족, 의료비·기부 등 세액공제, 회사
                비과세 항목에 따라 다릅니다. 5년 누적은 매년 동일 인상률
                유지 가정.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-5 mb-8 flex gap-3 bg-electric-5 border border-electric-20">
            ...
            <p className="text-xs text-muted-blue dark:text-canvas-300 leading-relaxed">
              ...
              비과세 식대 월 20만·1인 기준, 5년 누적은 매년 동일 인상률 유지 가정.
