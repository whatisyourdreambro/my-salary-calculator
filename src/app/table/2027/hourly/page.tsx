...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "시급 × 209시간(주휴 포함)을 세전 월급으로 환산한 뒤 2027년 국민연금 5.0%(확정 인상)·건강보험 3.595%(동결 확정)와 장기요양·고용보험·소득세(2026 기준 준용)를 공제한 참고치입니다. 근로 시간이 짧아 4대보험 가입 대상이 아니거나 3.3% 원천징수로 처리되는 알바는 실제 수령액이 다를 수 있습니다.",
  },
  {
...
const structuredData = [
  datasetLd({
    ...
    description:
      "2027년 최저시급 10,700원 확정과 국민연금 5.0% 인상을 반영한 시급 구간별 월 환산 실수령액 데이터 표 (건강보험 2027 동결 확정 반영, 장기요양·고용보험은 2026 준용).",
