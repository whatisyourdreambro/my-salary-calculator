...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildPageMetadata({
    title: `${industry.name} 업계 연봉 2026 — 신입~경력별 평균 연봉·실수령액`,
    description: `${industry.name} 업계 평균 연봉 ${industry.salary.overall.toLocaleString()}만원. 신입 ${industry.salary.entry.avg.toLocaleString()}만원~, 시니어 ${industry.salary.senior.avg.toLocaleString()}만원~ 수준. 2026년 최신 데이터 기준 실수령액 계산기 제공.`,
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 mb-6 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              ...
              <div className="sm:text-right flex-shrink-0">
                <div className="text-sm text-gray-500 dark:text-gray-400">업계 평균</div>
