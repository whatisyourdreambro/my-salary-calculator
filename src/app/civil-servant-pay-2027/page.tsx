...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "보수위는 인상률과 함께 ① 5급 이하 초과근무수당 지급률 55%→60% 상향 ② 직급보조비 인상(6급 3만5천원, 7급 2만5천원, 8·9급 2만원 인상)을 권고했습니다. 예산안에 인상률은 권고 상한으로 반영됐고, 수당 항목의 세부 반영 내용은 인사혁신처의 처우개선안 발표와 최종 보수규정 개정에서 확인해야 합니다. (출처: 공무원보수위원회 2026-07-23 의결 보도)",
  },
  {
    question: "2026년 인상률은 얼마였나요? (참고 기준)",
    answer:
      `2026년은 전체 3.5% 인상으로 2017년 이후 최고였고, 7~9급 저연차 구간은 처우개선 가산을 더해 최대 6.6% 인상됐습니다. 9급 1호봉 월 봉급은 2,133,000원, 수당 포함 초임 보수는 연 3,428만원이었습니다. 예산안의 ${pct}%가 그대로 반영될 경우 2027년에는 2011년 이후 16년 만의 최대 인상률이 됩니다.`,
  },
  {
    question: "확정 봉급표는 언제, 어디서 확인할 수 있나요?",
    answer:
      "통상 연말 공무원보수규정 개정과 함께 인사혁신처(mpm.go.kr)가 이듬해 봉급표를 공표합니다. 2027년 표의 정확한 발표일·시행일은 실제 공표 자료로 확인해야 합니다. 현재 시행 중인 표는 2026 공무원 봉급표 페이지에서 확인하세요.",
  },
  {
    question: "이 페이지의 예상 월급은 얼마나 정확한가요?",
    answer:
      `본 예상표는 2026년 확정 봉급표에 예산안 인상률 ${pct}%를 단순 적용한 계산입니다. 정부가 예고한 7~9급 초임 추가 인상, 국회 심의 과정의 조정, 수당 개편이 더해지면 확정 봉급표와 차이가 날 수 있습니다. 최종 봉급표 공표 전까지 참고용으로 활용하세요.`,
  },
];
      ...
      <div className="page-width">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-6 inline-flex items-start gap-2 text-xs text-amber-800 px-4 py-2 bg-amber-50 rounded-xl border border-amber-200 max-w-xl text-left">
            ...
            <span>
              ...
              봉급표가 아닙니다. 저연차 추가 인상·국회 심의 조정은 미반영입니다.
              최종표와 시행일은 연말 보수규정 개정·공표 자료를 확인해야 합니다.
            </span>
          </p>
        </div>
        ...
        <section className="mt-10 mb-12 max-w-3xl mx-auto">
          ...
          <ol className="space-y-3">
            {[
              ...
              {
                step: "2",
                title: `정부 예산안 — ${pct}% 반영 보도 (9/1)`,
                desc: `예산안 보도 기준으로 ${pct}%가 반영됐습니다. 이 단계는 정부안 제시이며, 호봉별 봉급표의 최종 확정 단계가 아닙니다. 수당 포함 초임 보수와 기본 봉급도 서로 구분해야 합니다.`,
                done: true,
              },
              {
                step: "3",
                title: "국회 예산 심의 — 9~12월 (진행 중)",
                desc: "국회 심의 과정에서 예산안이 조정될 수 있습니다. 의결된 예산과 보수규정 개정 내용을 확인하기 전에는 이 예상표를 확정표로 사용하지 마세요.",
                done: false,
              },
              {
                step: "4",
                title: "보수규정 개정·최종 봉급표 공표 — 연말 확인",
                desc: "인사혁신처가 공표하는 2027 봉급표와 개정 법령의 시행일을 확인하는 단계입니다. 공표 전인 현재는 2026 확정표에 따른 예상 계산을 제공합니다.",
                done: false,
              },
            ].map((item) => (
              <li
        ...
        <section className="mt-10 mb-12 max-w-3xl mx-auto prose prose-slate">
          ...
          <p className="text-sm leading-7 text-muted-blue">
            ...
            초임 보수 연 3,428만원이 현재 기준입니다. 예산안의 {pct}%가 그대로 반영될 경우
            2027년에는 16년 만의 최대 인상률이 됩니다. 저연차 추가 인상이 반영되면
            최종 봉급은 위 단순 예상표와 달라질 수 있습니다.
          </p>
        </section>
        ...
        <div className="mt-8 max-w-3xl mx-auto">
          <ShareButtons
            title="2027 공무원 봉급표 예상 — 예산안 3.9%·9급~5급 비교"
            description="2026 확정 봉급에 3.9%를 적용한 기본 봉급 예상액입니다. 수당·공제·저연차 추가 인상은 미반영이며 최종 봉급표 공표 전입니다."
          />
        </div>
