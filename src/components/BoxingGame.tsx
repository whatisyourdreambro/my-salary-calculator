...
export default function BoxingGame({
 ...
 return (
 <div className="fixed inset-0 z-50 flex items-center justify-center bg-electric/95 backdrop-blur-xl">
 <motion.div
 ...
 <div className="w-full h-1/4 border-b-4 border-canvas/50 mt-12"></div>
 <div className="w-full h-1/4 border-b-4 border-canvas/50"></div>
 <div className="w-full h-1/4 border-b-4 border-canvas/50"></div>
 {/* Spotlights */}
 ...
 <div className="flex justify-between text-[rgba(255,255,255,0.8)] font-black text-xl mb-2 uppercase tracking-tighter">
 <span>{companyA.name.ko}</span>
 <span>{hpA}%</span>
 </div>
 <div className="h-8 bg-canvas rounded-lg overflow-hidden border-2 border-electric/50 shadow-[0_0_15px_rgba(59,130,246,0.5)]">
 <motion.div
 ...
 <div className="text-xs text-faint-blue font-bold tracking-widest mt-1">SALARY DEATHMATCH</div>
 </div>

 <div className="flex-1">
 <div className="flex justify-between text-electric font-black text-xl mb-2 uppercase tracking-tighter">
 <span>{hpB}%</span>
 <span>{companyB.name.ko}</span>
 </div>
 <div className="h-8 bg-canvas rounded-lg overflow-hidden border-2 border-canvas/50 shadow-[0_0_15px_rgba(239,68,68,0.5)]">
 <motion.div
 ...
 {/* Gloves */}
 <div className="absolute top-1/2 -right-8 w-16 h-16 bg-gradient-to-br from-red-600 to-red-800 rounded-full border-4 border-canvas shadow-lg" />
 <div className="absolute bottom-0 right-0 w-16 h-16 bg-gradient-to-br from-red-600 to-red-800 rounded-full border-4 border-canvas shadow-lg" />
 ...
 {/* Gloves */}
 <div className="absolute top-1/2 -left-8 w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-800 rounded-full border-4 border-electric shadow-lg" />
 <div className="absolute bottom-0 left-0 w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-800 rounded-full border-4 border-electric shadow-lg" />
 ...
 className="text-2xl font-black text-navy italic drop-shadow-md"
 >
 {log[0]}
 </motion.div>
 </AnimatePresence>
 ...
 className="absolute inset-0 flex flex-col items-center justify-center bg-electric/90 backdrop-blur-md z-50"
 >
 <motion.div
 ...
 <h2 className="text-8xl font-black text-navy mb-4 italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-primary to-primary/80">
 KO!
 </h2>
 <p className="text-3xl text-navy font-bold mb-12">
 <span className={winner === "A" ? "text-[rgba(255,255,255,0.8)]" : "text-electric"}>
