...
|---|---|---|---|---|---|
| 1 | 예약 배포 시각 09:10 KST | — | 승인 | 9/29 09:10 main → `claude/deploy-0929` 빨리감기 · 10/1 09:10 L10' 켜짐 재빌드(보유세 비시즌 전환과 같은 빌드) | 공변량 `docs/ad-experiments.md` 절 3(c) |
| 2 | 착지 뷰 자동광고 관측 `autoads_seen`(aa1)을 9/29 배포에 포함 | AAS(`claude/r3-aas-20260926`) | 승인 | 9/29 배포. 판독 10/2(수집 점검)·10/9(판정) | `27db60e9`·`50401ae2`, `docs/analytics-measurement.md` '자동광고 관측' |
...
| 16 | 계산기 출처 허용 목록에 kepco.co.kr·opinet.co.kr | CALC-05 | 승인 | 9/29 배포에 포함(`4892b4c3`) | — |
