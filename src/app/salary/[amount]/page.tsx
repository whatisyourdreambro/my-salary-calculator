...
export default function SalaryAmountPage({ params }: Props) {
 ...
 <div className="pt-12 border-t border-canvas px-6 max-w-4xl mx-auto w-full">
 <h2 className="text-sm font-black text-faint-blue uppercase tracking-widest mb-6 text-center">
 다른 연봉 리포트
 </h2>
