...
const FAQ_FORECAST = [
  ...
  },
  {
    ...
    answer: `2026년 순경 1호봉 월 봉급 ${fmt(ENTRY.base2026)}원에 ${pct}%를 단순 적용하면 약 ${fmt(ENTRY.pay2027)}원으로 월 ${fmt(ENTRY.monthlyIncrease)}원가량 늘어납니다(천원 단위 반올림, 확정 봉급표 아님). 순경 1호봉은 2025·2026년 모두 일반직 9급 1호봉과 같은 금액이었고 2026년에는 둘 다 6.6% 올랐습니다. 2027년에도 저연차 조정이 있으면 확정액은 이보다 클 수 있지만, 조정 여부는 아직 공표되지 않았습니다.`,
  },
  {
