...
<li><strong>실제 감면액이 더 적다면</strong>: 추징세액보다 실제로 줄어든 세금이 적다는 사실을 증명하면 실제 감면액만 추징합니다. 누계 900만원이면 추징세액은 54만원인데, 총급여 3,000만원 1인 가구처럼 해마다 8만 1,000원씩 줄었다면 증명을 통해 그 금액만 내면 됩니다.</li>
</ul>
