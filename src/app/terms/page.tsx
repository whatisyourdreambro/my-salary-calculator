...
const SECTIONS = [
 ...
 {
 title: "제5조 (회사 연봉 데이터 및 정정·삭제 정책)",
 body: [
 "본 사이트의 회사별 연봉 데이터와 연봉 순위에 표시되는 기업별 금액은 공개된 정보(채용 공고, 사업보고서·감사보고서, 언론 보도, 공개 커뮤니티 후기 등)를 종합한 자체 추정치이며, 해당 기업이 공식 발표·확인한 수치가 아닙니다.",
 "해당 정보는 일반적인 참고를 위한 정보 제공 목적으로만 제공되며, 특정 기업의 실제 처우를 보장하거나 기업의 우열을 평가·단정하기 위한 것이 아닙니다.",
 "게재된 정보에 사실과 다른 내용이 있을 경우, 비공개 문의·오류 신고(/contact)로 접수해 주세요. 관련 근거를 확인해 정정·삭제 필요성을 검토합니다. 본 사이트는 어떠한 기업이나 개인의 명예를 훼손할 의도가 없습니다.",
 ],
 },
 {
 title: "제6조 (저작권)",
 ...
 "제휴 마케팅 고지: 본 사이트는 금융 상품 비교·가입 관련 제휴 네트워크(링크프라이스, 아이라이크클릭 등)의 제휴 링크를 포함할 수 있으며, 해당 링크를 통한 조회·가입 시 일정 수수료를 받을 수 있습니다. 제휴 링크가 노출되는 위치에는 별도의 고지 문구를 함께 표시합니다.",
 ],
 },
 {
 title: "제8조 (약관 변경)",
...
export default function TermsPage() {
 ...
 <div className="mb-12">
 <p className="text-sm text-faint-blue mb-2">최종 업데이트: 2026년 6월</p>
