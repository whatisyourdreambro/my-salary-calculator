...
export const metadata: Metadata = buildPageMetadata({
 ...
 description:
 "2026 최저시급 10,320원(전년 대비 +290원, 2.9% 인상). 주휴수당 포함 월급 2,156,880원, 연봉 25,882,560원. 시급·월급·연봉 환산표, 적용 시점, 위반 시 처벌 + 2027 최저임금 심의 현황까지 한 번에.",
 ...
 "최저임금 인상률",
 "최저임금 위반",
 // 7월 심의~8/5 고시 시즌에 폭증하는 내년도 쿼리 흡수 (2026-07-06 감사)
 "2027 최저임금",
 "2027 최저시급",
 "내년 최저임금",
 "최저임금 심의",
...
const FAQ_ITEMS = [
 ...
 answer:
 "최저임금위원회(근로자·사용자·공익위원 각 9명)가 매년 상반기 심의를 거쳐 통상 7월 중 표결로 다음 해 최저임금을 결정하고, 고용노동부장관이 8월 5일까지 고시합니다. 2027년 최저임금도 이 절차에 따라 2026년 여름에 확정되며, 확정 즉시 이 페이지에 반영합니다. 확정 전까지는 2026년 10,320원이 적용 중인 유일한 공식 수치입니다.",
 },
 {
 question: "2027년 최저임금은 얼마가 될까요?",
 answer:
 "아직 결정되지 않았습니다. 언론의 인상률 전망은 추정치일 뿐이며, 최저임금위원회 표결 전에는 어떤 수치도 공식이 아닙니다. 참고로 최근 인상 추이는 2024년 9,860원 → 2025년 10,030원(+1.7%) → 2026년 10,320원(+2.9%)입니다. 확정 고시(8/5 이전)가 나오면 이 페이지와 환산표를 즉시 업데이트합니다.",
 },
 {
...
export default function MinimumWage2026Page() {
 ...
 <p className="text-sm leading-7 text-muted-blue">
 2027년에 적용될 최저임금은 최저임금위원회가 심의 중이며, 관례상{" "}
 <strong>7월 중 표결로 결정되어 8월 5일까지 고시</strong>됩니다. 확정 전에
 보도되는 인상률 전망치는 공식 수치가 아니므로, 이 페이지는 고시 확정 즉시
 2027년 시급·월급·연봉 환산표를 업데이트합니다. 그 전까지 급여·알바비 계산은
 현재 적용 중인 2026년 시급 10,320원을 기준으로 하면 됩니다.
 </p>
 </section>
