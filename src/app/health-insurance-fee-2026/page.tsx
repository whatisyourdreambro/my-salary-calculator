...
const FAQS = [
  {
    ...
    a: "직장가입자는 보수월액의 7.19%(본인 3.595% + 회사 3.595%) + 장기요양보험료 13.14%(건보료의)를 추가 부담합니다. 본인 총 부담은 약 4.067%(3.595% + 0.472%) 수준입니다. 즉 월 400만원이면 본인 약 16만원, 회사도 16만원을 분담합니다.",
  },
  {
    q: "지역가입자 건강보험료는 어떻게 계산되나요?",
    a: "지역가입자는 소득에는 직장과 동일한 정률(7.19%)을, 재산(기본공제 1억원)에는 점수제(점수당 211.5원, 2026년 기준)를 적용해 산정합니다. 자동차 부과 점수는 2024년 2월부터 전면 폐지됐습니다. 자영업·프리랜서·은퇴자에 해당하며, 통상 월 20~40만원 수준이지만 재산이 많으면 100만원 이상도 가능합니다.",
  },
  {
    q: "퇴직 후 건강보험료는 어떻게 되나요?",
    a: "퇴직하면 자동으로 지역가입자로 전환되며 보험료가 크게 오를 수 있습니다. 이를 막기 위해 ① 가족(배우자·부모·자녀)의 피부양자로 등록 (소득·재산 요건 충족 시), 또는 ② 임의계속가입 신청(지역가입자 전환 후 최초 고지된 지역보험료 납부기한부터 2개월 이내, 최대 36개월간 직장가입자 수준 보험료로 납부) 두 가지 옵션이 있습니다.",
  },
  {
  ...
  {
    q: "본인부담상한제는 무엇인가요?",
    a: "1년간 본인이 부담한 의료비가 소득 분위별 상한(2024년 기준 87만원~808만원, 매년 고시로 갱신)을 넘으면 다음해 8월 자동 환급됩니다. 큰 수술이나 만성질환으로 본인부담이 컸다면 별도 신청 없이 환급되니, 건강보험공단에서 본인 분위와 환급 예정 금액을 확인하세요.",
  },
];
    ...
    <main className="w-full min-h-screen bg-canvas dark:bg-canvas-950 pb-20">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <section className="my-10 prose prose-slate dark:prose-invert max-w-none text-[15px] leading-7 text-muted-blue dark:text-canvas-300">
          ...
          <p>
            <strong>직장가입자</strong>는 보수월액의 7.19%를 회사와 절반씩 분담하며, 부양가족은
            피부양자로 무료 등재됩니다. <strong>지역가입자</strong>는 자영업·프리랜서·은퇴자가
            해당하며, 소득 정률(7.19%) + 재산 점수제로 산정해 단독 부담합니다(자동차 부과는 2024년 폐지). 동일 소득이라도
          ...
          <ol>
            ...
            <li><strong>임의계속가입 (직장 시절 수준)</strong>: 지역보험료 최초 고지 납부기한부터 2개월 이내 신청, 최대 36개월간 본인+회사분 모두 본인 부담. 재산은 있는데 소득 줄어든 은퇴자에게 유리.</li>
