  ...
  return (
    <main className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      <article className="prose dark:prose-invert lg:prose-xl w-full">
        ...
        <ol>
          <li>
            <strong>1주일 소정근로시간 15시간 이상:</strong> 근로계약서에 명시된
            1주일 근무 시간이 15시간 이상이어야 합니다.
          </li>
          <li>
            <strong>소정근로일 개근:</strong> 일하기로 약속한 날에 모두 출근해야
            합니다. 지각이나 조퇴는 결근이 아니지만, 연차휴가를 사용하지 않은
            결근이 있으면 해당 주에는 주휴수당을 받을 수 없습니다.
          </li>
          <li>
            <strong>다음 주 근로 예정:</strong> 계속 근로가 예정되어 있어야
            합니다. 즉, 마지막 근무 주에는 다음 주 근로가 예정되어 있지 않으므로
            주휴수당이 발생하지 않는 것이 일반적입니다.
          </li>
        </ol>
