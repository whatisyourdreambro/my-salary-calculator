...
const FAQ_ITEMS = [
 {
  ...
  answer:
   "① 소득 요건: 단독가구 2,200만원, 홑벌이가구 3,200만원, 맞벌이가구 3,800만원 미만이어야 합니다. ② 재산 요건: 2025년 6월 1일 기준 가구원 전체 재산 합계가 2억원 미만이어야 합니다. ③ 국적 요건: 대한민국 국적자이거나 국적자와 혼인한 외국인이어야 합니다.",
 },
 {
  question: "근로장려금은 얼마나 받을 수 있나요?",
  answer:
   "2026년(2025년 귀속) 기준 최대 지급액은 단독가구 165만원, 홑벌이가구 285만원, 맞벌이가구 330만원입니다. 소득 구간에 따라 점증→평탄→점감 구조로 지급되며, 재산이 1억4천만원 이상이면 50% 감액됩니다.",
 },
 {
