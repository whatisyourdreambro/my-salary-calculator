  ...
  return (
    <main className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      <article className="prose dark:prose-invert lg:prose-xl w-full">
        ...
        <p>
          연말정산은 13월의 월급이라고도 불리지만, 제대로 준비하지 않으면 오히려
          13월의 세금폭탄이 될 수 있습니다. 2025년 귀속 연말정산을 미리 준비할
          수 있도록 핵심적인 팁 몇 가지를 알려드립니다.
        </p>
        ...
        <ul>
          <li>
            <strong>월세액 세액공제</strong>: 조건에 해당하는 무주택 근로자라면,
            연간 최대 750만원까지 월세액의 15~17%를 세액공제 받을 수 있습니다.
          </li>
          <li>
