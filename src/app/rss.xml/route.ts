...
// [SEO 초고도화] src/app/guides/page.tsx 에서 가이드 목록 데이터를 직접 가져옵니다.
// 이제 가이드 페이지만 수정하면 RSS 피드가 자동으로 업데이트됩니다.
const guides = [
  {
  ...
  },
  {
    ...
    title: "2026년 연봉 실수령액: 내 월급, 세후 얼마일까?",
    description:
      "연봉 3000부터 1억까지, 2026년 최신 세법을 완벽 적용한 실수령액 테이블과 상세 공제 내역을 확인하세요.",
    category: "연봉 분석",
  },
  {
    slug: "salary-4500",
  ...
  },
  {
    ...
    title: "네카라쿠배 개발자 초봉 1억, 그 진실은? (2026년 최종판)",
    description:
  ...
  {
    slug: "hyundai-salary",
    title: "현대차 생산직 연봉: '킹산직'의 모든 것 (2026년 최종 분석)",
    description:
  ...
  {
    slug: "nurse-salary",
    title: "간호사 연봉 테이블: 신규부터 수간호사까지 총정리 (2026년)",
    description:
  ...
  },
  {
    ...
    title: "연봉협상: 최소 20% 올려받는 4단계 전략 (2026년 최종판)",
    description:
  ...
  },
  {
    ...
    description:
      "거대한 산업의 흐름 속, 당신의 연봉은 어디로 향할까요? 2026년 핵심 트렌드를 분석합니다.",
    category: "커리어 성장",
  },
  {
    slug: "nurse-5yr-salary",
    title: "5년차 간호사 연봉과 커리어: 번아웃과 성장 사이 (2026년)",
    description:
  ...
  {
    slug: "bonus-tax",
    title: "성과급 세금 폭탄, 피하는 법 완벽 가이드 (2026년 최종판)",
    description:
  ...
  {
    slug: "severance-tax",
    title: "퇴직금 세금 계산: 최소 40% 아끼는 공제의 비밀 (2026년)",
    description:
  ...
  },
  {
    ...
    title: "연말정산 A to Z: 13월의 월급, 제대로 찾는 법 (2026년)",
    description:
  ...
  },
  {
    ...
    title: "실업급여 A to Z: 조건, 신청 방법, 금액까지 완벽 정리 (2026년)",
    description:
  ...
  {
    slug: "minimum-wage",
    title: "2026년 최저임금 완벽정리: 시급 10,030원, 내 월급은? (예상)",
    description:
  ...
  },
  {
    ...
    title: "연봉 1억을 위한 현실적인 절세 전략 (2026년 최종판)",
    description:
  ...
  },
  {
    ...
    title: "디딤돌 vs 보금자리론, 내게 맞는 대출은? (2026년 최종 비교)",
    description:
...
function generateRssFeed() {
  ...
  const siteTitle = "Moneysalary 금융 가이드";
  ...
  guides.forEach((guide) => {
    ...
    rss += `<pubDate>${currentDate}</pubDate>`; // [개선] 각 글의 실제 발행일로 변경 가능
