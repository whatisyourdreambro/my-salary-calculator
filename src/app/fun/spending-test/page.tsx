...
export default function SpendingTestPage() {
 ...
 <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-navy mb-4">
 소비 성향 테스트
 </h1>
 ...
 <p className="text-lg leading-relaxed text-navy font-medium keep-all">
 {result.description}
 </p>
 </div>
 ...
 <button
 onClick={resetTest}
 className="py-4 px-8 bg-white text-navy font-bold rounded-xl hover:bg-canvas transition-colors shadow-lg"
 >
 다시하기
 </button>
 <button
