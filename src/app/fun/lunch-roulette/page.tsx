...
const normalMenu = [
  { name: "Íµ?∞•", icon: Soup, color: "#FF9F43" },
  { name: "?úÏú°Î≥∂Ïùå", icon: UtensilsCrossed, color: "#EE5A24" },
  { name: "?àÍπå??, icon: UtensilsCrossed, color: "#F79F1F" },
  { name: "ÍπÄÏπòÏ∞åÍ∞?, icon: Soup, color: "#EA2027" },
  { name: "?úÎ∏å?®Ïù¥", icon: Sandwich, color: "#A3CB38" },
  { name: "ÏßúÏû•Î©?, icon: UtensilsCrossed, color: "#1289A7" },
  { name: "?∏Ïùò??, icon: Coffee, color: "#5758BB" },
  { name: "?ºÏûê", icon: Pizza, color: "#FFC312" },
];

const corporateCardMenu = [
  { name: "?úÏö∞ ?§ÎßàÏπ¥ÏÑ∏", icon: Beef, color: "#B53471" },
  { name: "?§Ïãú ?§ÎßàÏπ¥ÏÑ∏", icon: Fish, color: "#0652DD" },
  { name: "?âÏñë?âÎ©¥", icon: Soup, color: "#12CBC4" },
  { name: "?§ÌÖå?¥ÌÅ¨", icon: Beef, color: "#833471" },
  { name: "?åÏù∏ ?§Ïù¥??, icon: ChefHat, color: "#9980FA" },
  { name: "?ëÍ∞àÎπ?, icon: Drumstick, color: "#D980FA" },
  { name: "?çÏä§??, icon: Fish, color: "#FDA7DF" },
  { name: "?∏ÌÖî Î∑îÌéò", icon: UtensilsCrossed, color: "#FFC312" },
];
...
export default function LunchRoulettePage() {
  ...
  return (
    <main className="w-full min-h-screen bg-slate-950 text-white overflow-hidden flex flex-col items-center pt-28 px-4 pb-20 relative">
      {/* Casino Background */}
      ...
      <div className="relative z-10 w-full max-w-2xl flex flex-col items-center">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2 font-medium">?§Îäò???êÏã¨ Î©îÎâ¥Î•?Î≤†ÌåÖ?òÏÑ∏??</p>
        </div>
