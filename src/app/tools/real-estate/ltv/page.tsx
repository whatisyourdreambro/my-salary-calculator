...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "LTV(Loan to Value, 담보인정비율)는 주택 가격 대비 대출 가능 비율입니다. 예) LTV 70%는 5억 주택의 경우 3.5억까지 대출 가능. 2026년 기준 규제지역 50%, 비규제지역 70%, 생애최초 주택구입자 80%(2025년 정부 정책). 다만 LTV 한도여도 DSR이 더 작으면 DSR이 결정.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "본인 또는 배우자가 생애 최초로 주택을 구입하는 경우. 주택가 5억 이하(2025년 기준), 부부합산 연소득 6천 이하 등 요건 충족 시 LTV 80%. DSR도 비교적 완화 적용. 신혼부부 디딤돌·보금자리론은 별도 저금리 상품 옵션.",
  },
  {
