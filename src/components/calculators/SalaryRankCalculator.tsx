    ...
    return (
        <div className="w-full max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                {/* Input Section */}
                <div className="bg-slate-50 rounded-[2.5rem] p-8 sm:p-10 border border-slate-200 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="space-y-8 relative z-10">
                        <div>
                            <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-3">Age Group</label>
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-3">Annual Salary (KRW)</label>
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {isCalculating && (
                            <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
                                className="absolute inset-0 flex flex-col items-center justify-center bg-slate-50 rounded-[2.5rem] border border-slate-200 z-20"
                            >
                                <div className="relative">
                        ...
                        {result && !isCalculating && (
                            ...
                            >
                                ...
                                <div
                                    ref={cardRef}
                                    className="w-full bg-black rounded-[2.5rem] border border-slate-200 shadow-2xl overflow-hidden relative p-8 sm:p-10 flex flex-col h-full"
                                >
                                    {/* Card Texture */}
                                    ...
                                    <div className="flex justify-between items-start mb-12 relative z-10">
                                        <div>
                                            <p className="text-slate-500 text-xs font-bold tracking-[0.2em] mb-2">MEMBERSHIP TIER</p>
                                    ...
                                    <div className="mb-12 relative z-10">
                                        <div className="flex items-baseline gap-4">
                                            ...
                                            <span className="text-slate-600 font-medium text-lg">Top Percentile</span>
                                        </div>
                                        <div className="w-full h-3 bg-white rounded-full mt-6 overflow-hidden border border-slate-200">
                                            <motion.div
                                                initial={{ width: 0 }}
                                    ...
                                    <div className="mt-12 pt-8 border-t border-white/10 flex justify-between items-end relative z-10">
                                        <div>
                                            ...
                                            <p className="text-slate-700 font-mono tracking-widest">ANONYMOUS VIP</p>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-zinc-600 text-[10px] font-mono mb-1">VALID THRU</p>
                                            <p className="text-slate-700 font-mono">12/99</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="absolute -bottom-20 left-0 right-0 flex gap-4">
                                    <button
                                        ...
                                        className="flex-1 py-4 bg-white text-slate-600 font-bold rounded-2xl hover:bg-slate-100 hover:text-slate-900 transition-all flex items-center justify-center gap-2 border border-slate-200"
                                    >
