...
const FAQS = [
  {
    q: "자동차세는 언제 납부하나요?",
    a: "자동차세는 1년에 두 번 분납합니다. 1기분(1~6월분)은 6월 16~30일, 2기분(7~12월분)은 12월 16~31일에 고지서가 발송되며, 납부 기한은 1기분 6월 30일·2기분 12월 31일입니다. 1월에 연납하면 2~12월분의 5%(실질 약 4.6%)를 공제받을 수 있습니다.",
  },
  {
    q: "자동차세 연납 할인은 얼마나 되나요?",
    a: "2026년 기준 1월 1~31일에 연납을 신청하면 2~12월분 세액의 5%(연세액 대비 실질 약 4.6%)를 공제받습니다. 예: 2,000cc 차량 연 자동차세가 약 52만원이면 연납 시 약 49만 6천원으로 약 2만 4천원 절약됩니다. 3월·6월·9월에도 연납 신청이 가능하지만 남은 기간분만 공제되어 공제액이 줄어듭니다.",
  },
  {
    q: "자동차세는 어떻게 계산되나요?",
    ...
    <main className="w-full min-h-screen bg-canvas dark:bg-canvas-950 pb-20">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <section className="my-10 prose prose-slate dark:prose-invert max-w-none text-[15px] leading-7 text-muted-blue dark:text-canvas-300">
          ...
          <p>
            <strong>4단계 — 연납 공제:</strong> 1월 1~31일에 일시납하면 2~12월분(11개월분)의
            5%, 즉 연세액 대비 실질 약 4.6%가 공제됩니다. 위 예시 468,000원 기준 공제액 약
            21,450원 → <strong className="text-electric">약 446,550원</strong>으로 절약됩니다.
          </p>
