...
const glossaryData = [
  ...
  },
  {
    title: "통상임금",
    content:
      "근로자에게 정기적이고 일률적으로 소정 근로에 대하여 지급하기로 정한 금액입니다. 연장, 야간, 휴일근로수당이나 연차유급휴가수당 등을 산정하는 기준이 됩니다.",
  },
  {
    title: "비과세 수당",
    content:
      "세금을 부과하지 않는 소득 항목입니다. 식대, 차량유지비 등이 대표적이며, 비과세 수당이 많을수록 세후 실수령액이 높아지는 효과가 있습니다.",
  },
];
