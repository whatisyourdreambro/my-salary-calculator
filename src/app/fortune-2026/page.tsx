    ...
    <main className="w-full min-h-screen bg-white px-4 pt-28 pb-20 font-sans">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-12 pb-10 border-b border-gray-100">
          ...
          <h1 className="text-3xl font-black text-slate-900 mb-3">2026 직장인 재물운·연봉운 사주</h1>
          <p className="text-slate-500 font-medium">태어난 년도와 월을 입력하면 2026년 재물운과 커리어운을 풀어드립니다.</p>
        </div>

        <AdUnit slotId="7788990011" format="auto" label="사주 상단 광고" />

        {/* Input */}
        <div className="bg-white border border-gray-200 rounded-2xl p-8 my-8 shadow-sm">
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              <label className="block text-xs font-bold text-slate-500 mb-2 uppercase tracking-widest">출생 연도</label>
              <input
                type="number"
                min={1950}
                max={2006}
                ...
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-slate-900 font-bold text-xl text-center focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none"
              />
            </div>
            <div>
              <label className="block text-xs font-bold text-slate-500 mb-2 uppercase tracking-widest">출생 월</label>
              <select
                value={birthMonth}
                onChange={e => setBirthMonth(Number(e.target.value))}
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-slate-900 font-bold text-center focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none"
              >
          ...
          {result && (
            ...
            >
              ...
              <button
                ...
                className="w-full py-3 border border-gray-200 rounded-xl text-slate-600 font-bold hover:bg-slate-50 transition-colors flex items-center justify-center gap-2"
              >
        ...
        <div className="mt-10">
          <AdUnit slotId="8899001122" format="auto" label="사주 하단 광고" />
        </div>
