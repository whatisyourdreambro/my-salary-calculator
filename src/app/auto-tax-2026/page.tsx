...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "2026 자동차세 자동 계산. 배기량(cc)·차령(년) 입력하면 연납 할인 7% 포함 정확한 자동차세를 즉시 산출. 6월/12월 분납 금액 비교까지.",
  path: "/auto-tax-2026",
  keywords: [
    "자동차세 계산기",
    "2026 자동차세",
...
const FAQS = [
  {
    q: "자동차세는 언제 납부하나요?",
    a: "자동차세는 1년에 두 번 분납합니다. 1기분(1~6월분)은 6월 16~30일, 2기분(7~12월분)은 12월 16~31일에 고지서가 발송되며 다음 달 말일까지 납부해야 합니다. 1월에 연납하면 7% 할인을 받을 수 있습니다.",
  },
  {
    q: "자동차세 연납 할인은 얼마나 되나요?",
    a: "1월 1~31일에 연납을 신청하면 약 7%의 세액 공제를 받습니다. 예: 2,000cc 차량 연 자동차세가 약 52만원이면 연납 시 약 48만 4천원으로 약 3만 6천원 절약됩니다. 2~3월 신청 시 할인율이 줄어들며, 4월부터는 분납으로 전환됩니다.",
  },
  {
    q: "자동차세는 어떻게 계산되나요?",
  ...
  },
  {
    ...
    a: "전기차는 배기량이 없으므로 비영업용 승용 기준 연 13만원(지방교육세 포함 약 16만 9천원) 정액으로 부과됩니다. 하이브리드는 배기량 기준으로 계산되며 전기차에 비해 세금이 높습니다. 친환경차 세제 혜택은 매년 변동될 수 있으니 국세청·지자체 공고를 확인하세요.",
  },
  {
    q: "중고차 매매 시 자동차세는 누가 내나요?",
    a: "자동차세는 6월 1일·12월 1일 기준 등록 명의자에게 부과됩니다. 매매가 그 사이에 이뤄지면 일할 계산해서 양도자·양수자가 각각 부담하는 것이 일반적이며, 매매 계약서에 분담 비율을 명시하는 것이 안전합니다. 일반적으로 매도자가 매도일까지의 세금을, 매수자가 매수일부터의 세금을 부담합니다.",
  },
  {
  ...
  {
    q: "자동차세 미납 시 어떻게 되나요?",
    a: "납부 기한 다음 날부터 3%의 가산금이 부과되며, 매월 1.2%씩 중가산금이 추가됩니다(최대 60개월). 또한 차량 운행 정지·압류 등의 처분이 가능하며, 미납이 누적되면 자동차 등록 갱신·이전이 제한됩니다. 위택스 또는 자동차세 모바일 앱으로 즉시 납부할 수 있습니다.",
  },
];
...
const HOWTO_STEPS = [
  ...
  {
    name: "연납 여부 선택",
    text: "1월 연납 시 약 7% 할인을 적용합니다. 분납은 6월·12월 각각 절반씩 납부합니다.",
  },
  {
    name: "결과 확인",
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <header className="mb-8">
          ...
          <p className="text-[15px] leading-7 text-muted-blue dark:text-canvas-300">
            ...
            연납 시 7% 할인을 자동 반영하고, 6월·12월 분납 금액까지 비교할 수 있습니다. 2026년
            기준 비영업용 승용차 cc당 세율과 차령별 경감(3년차부터 매년 5%, 최대 50%)이 적용됩니다.
          </p>
        </header>
        ...
        <section className="my-10 prose prose-slate dark:prose-invert max-w-none text-[15px] leading-7 text-muted-blue dark:text-canvas-300">
          ...
          <p>
            <strong>4단계 — 연납 할인:</strong> 1월 1~31일에 일시납하면 약 7%의 세액공제. 위 예시
            468,000원 × 93% = <strong className="text-electric">약 435,240원</strong>으로 약
            32,760원 절약됩니다.
          </p>
          ...
          <p>
            연납은 약 7% 할인이라는 즉각적인 이득이 있지만, 1월에 현금이 묶이는 단점이 있습니다.
            반면 분납은 6월·12월 두 번 나눠 내므로 현금 흐름 관리에 유리합니다. 연 50만원 이상 자동차세가
            나오는 2,000cc 이상 차량 보유자는 연납 할인 효과가 크므로 1월 연납을 추천합니다. 분납이
          ...
          <p>
            전기차는 배기량 기준 과세 대신 비영업용 승용 기준 연 13만원의 정액으로 부과됩니다.
            지방교육세 30%를 더해 약 16만 9천원 수준. 일반 2,000cc 가솔린차(연 약 52만원)에 비해
            연간 약 35만원의 자동차세 절감 효과가 있어, 5년 운영 시 약 175만원의 세제 혜택을 누립니다.
            하이브리드는 일반 가솔린·디젤차와 동일하게 배기량 기준 과세됩니다.
          </p>
