...
export default function FortunePage() {
 ...
 <div className="inline-block p-4 rounded-full bg-primary/20 border border-canvas/50 mb-4">
 ...
 className="w-full bg-electric/30 border border-canvas rounded-xl px-4 py-3 text-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
 />
 </div>
 ...
 <div className="space-y-2">
 <label className="text-sm font-medium text-faint-blue">성별</label>
 <div className="flex bg-electric/30 rounded-xl p-1 border border-canvas">
 ...
 <div className="space-y-2">
 <label className="text-sm font-medium text-faint-blue">양력/음력</label>
 <div className="flex bg-electric/30 rounded-xl p-1 border border-canvas">
 ...
 <motion.div
 className="absolute inset-0 border-4 border-canvas/30 rounded-full"
 />
 <motion.div
 ...
 rounded-full text-sm text-muted-blue">
 ...
 <div className="
 p-6 rounded-xl border border-canvas">
 <h4 className="font-bold text-center text-primary mb-4">행운의 아이템</h4>
 <div className="flex justify-around text-center">
 <div>
 <p className="text-xs text-faint-blue mb-1">행운의 색</p>
 <p className="font-bold text-primary">{resultData.luckyColor}</p>
 </div>
 <div>
 <p className="text-xs text-faint-blue mb-1">행운의 숫자</p>
 <p className="font-bold text-electric">{resultData.luckyNumber}</p>
 </div>
 <div>
 <p className="text-xs text-faint-blue mb-1">총점</p>
