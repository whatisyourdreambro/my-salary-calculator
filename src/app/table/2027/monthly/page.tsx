...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "국민연금 5.0%와 최저임금은 확정, 건강보험·장기요양은 2027년분 미발표라 2026년 기준을 준용한 예상표입니다. 소득세는 현행 근로소득 간이세액표(2026년 3월 1일 지급분부터)를 준용한 월 원천징수액이며, 2027년 표가 개정되면 갱신합니다. 확정 발표 시 즉시 갱신하며, 올해 확정 기준은 2026 월급 실수령액 표에서 볼 수 있습니다.",
  },
  {
      ...
      <div className="page-width -mt-20 relative z-10">
        ...
        <section className="mt-12 mb-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-faint-blue leading-relaxed mb-4">
              건강보험·장기요양 요율은 2027년분 발표 전이라 2026년 기준을
              준용했습니다. 소득세는 현행 근로소득 간이세액표(2026년 3월 1일 지급분부터)를 준용한 월 원천징수액입니다. 내 월급의 연금 인상 부담만 따로 보려면{" "}
        ...
        <div className="mt-4 text-center text-faint-blue text-sm pb-8">
          * 비과세 식대 월 20만원·본인 1인 공제 기준. 국민연금 5.0%·최저임금은 확정,
          건강보험은 2026 기준 준용(확정 시 갱신). 소득세는 2026년 근로소득 간이세액표 준용입니다. 각 행의 상세 페이지는 2026년
          기준입니다.
        </div>
      </div>
    </main>
