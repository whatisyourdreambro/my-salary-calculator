...
const FAQ_ITEMS = [
 ...
 },
 {
  ...
  answer:
   "퇴직 전 3개월 평균임금의 60%를 받습니다. 2026년 이직자 기준 상한액은 일 68,100원(월 약 204만원), 하한액은 최저시급(10,320원)의 80% × 1일 소정근로시간으로 8시간 기준 66,048원(월 약 198만원)입니다. 월급 약 330만원 이하면 하한액, 약 341만원 이상이면 상한액이 적용되고 그 사이 구간만 실제 60%가 적용됩니다. 50세 미만 기준 고용보험 가입 기간에 따라 120일~240일, 50세 이상은 최대 270일 지급됩니다.",
 },
 {
