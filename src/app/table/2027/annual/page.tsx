...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "국민연금 5.0%(법정 인상 스케줄)와 최저임금 10,700원은 확정입니다. 건강보험·장기요양보험 요율은 아직 2027년분이 발표되지 않아 2026년 기준을 준용했으며, 확정 발표(건보는 통상 9월 건정심) 즉시 표를 갱신합니다. 미확정분이 오르면 실수령액은 표보다 조금 더 줄어들 수 있습니다. 소득세는 현행 근로소득 간이세액표(2026년 3월 1일 지급분부터)를 준용한 월 원천징수액이며, 2027년 표가 개정되면 갱신합니다.",
  },
  {
      ...
      <div className="page-width -mt-20 relative z-10">
        ...
        <section className="mt-12 mb-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-faint-blue leading-relaxed mb-4">
              ...
              월 209시간 기준 2,236,300원입니다. 건강보험·장기요양 요율은 아직
        ...
        <div className="mt-4 text-center text-faint-blue text-sm pb-8">
          * 비과세 식대 월 20만원·본인 1인 공제 기준. 국민연금 5.0%·최저임금 10,700원은
          확정, 건강보험은 2026 기준 준용(확정 시 갱신). 소득세는 2026년 근로소득 간이세액표 준용입니다. 각 행의 상세 페이지는
          2026년 기준입니다.
        </div>
      </div>
    </main>
