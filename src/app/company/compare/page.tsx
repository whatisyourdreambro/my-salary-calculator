...
export default function CompareSelectionPage() {
 ...
 <Swords className="w-8 h-8 text-navy" />
 </div>
 </div>
 ...
 className="w-full py-4 bg-gradient-to-r from-primary to-red-600 text-navy text-xl font-black rounded-2xl shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
 >
 <span>FIGHT!</span>
