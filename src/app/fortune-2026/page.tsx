...
// 12지지별 가장 최근 해 — 쥐(2020) ~ 말(2026) 은 직전 7년, 양(2015) 부터는
// 12년 주기로 2026 기준 직전 띠해. 이전 버전은 2019가 양·돼지 두 위치에
// 중복 + 정렬 깨짐(2026-05-24 incident 수정).
const ZODIAC_YEARS = [2020, 2021, 2022, 2023, 2024, 2025, 2026, 2015, 2016, 2017, 2018, 2019];
