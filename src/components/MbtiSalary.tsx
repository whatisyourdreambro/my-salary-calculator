                        ...
                        {Object.keys(MBTI_DATA).map((mbti) => (
                            <button
                                ...
                                className={`p-2 rounded-xl font-bold text-sm transition-all ${selectedMbti === mbti
                                    ...
                                    : "bg-slate-100 text-slate-500 hover:bg-slate-200 hover:text-white"
                                    }`}
                            >
                                {mbti}
                            </button>
                    ...
                    <AnimatePresence mode="wait">
                        {!result && !isAnalyzing && (
                            <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
                                className="absolute inset-0 flex flex-col items-center justify-center text-slate-500 bg-white/50 rounded-3xl border border-slate-200 border-dashed"
                            >
                        ...
                        {isAnalyzing && (
                            <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}
                                className="absolute inset-0 flex flex-col items-center justify-center bg-white rounded-3xl border border-slate-200 z-10"
                            >
                        ...
                        {result && !isAnalyzing && (
                            ...
                            >
                                <div
                                    ref={cardRef}
                                    className="bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden relative p-8"
                                >
