...
export default function GiftTaxPage() {
 ...
 <Heart size={13} aria-hidden="true" /> 2026 세법 기준
 </span>
 ...
 <p className="text-navy/70 text-xs font-black uppercase tracking-widest mb-2">납부 증여세</p>
 <p className="text-5xl font-black text-navy tracking-tight">{fmt(r.tax)}<span className="text-2xl ml-1">원</span></p>
