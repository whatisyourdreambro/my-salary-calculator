...
const faqs = [
  {
    ...
    answer:
      "각 회사가 금융감독원 전자공시(DART) 사업보고서 '직원 등의 현황'에 공시한 연간 급여총액을 직원 수로 나눈 값입니다(등기임원 보수 제외). 사업부문·성별로 나뉜 공시는 급여총액 합산 ÷ 인원 합산으로 가중 평균했습니다. 회사가 제출한 공시 원문이 출처이므로 추정치가 아닙니다. DART 원자료로 계산한 값이며 회사가 공시한 1인평균급여액과 다를 수 있습니다.",
  },
  {
