...
// 2026-09-16 ✅: 9/9 수정 잠정합의안(현금 50%·주식 30%·이연 주식 10%p×2) 총투표 가결
//                (찬성 57.08%·투표율 95.37%·약 2,165표 차) → status="ratified",
//                newSplit 50/30/10/10·SOURCES·LAST_UPDATED 갱신(sync kit 2026-09-20 실행).
...
export const AGREEMENT_2026 = {
  /** ★ 총투표 결과 확인 후 여기만 변경 — 2026-09-16 수정안 가결 확정(헤럴드경제·파이낸셜뉴스 등 복수 언론) */
  status: "ratified" as AgreementStatus,
  /** 수정 잠정합의안 마련일(첫 잠정합의 8/20 → 8/25 부결 → 재교섭) */
  agreedDate: "2026-09-09",
  voteNote:
    "2026년 9월 16일 오전 9시 마감 조합원 총투표에서 가결 — 찬성 57.08%(8,731표) vs 반대 42.92%(약 2,165표 차, 투표율 95.37%). 첫 잠정합의안(현금 40%+자사주 60%)은 8월 25일 25표 차로 부결됐고, 현금 비중을 50%로 높인 수정안이 3주 만에 통과",
  wageIncreasePct: 6.3, // 직무급+경력급 합산 기본급 인상률 (수정안에서도 유지 — 파이낸셜뉴스 2026-09-16)
  poolRate: 0.1, // PS 재원 = 연간 영업이익의 10% (기존 유지)
  capAbolished: true, // 기본급 1,000% 상한 폐지 (2025-09 합의 유지)
  /** 신 체계(가결안): 당해 80% = 현금 50% + 자사주 30%(즉시 매도 가능), 이연 20% = 1년·2년 후 주식 10%p씩 */
  newSplit: { cashNowPct: 50, stockNowPct: 30, stockYear1Pct: 10, stockYear2Pct: 10 },
  /** 구 체계(2025년분까지): 당해 현금 80% + 이연 현금 10%p×2 */
  oldSplit: { cashNowPct: 80, cashYear1Pct: 10, cashYear2Pct: 10 },
  /** 현금 50% 중 일부를 본인 요청 시 10% 단위로 주식 전환 가능(최대 주식 100%) — 전환분 이연 구조는 미보도, 20%p 동일 가정 */
  stockElectionMaxPct: 100,
  /** 수정안에서 명문화 — 회사 적자 발생 시 임금의 최대 3% 이내 이연 지급 가능(헤럴드경제·파이낸셜뉴스 2026-09-16) */
  deficitWageDeferralMaxPct: 3,
  basePriceRule:
...
export const SOURCES = [
  ...
  { outlet: "더나은미래", date: "2026-09-09", fact: "노사 수정 잠정합의안 마련 — PS 현금 비중 40%→50%" },
  {
    outlet: "헤럴드경제",
    date: "2026-09-16",
    fact: "수정안 총투표 가결 — 투표율 95.37%·찬성 57.08%·약 2,165표 차. 현금 50%·주식 30%·이연 20%. 적자 시 임금 최대 3% 이연. 현금 일부 10% 단위 주식 전환 가능",
  },
  {
    outlet: "파이낸셜뉴스",
    date: "2026-09-16",
    fact: "당해 80% = 현금 50%+주식 30%, 20%는 1·2년 뒤 주식 10%씩 이연. 임금 6.3% 인상 유지. 적자 시 임금 일부 이연 명문화",
  },
] as const;
