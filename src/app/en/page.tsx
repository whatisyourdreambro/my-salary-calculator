...
export default function EnLandingPage() {
  const featuredSlugs = ["four-major-insurance-complete", "year-end-tax-deductions-guide", "health-insurance-2026-guide", "earned-income-credit-2026", "loan-types-comparison-2026", "chip-stock-tax-guide"];
  const featured = featuredSlugs.flatMap((slug) => { const guide = enGuideCards.find((card) => card.slug === slug); return guide ? [guide] : []; });
  return <EnLandingClient guides={featured} />;
}
