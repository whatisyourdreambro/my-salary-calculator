...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "2027년 1월부터 국민연금 요율이 근로자 4.75%에서 5.0%로 오르기 때문입니다. 월급 300만원 기준 매달 약 7,500원을 더 내게 됩니다. 표의 '변화값(2026比)' 열이 이 감소분입니다. 건강보험료율은 2027년 동결 확정이라 감소분은 국민연금 인상 효과뿐이며, 장기요양보험료율 등 남은 미확정 요율이 추가 인상되면 감소폭이 조금 더 커질 수 있습니다.",
  },
  {
    question: "이 표는 확정 수치인가요?",
    answer:
      "국민연금 5.0%·최저임금·건강보험 3.595%(2027 동결)는 확정, 장기요양은 2027년분 미발표라 2026년 기준을 준용한 예상표입니다. 소득세는 2026년 누진세액 모델로 추정한 연간 금액을 12개월로 나눈 값이며, 실제 월별 간이세액표를 조회한 결과는 아닙니다. 확정 발표 시 즉시 갱신하며, 올해 확정 기준은 2026 월급 실수령액 표에서 볼 수 있습니다.",
  },
  {
...
const monthlyJsonLd = [
  datasetLd({
    ...
    description:
      "2027년 국민연금 5.0% 인상·최저임금 확정을 반영한 월급 구간별 실수령액과 4대보험 공제 내역 데이터셋 (건강보험 2027 동결 확정 반영, 장기요양은 2026 준용)",
      ...
      <div className="page-width -mt-20 relative z-10">
        ...
        <section className="mt-12 mb-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-faint-blue leading-relaxed mb-4">
              ...
              확정됐고, 장기요양보험료율은 2027년분 발표 전이라 2026년 기준을 준용했습니다. 소득세는 연간 누진세액 추정의 월 환산액으로 실제 월별 원천징수액과 다를 수 있습니다. 내 월급의 연금 인상 부담만 따로 보려면{" "}
        ...
        <div className="mt-4 text-center text-faint-blue text-sm pb-8">
          * 비과세 식대 월 20만원·본인 1인 공제 기준. 국민연금 5.0%·최저임금·건강보험
          3.595%(2027 동결)는 확정, 장기요양은 2026 기준 준용(확정 시 갱신). 소득세는 2026년 연간 세액 추정의 월 환산입니다. 각 행의 상세 페이지는 2026년
          기준입니다.
        </div>
      </div>
    </main>
