...
export default function Calc2026Page() {
 ...
 {/* Header Banner */}
 <div className="bg-[#0F4C81] py-12 text-navy">
 ...
 <div className="bg-white p-6 rounded-2xl border border-canvas shadow-sm space-y-3">
 <div className="w-10 h-10 bg-canvas rounded-lg flex items-center justify-center text-[#0F4C81]">
 <ShieldCheck size={24} />
 </div>
 ...
 <h3 className="font-bold text-navy">자산 성장 경로</h3>
 <p className="text-xs text-faint-blue leading-relaxed">
