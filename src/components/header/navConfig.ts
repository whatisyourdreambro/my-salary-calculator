...
export const navConfig: NavItem[] = [
 ...
 },
 {
  ...
  items: [
   ...
   { name: "신용카드 소득공제 계산기", href: "/credit-card-deduction-2026", description: "25% 문턱·한도 자동 계산", badge: "NEW" },
   { name: "월세 세액공제 계산기", href: "/rent-tax-credit-2026", description: "15~17% 최대 170만 환급", badge: "NEW" },
   { name: "의료비 세액공제 계산기", href: "/medical-tax-credit-2026", description: "3% 문턱·실손 차감 반영", badge: "NEW" },
