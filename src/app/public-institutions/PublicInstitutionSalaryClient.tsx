...
export default function PublicInstitutionSalaryClient() {
  ...
  return (
    <section id="salary-calculator" aria-labelledby="calculator-heading" className="scroll-mt-28">
      ...
      <p className="mt-5 text-sm leading-7 text-muted-foreground">2026년 일반 근로자 공제 모형과 국민연금 2026년 7월 이후 상·하한을 사용합니다. 소득세는 연간 소득을 단순화한 추정치이며 실제 간이세액표 원천징수·연말정산 결과와 다를 수 있습니다. 기관별 추가 공제, 보수월액 신고·정산 시점은 반영하지 않습니다.</p>
