...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "꼭 그럴 필요 없습니다. (1) IRP 단독 900만 풀 활용, (2) 연금저축 600만 + IRP 300만 분산 두 가지가 대표적입니다. 다만 연금저축은 단독 세액공제 한도가 600만원이라(소득세법 §59의3) 연금저축에만 900만원을 넣으면 공제는 600만원까지만 됩니다 — 합산 900만 한도를 다 쓰려면 나머지 300만원은 반드시 IRP 에 넣어야 합니다. 이 조건을 지키는 범위에서는 어느 계좌에 얼마를 넣든 환급액이 같습니다. 운용 측면에서는 IRP 가 안전자산 30% 의무, 연금저축은 자유입니다.",
  },
  {
