...
| 8월 (완료·조기 달성) | ★리포트 2호 "성과급 실지급률"(/insights/bonus-payout-history-2026)·3호 격인 "상장사 평균연봉 TOP100"(/insights/listed-avg-salary-top100-2026) 2026-08-23 발행 — 아래 "10월 리포트 2호" 항목은 조기 이행됨. 크로스링크(랭킹 페이지 상호보완)는 2026-08-24 재점검에서 이행 |
| 9월 | 티스토리·워드프레스 재테크 블로거에 /embed 알리기(커뮤니티·블로그 댓글 아님 — 자연 발견 유도: 관련 가이드 글에 /embed 내부링크). GSC 저격 Round 2(9/13 재측정과 함께). 실험 #1 판정(9월 초)·실험 #3 판정(9/7경) |
| 10월 | (리포트 2호 조기 발행됨 — 10월 슬롯은 데이터 갱신·버킷 C 마감 관리로 전환) ★GSC 신규 페이지 버킷 C 10월 말 마감 |
| 12~1월 | 리포트 "성과급 발표 총정리" — 발표 24h 내 갱신, 인용 피크 |
