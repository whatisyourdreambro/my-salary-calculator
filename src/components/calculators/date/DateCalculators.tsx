...
export function DDayCalculator() {
 ...
 <p className="text-muted-blue mb-2">결과</p>
...
export function AgeCalculator() {
 ...
 <div className="bg-white rounded-3xl p-8 border border-canvas shadow-xl">
 <h2 className="text-2xl font-bold text-navy mb-6 flex items-center gap-2">
 <Clock className="text-electric" /> 만 나이 계산기
 </h2>
 <div className="space-y-6">
 <div>
 ...
 className="w-full p-4 bg-electric border border-canvas rounded-xl text-white focus:border-electric outline-none"
 />
 </div>
 <button
 onClick={calculate}
 ...
 <div className="p-6 bg-electric rounded-xl border border-canvas text-center">
 <p className="text-muted-blue mb-2">만 나이</p>
 <p className="text-4xl font-black text-electric">{result.intl}세</p>
 </div>
 <div className="p-6 bg-electric rounded-xl border border-canvas text-center">
 <p className="text-muted-blue mb-2">연 나이</p>
 <p className="text-4xl font-black text-muted-blue">{result.korean}세</p>
 </div>
 </div>
 )}
 </div>
