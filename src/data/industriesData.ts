...
export const industriesData: IndustryProfile[] = [
  ...
  {
    id: "startup",
    aggregateTier: "startup",
    name: "스타트업",
    nameEn: "Startups",
    emoji: "🚀",
    // salary는 DB 등록 tier="startup" 51개사의 영끌 연봉(기본급+평균 인센티브)
    // 실집계를 100만원 단위로 반올림한 값 (2026-08-07 산출).
    // overall = entry/junior/senior 평균의 산술평균. 외부 출처 추정치 아님.
    salary: {
      entry: { min: 4300, max: 8500, avg: 5600 },
      junior: { min: 5500, max: 11300, avg: 7000 },
      senior: { min: 7400, max: 16200, avg: 9500 },
      overall: 7400,
    },
    description:
    ...
    faqs: [
      {
        q: "스타트업·성장 기업 연봉은 어떻게 봐야 하나요?",
        a: "스타트업은 회사의 성장 단계·투자 유치·업종에 따라 보상 편차가 매우 큽니다. 기본급 외에 스톡옵션·인센티브가 더해지는 구조가 흔하므로, 계약 연봉만이 아니라 전체 보상 패키지로 비교하는 것이 좋습니다. 아래 회사별 연봉 순위 표에서 머니샐러리 DB에 등록된 기업들의 신입·시니어 연봉 집계를 회사별로 확인할 수 있습니다.",
      },
      {
        q: "스타트업 입사 전 무엇을 확인해야 하나요?",
        a: "기본급과 인센티브의 비중, 스톡옵션의 행사가·베스팅 조건, 회사의 현금 흐름과 투자 유치 상황을 확인하는 것이 일반적입니다. 대기업 대비 복지·안정성은 회사마다 차이가 크므로, 같은 연봉대라도 근무시간·문화 데이터를 함께 비교해 보세요.",
      },
    ],
    keywords: [
      "스타트업 연봉",
    ...
    trend: "stable",
    trendNote: "성장 단계·투자 유치 여부에 따라 회사별 보상 편차가 큰 시장. 흑자 기반 기업 중심으로 채용 수요 유지.",
  },
  {
