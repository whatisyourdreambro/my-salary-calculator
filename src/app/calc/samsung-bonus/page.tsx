...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "네, '내 연봉으로 계산' 섹션 안의 '세금 계산 가정 조정'에서 (1) 세액공제율을 0~50%까지 슬라이더로 조정 (디폴트 30%, 자녀·연금·의료비·기부 등 공제 반영 비율), (2) 4대보험 추가 부과 적용 여부를 체크박스로 ON/OFF 할 수 있습니다. 성과급은 보수에 합산되어 4대보험 정산되지만, 국민연금은 보수월액 상한(연 7,644만원)이 있어 고소득자는 추가 부과액이 적습니다.",
  },
  {
