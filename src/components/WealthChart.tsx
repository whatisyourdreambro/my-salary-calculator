    ...
    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-xl space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">월 {formatKRW(monthlySavings)}원씩 투자하면 미래의 내 자산은?</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="space-y-3">
          <div className="flex justify-between">
            <label className="text-sm font-bold text-gray-700">저축률</label>
        ...
        <div className="space-y-3">
          <div className="flex justify-between">
            <label className="text-sm font-bold text-gray-700">은퇴 목표액</label>
                ...
                if (active && payload && payload.length) {
                  return (
                    <div className="bg-white p-4 border border-gray-100 shadow-xl rounded-xl">
                      <p className="font-bold text-gray-800 mb-2">{label}년 후 (나이: {payload[0].payload.age}세)</p>
