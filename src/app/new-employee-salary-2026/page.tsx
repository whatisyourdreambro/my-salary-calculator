...
export const metadata: Metadata = buildPageMetadata({
 title: `신입 초봉 2026 — 회사 ${companyCountKo} 영끌 연봉 TOP 50`,
 description:
 `2026년 신입 사원 초봉 TOP 50. 대기업·IT·금융·공기업·외국계 회사별 영끌(기본급+성과급) 신입 평균 연봉. 머니샐러리 회사 ${companyCountKo} 데이터 자동 집계.`,
...
export default function NewEmployeeSalary2026Page() {
 ...
 faqLd(FAQ_ITEMS),
 articleLd({
 title: `신입 초봉 2026 — 회사 ${companyCountKo} 영끌 TOP 50`,
 ...
 머니샐러리 회사 데이터베이스 {companyCountKo}의 신입 영끌(기본급 + 인센티브 평균) 연봉을
 ...
 시장 평균의 1.5~2배 수준입니다. 본 페이지는 회사 {companyCountKo}의 신입 영끌(기본급 +
