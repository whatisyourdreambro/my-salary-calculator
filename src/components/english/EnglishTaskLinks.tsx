...
export default function EnglishTaskLinks({ items, label = "Related tasks" }: { items: readonly EnglishTaskLink[]; label?: string }) {
  return <nav aria-label={label} className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
