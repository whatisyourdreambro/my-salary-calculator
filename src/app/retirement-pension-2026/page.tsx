...
export const metadata: Metadata = buildPageMetadata({
 ...
 description:
 "확정급여형(DB)·확정기여형(DC)·개인형퇴직연금(IRP) 차이와 운용 수익률, 세제 혜택. IRP 900만원 납입 시 환급 최대 148.5만원, 퇴직금 일시 수령 대신 IRP 이전 시 세금 약 30~40% 절감 — 본인에게 맞는 퇴직연금 선택법 5단계.",
...
const FAQ_ITEMS = [
 ...
 answer:
 "퇴직 시 일시 수령하면 퇴직소득세를 일시에 부담(연 5,000만원 퇴직금 기준 약 250~400만원). IRP로 이전 후 만 55세 이후 연금으로 분할 수령하면 연금소득세 3.3~5.5% 저세율 적용. 일시 수령 대비 약 30~40% 세금 절감 가능(연금수령 시 퇴직소득세 30% 감면, 11년차부터 40%). 또한 IRP 계좌 내에서 운용 수익은 인출 시까지 과세이연.",
 },
 {
...
const HOW_TO_STEPS = [
 ...
 text: "퇴직 시 일시 수령 X. IRP 계좌로 이전 → 만 55세 이후 연금으로 분할 수령(연금소득세 3.3~5.5%). 약 30~40% 세금 절감.",
 },
];
...
export default function RetirementPension2026Page() {
 ...
 3.3~5.5% 적용 → 약 330~550만원으로 약 30~34% 절감. 거기에 운용 수익까지
