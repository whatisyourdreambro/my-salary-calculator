      ...
      <main className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <article className="prose dark:prose-invert lg:prose-xl w-full">
          ...
          <p className="lead">
            ...
            최소한의 임금 수준입니다. 매년 최저임금위원회의 심의를 거쳐
            결정되며, 모든 사업장에 동일하게 적용됩니다. 2025년 최저임금 기준
            시급, 월급, 연봉은 얼마인지 자세히 알아보겠습니다.
          </p>

          <h2>1. 2025년 최저시급</h2>
          <p>
            2025년 최저임금은 시간당 <strong>10,030원</strong>으로
            결정되었습니다. (예시 금액) 이는 2024년 대비 약 2.5% 인상된
            금액입니다. 이 금액은 수습 근로자 등 일부 예외를 제외하고 모든
            근로자에게 적용됩니다.
          </p>
