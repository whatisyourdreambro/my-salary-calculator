...
export const jobsData: JobProfile[] = [
  // ─── 의료 ───────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      { q: "간호사 월급 실수령액은 얼마인가요?", a: "연봉 3,700만원 기준 세후 월 실수령액은 약 273만원입니다. 야간·교대·위험수당이 붙는 경우 월 300만원 이상도 가능합니다. 정확한 실수령액은 머니샐러리 연봉 계산기에 직접 입력해 확인하세요." },
  ...
  },
  {
    ...
    officialStats: {
      medianAnnualManwon: 4000,
      lowerQuartileManwon: 3500,
      upperQuartileManwon: 4225,
      year: "2025",
      source: "한국고용정보원 한국직업정보(KNOW) 재직자조사 — 워크피디아 직업내비게이션(기준연도 2025)",
      sourceUrl: "https://www.wagework.go.kr/pt/b/a/retrieveOccpNvgtDtal.do?konetOccpCd=K000007501",
      classification: "물리 및 작업 치료사",
      note: "2023 조사(adiga 미러)에서는 3,300/3,800/4,500이었음. 교차 참고: 고용보험 행정데이터 기준 물리치료사 월평균 292만원(2025) — 재직자 설문값과 유사 수준.",
    },
  },
  {
    id: "radiographer",
    ...
    officialStats: {
      ...
      upperQuartileManwon: 7000,
      year: "2025",
      source: "한국고용정보원 한국직업정보(KNOW) 재직자조사 — 워크피디아 직업내비게이션(기준연도 2025)",
      sourceUrl: "https://www.wagework.go.kr/pt/b/a/retrieveOccpNvgtDtal.do?konetOccpCd=K000001017",
      classification: "방사선사",
      note: "2023 조사(adiga 미러)에서는 3,800/5,000/6,450이었음.",
    },
  },
  {
    id: "veterinarian",
  ...
  },
  {
    ...
    category: "의료",
    salary: {
      // 정부 통계 기반: 워크피디아 2025 재직자조사 분위수(2,400/2,750/3,300)에서 보수적으로 유도
      entry: { min: 2400, max: 2800, avg: 2550 },
      junior: { min: 2600, max: 3100, avg: 2850 },
      senior: { min: 2900, max: 3600, avg: 3300 },
      overall: 2750,
    },
    description: "노인·환자의 신체활동·일상생활을 지원하는 장기요양 국가자격 인력. 요양원·요양병원(시설)과 방문요양(재가)에서 근무하며, 고령화로 수요가 가장 빠르게 늘고 있는 직업 중 하나.",
    requirements: ["요양보호사 교육기관 교육과정 이수(신규자 320시간)", "요양보호사 자격시험 합격(국가자격)"],
    relatedCompanyIds: [],
    relatedCalcSlugs: ["night-shift-pay-quick", "severance-pay-quick", "annual-leave-pay-quick"],
    faqs: [
      { q: "요양보호사 연봉은 얼마인가요?", a: "정부 통계(한국고용정보원 워크피디아 2025 재직자조사) 기준 요양보호사 중위 연봉은 2,750만원(월 약 229만원)이며, 하위 25%는 2,400만원, 상위 25%는 3,300만원입니다. 요양원·요양병원 등 시설 근무는 월급제, 방문요양은 시급제 비중이 높아 근무 형태에 따라 실제 수입 차이가 큽니다." },
      { q: "요양보호사 월급 실수령액은 얼마인가요?", a: "시설 근무 요양보호사 월급은 세전 200~250만원 수준이 많으며, 야간·연장근무 수당이 붙으면 더 올라갑니다. 연봉 2,750만원 기준 세후 월 실수령액은 약 206만원 안팎입니다. 정확한 금액은 머니샐러리 연봉 계산기에 직접 입력해 확인하세요." },
      { q: "요양보호사 자격증은 어떻게 따나요?", a: "요양보호사 교육기관에서 교육과정(신규자 기준 320시간)을 이수한 뒤 국가자격시험에 합격하면 됩니다. 학력 제한이 없어 중장년층 취득이 많으며, 간호사·사회복지사 등 관련 자격 보유자는 교육시간이 감면됩니다." },
      { q: "요양보호사 전망은 어떤가요?", a: "초고령사회 진입으로 장기요양 수요가 계속 늘어 취업은 어렵지 않은 편입니다. 국민건강보험공단이 장기근속장려금(동일 기관 3년 이상 근속 시 월 단위 지급)을 운영하는 등 처우 개선 정책도 이어지고 있습니다." },
    ],
    keywords: ["요양보호사 연봉", "요양보호사 월급", "요양보호사 시급", "요양보호사 평균 연봉", "요양보호사 실수령액", "요양보호사 연봉 2026"],
    officialStats: {
      medianAnnualManwon: 2750,
      lowerQuartileManwon: 2400,
      upperQuartileManwon: 3300,
      year: "2025",
      source: "한국고용정보원 한국직업정보(KNOW) 재직자조사 — 워크피디아 직업내비게이션(기준연도 2025)",
      sourceUrl: "https://www.wagework.go.kr/pt/b/a/retrieveOccpNvgtDtal.do?konetOccpCd=K000000850",
      classification: "요양 보호사 및 간병인",
      note: "시설(요양원·요양병원)과 재가(방문요양) 근무 형태에 따라 편차 큼 — 방문요양은 시급제 비중이 높아 연 환산 시 낮게 응답될 수 있음.",
    },
  },
  ...
  },
  {
    ...
    officialStats: {
      ...
      lowerQuartileManwon: 3400,
      upperQuartileManwon: 5000,
      year: "2025",
      source: "한국고용정보원 한국직업정보(KNOW) 재직자조사 — 워크피디아 직업내비게이션(기준연도 2025)",
      sourceUrl: "https://www.wagework.go.kr/pt/b/a/retrieveOccpNvgtDtal.do?konetOccpCd=K000007495",
      classification: "소방공무원(소방관)",
      note: "재직자 조사 기반(수당 포함 실수령 성격). 교차 참고: 고용보험 행정데이터 소방관 월 395만원(2025). 별도로 인사혁신처 2026 봉급표에 '경찰·소방공무원' 전용 봉급표 존재.",
    },
  },
  {
    id: "police-officer",
    ...
    officialStats: {
      medianAnnualManwon: 6000,
      lowerQuartileManwon: 4500,
      upperQuartileManwon: 8000,
      year: "2025",
      source: "한국고용정보원 한국직업정보(KNOW) 재직자조사 — 워크피디아 직업내비게이션(기준연도 2025)",
      sourceUrl: "https://www.wagework.go.kr/pt/b/a/retrieveOccpNvgtDtal.do?konetOccpCd=K000007521",
      classification: "경찰관",
      note: "직전 조사(2021년 중위 3,900만원) 대비 크게 오른 수치 — 직업당 약 30명 재직자 자기보고 설문 특성상 경력자·수당 포함 응답이 반영된 값입니다. 실제 초임(순경 1호봉 월 2,133,000원)은 인사혁신처 경찰공무원 봉급표 참고(/civil-servant-pay-2026).",
    },
  },
  {
    id: "soldier",
  ...
  {
    id: "military-civilian",
    name: "군무원",
    nameEn: "Military Civilian Employee",
    category: "공무원/공공",
    salary: {
      // 공무원보수규정 2026 봉급표 기반 유도: 9급 1호봉 월 2,133,000원(연 2,560만),
      // 7급 1호봉 월 2,317,100원(연 2,781만) + 공통수당(정액급식비·직급보조비·명절휴가비 등)
      entry: { min: 2900, max: 3500, avg: 3200 },
      junior: { min: 3400, max: 4300, avg: 3800 },
      senior: { min: 4500, max: 6200, avg: 5200 },
      overall: 3900,
    },
    description: "국방부·육해공군 부대에서 행정·군수·시설·정보통신 등 업무를 담당하는 특정직 공무원. 군인이 아닌 민간인 신분이며, 일반직 공무원과 동일한 봉급표를 적용받는다(공무원보수규정). 군무원 공채·경채 시험으로 임용.",
    requirements: ["군무원 채용시험 합격(9급·7급·5급 공채 또는 경력경쟁채용)", "면접전형·신원조사 통과"],
    relatedCompanyIds: [],
    relatedCalcSlugs: ["severance-pay-quick", "annual-leave-pay-quick", "earned-income-tax-quick"],
    faqs: [
      { q: "군무원 연봉은 얼마인가요?", a: "군무원은 일반직 공무원과 동일한 봉급표를 적용받습니다(공무원보수규정). 2026년 기준 9급 군무원 1호봉 기본급은 월 2,133,000원(연 약 2,560만원)이며, 정액급식비·직급보조비·명절휴가비·정근수당 등 수당을 포함하면 초임 연봉은 약 2,900~3,500만원 수준입니다. 직급·호봉별 상세 금액은 머니샐러리 2026 공무원 봉급표 페이지(/civil-servant-pay-2026)에서 확인할 수 있습니다." },
      { q: "군무원 7급 초임 연봉은 얼마인가요?", a: "2026년 7급 1호봉 기본급은 월 2,317,100원(연 약 2,781만원)입니다. 수당을 포함하면 연 3,300~3,700만원 수준이며, 2026년에는 7~9급 저연차 봉급이 추가 인상(합산 6.6%)되어 초임 상승 폭이 컸습니다." },
      { q: "군무원과 일반 공무원 월급 차이가 있나요?", a: "기본급은 차이가 없습니다. 군무원 봉급은 일반직 공무원과 동일한 봉급표(공무원보수규정)를 적용하며, 공무원연금·정근수당·명절휴가비 등 주요 처우도 같은 체계입니다. 다만 군부대 근무 특성에 따른 일부 수당 구성에는 차이가 있을 수 있습니다." },
      { q: "군무원은 군인인가요?", a: "아닙니다. 군무원은 군에서 근무하는 '특정직 공무원'으로 민간인 신분입니다. 군복무·당직 등 부대 일과에 일부 참여하지만 계급·진급 체계는 군인과 별개이며, 정년(60세)까지 신분이 보장됩니다." },
    ],
    keywords: ["군무원 연봉", "군무원 월급", "군무원 9급 연봉", "군무원 7급 연봉", "군무원 초봉", "군무원 봉급표 2026"],
  },
  {
    id: "prosecutor",
    name: "검사",
  ...
  },
  {
    ...
    category: "공학/제조",
    salary: {
      // 정부 통계 기반: 워크피디아 2025 재직자조사 분위수(5,575/6,800/8,000)에서 보수적으로 유도
      // 통계는 경력 안전관리자 중심이라 entry는 분위수 하단보다 낮게 설정
      entry: { min: 3800, max: 5500, avg: 4500 },
      junior: { min: 5000, max: 6800, avg: 5800 },
      senior: { min: 6500, max: 9000, avg: 7800 },
      overall: 6800,
    },
    description: "산업 현장의 안전관리·위험성평가·재해 예방을 담당하는 안전관리 전문 인력. 일정 규모 이상 사업장은 안전관리자 선임이 법으로 의무화되어 있고, 중대재해처벌법 시행 이후 수요가 크게 늘었다.",
    requirements: ["산업안전기사 자격증(한국산업인력공단)", "관련 학과 졸업 또는 실무경력 등 응시요건 충족"],
    relatedCompanyIds: [],
    relatedCalcSlugs: ["earned-income-tax-quick", "overtime-pay-quick", "severance-pay-quick"],
    faqs: [
      { q: "산업안전기사 연봉은 얼마인가요?", a: "정부 통계(한국고용정보원 워크피디아 2025 재직자조사) 기준 산업안전원 및 위험관리원 중위 연봉은 6,800만원이며, 하위 25%는 5,575만원, 상위 25%는 8,000만원입니다. 이 통계는 경력 안전관리자 비중이 높은 값으로, 자격증 취득 직후 신입 초봉은 3,800~5,500만원 수준입니다." },
      { q: "산업안전기사 자격증을 따면 취업이 잘 되나요?", a: "산업안전보건법상 일정 규모 이상 사업장은 안전관리자를 의무적으로 선임해야 하고, 중대재해처벌법 시행 이후 건설·제조 대기업을 중심으로 안전 인력 채용이 크게 늘었습니다. 자격증 소지자 수요가 공급보다 많아 기사 자격증 중에서도 취업 체감이 좋은 편입니다." },
      { q: "산업안전기사와 산업안전산업기사의 차이는 무엇인가요?", a: "산업기사는 응시요건과 시험 범위가 기사보다 낮은 하위 등급 자격입니다. 안전관리자 선임 요건은 사업장 규모·업종에 따라 다른데, 대형 사업장·건설 현장일수록 기사 이상 자격을 요구하는 경우가 많아 연봉·채용 폭 모두 기사가 유리합니다." },
      { q: "건설 안전관리자 연봉은 더 높나요?", a: "건설 현장 안전관리자는 현장수당·위험수당이 붙어 제조업 사업장보다 총액이 높은 경우가 많습니다. 대형 건설사 경력 안전관리자는 상위 25% 값(8,000만원)을 넘는 사례도 있습니다. 다만 현장 이동·주말 근무 등 근무 강도를 함께 고려해야 합니다." },
    ],
    keywords: ["산업안전기사 연봉", "산업안전기사 월급", "안전관리자 연봉", "산업안전기사 취업", "건설 안전관리자 연봉", "산업안전기사 연봉 2026"],
    officialStats: {
      medianAnnualManwon: 6800,
      lowerQuartileManwon: 5575,
      upperQuartileManwon: 8000,
      year: "2025",
      source: "한국고용정보원 한국직업정보(KNOW) 재직자조사 — 워크피디아 직업내비게이션(기준연도 2025)",
      sourceUrl: "https://www.wagework.go.kr/pt/b/a/retrieveOccpNvgtDtal.do?konetOccpCd=K000000835",
      classification: "산업안전원 및 위험관리원",
      note: "자격증 명칭(산업안전기사)이 아닌 직무(안전관리자) 기준 통계 — 경력 안전관리자 비중이 높아 신입 초봉과는 차이가 있음.",
    },
  },
