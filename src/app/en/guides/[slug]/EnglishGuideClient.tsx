...
export default function EnglishGuideClient({ guide, relatedGuides }: Props) {
 ...
 ? { name: "Salary Calculator", href: "/en" }
 : { name: "Salary Calculator", href: "/en" };
 ...
 <main className="min-h-screen bg-canvas relative selection:bg-primary/20">
  ...
  <div className="relative pt-28 pb-16 overflow-hidden text-center">
   ...
   <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-primary/10 rounded-full blur-[120px] -z-10 pointer-events-none" />
   ...
   >
    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-electric/20 text-primary font-bold text-sm mb-6">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 pt-6 relative z-20">
   <div className="flex flex-col lg:flex-row gap-8 xl:gap-16">
    ...
    >
     <div className="toss-card bg-white p-6 sm:p-10 rounded-[24px]">
      ...
      <div className="mt-10 p-5 bg-secondary/30 rounded-2xl border border-border/50">
       <div className="flex items-start gap-3">
        ...
        <div className="flex-1 text-sm">
         <p className="font-bold text-foreground mb-1">Sources & Methodology</p>
         <p className="text-muted-foreground leading-relaxed">
         ...
         <p className="text-xs text-muted-foreground mt-2">
          ...
          <Link href="/en" className="text-primary font-bold hover:underline">
           official sources
          </Link>{" "}
     ...
     <div className="sticky top-24 space-y-6">
      <div className="toss-card p-6 relative overflow-hidden group">
       ...
       <div className="relative z-10">
        ...
        <h3 className="text-lg font-bold mb-2">Time to Practice</h3>
        <p className="text-muted-foreground text-sm mb-6 leading-relaxed">
         Got the theory?<br />
         Use our <strong>{relatedCalculator.name}</strong> for accurate numbers in your situation.
        </p>
        <Link
