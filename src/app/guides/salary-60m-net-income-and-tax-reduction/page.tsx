...
export const metadata: Metadata = {
  title: "연봉 6000만원 실수령액, 세후 월급 416만원? 세금 줄이는 법 (2025년)",
  description:
    "연봉 6000만원 직장인의 세후 실수령액은 얼마일까요? 국민연금, 건강보험, 소득세 등 상세한 공제 내역을 포함한 2025년 최신 연봉 테이블 기준 월급을 확인하고, 연말정산 및 절세 상품을 활용하여 세금을 효과적으로 줄이는 방법을 알려드립니다.",
  openGraph: {
    title: "연봉 6000만원 실수령액, 세후 월급 416만원? 세금 줄이는 법 (2025년)",
    description:
      "내 연봉 6000만원, 통장에는 얼마나 찍힐까? 상세 공제 내역과 함께 당신의 진짜 월급을 알려드립니다.",
    images: ["/api/og?title=연봉 6000만원, 실수령액과 절세"],
  },
};
...
const articleStructuredData = {
  ...
  "@type": "Article",
  headline: "연봉 6000만원 실수령액, 세후 월급 416만원? 세금 줄이는 법 (2025년)",
  author: {
    "@type": "Organization",
    name: "Moneysalary",
  },
  ...
  description:
    "연봉 6000만원 직장인의 2025년 기준 세후 실수령액과 상세 공제 내역, 그리고 연말정산 및 절세 상품을 활용하여 세금을 효과적으로 줄이는 방법을 알려드립니다.",
};

const deductionData = [
    { item: "월 예상 소득(세전)", amount: "5,000,000원" },
    { item: "국민연금 (4.5%)", amount: "약 202,500원" },
    { item: "건강보험 (3.545%)", amount: "약 159,520원" },
    { item: "고용보험 (0.9%)", amount: "약 45,000원" },
    { item: "근로소득세 (간이세액)", amount: "약 176,000원" },
    { item: "공제액 합계", amount: "약 583,020원" },
];

export default function Salary60MGuidePage() {
  return (
    <>
      <script
      ...
      <main className="w-full bg-background">
        <div className="w-full bg-gradient-to-br from-green-500 to-teal-600 dark:from-gray-900 dark:to-green-900 text-white text-center py-20 sm:py-28 px-4">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg sm:text-xl text-teal-100 dark:text-gray-300">
            중견 직장인의 현실적인 연봉, 6000만원. 세금 떼고 내 손에 들어오는 진짜 월급은 얼마인지, 상세 공제 내역과 함께 연말정산 및 절세 상품을 활용하여 세금을 효과적으로 줄이는 방법을 알려드립니다.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 -mt-20">
          <article className="prose dark:prose-invert lg:prose-xl max-w-none bg-light-card dark:bg-dark-card p-6 sm:p-10 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800">
            <p className="lead text-lg sm:text-xl font-medium text-gray-700 dark:text-gray-300">
              연봉 6000만원은 월급으로 환산하면 500만원입니다. 하지만 각종 세금과 4대 보험료를 공제하고 나면, 실제 통장에 입금되는 금액은 이보다 훨씬 적습니다. 2025년 기준으로 연봉 6000만원 직장인의 실제 월급 명세서를 파헤쳐 보고, 이 금액으로도 충분히 부자가 될 수 있는 재테크 전략을 제시합니다.
            </p>
            ...
            <section className="mt-12 bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-2xl border border-yellow-200 dark:border-yellow-800">
              <h2 className="!mt-0 !text-2xl font-bold text-yellow-700 flex items-center gap-2">
                <PiggyBank className="w-6 h-6" /> 재테크 팁: 세금 줄이고 자산 늘리기
              </h2>
              <p className="!my-2 text-base">
                연봉 6000만원은 소득세율 구간이 높아지기 시작하는 시점입니다. 적극적인 절세 전략과 함께 자산 증식을 위한 투자를 병행해야 합니다.
              </p>
               <ul className="!my-2 space-y-1 text-base">
                  ...
                  <li><strong>3순위:</strong> <Link href="/guides/road-to-100m-part3-invest" className="font-bold text-yellow-800 hover:underline">미국 지수 추종 ETF 적립식 투자</Link> - 장기적인 복리 효과
                  </li>
                </ul>
            </section>
