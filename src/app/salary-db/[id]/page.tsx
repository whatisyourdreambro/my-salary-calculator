...
function buildCompanyFaq(company: ReturnType<typeof companyRepository.getById>) {
 ...
 ? `${josa(koName, "은/는")} ${industryLabelKo(company.industry)} 업종 내에서 신입 ${entryManwon}만원 수준이며, 위 본문의 "업종 평균 비교" 섹션에서 동종사 대비 상위/하위 위치를 확인할 수 있습니다.`
 : `${josa(koName, "은/는")} ${industryLabelKo(company.industry)} 업종 내에서 신입 ${entryManwon}만원 수준입니다. 국내 동종사 표본이 부족한 회사는 업종 평균 비교가 제공되지 않으며, 비슷한 연봉대 회사 목록으로 시장 위치를 가늠할 수 있습니다.`,
 },
 {
