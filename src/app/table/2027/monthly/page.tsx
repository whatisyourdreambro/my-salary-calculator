...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "2027년 1월부터 국민연금 요율이 근로자 4.75%에서 5.0%로 오르기 때문입니다. 월급 300만원 기준 매달 약 7,500원을 더 내게 됩니다. 표의 '변화값(2026比)' 열이 이 감소분입니다. 건강보험료율은 2027년 동결 확정이라 표의 감소분에는 국민연금 인상 효과만 반영했으며, 장기요양보험료율이나 고용보험 실업급여 요율(2027년 근로자 0.9%→1.0% 인상안 심의 중, 법령 개정 전)이 오르면 감소폭이 조금 더 커질 수 있습니다.",
  },
  {
    question: "이 표는 확정 수치인가요?",
    answer:
      "국민연금 5.0%·최저임금·건강보험 3.595%(2027 동결)는 확정, 장기요양(2027년분 미발표)·고용보험(2027 인상안 심의 중, 법령 개정 전)은 2026년 기준을 준용한 예상표입니다. 소득세는 현행 근로소득 간이세액표(2026년 3월 1일 지급분부터)를 준용한 월 원천징수액이며, 2027년 표가 개정되면 갱신합니다. 확정 발표 시 즉시 갱신하며, 올해 확정 기준은 2026 월급 실수령액 표에서 볼 수 있습니다.",
  },
  {
...
const monthlyJsonLd = [
  datasetLd({
    ...
    description:
      "2027년 국민연금 5.0% 인상·최저임금 확정을 반영한 월급 구간별 실수령액과 4대보험 공제 내역 데이터셋 (건강보험 2027 동결 확정 반영, 장기요양·고용보험은 2026 준용)",
      ...
      <div className="page-width -mt-20 relative z-10">
        ...
        <section className="mt-12 mb-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-faint-blue leading-relaxed mb-4">
              건강보험료율은 2026년 9월 8일 건정심에서 2026년과 같은 근로자 3.595%로 동결
              확정됐고, 장기요양(2027년분 발표 전)·고용보험(2027 인상안 심의 중) 요율은 2026년 기준을 준용했습니다. 소득세는 현행 근로소득 간이세액표(2026년 3월 1일 지급분부터)를 준용한 월 원천징수액입니다. 내 월급의 연금 인상 부담만 따로 보려면{" "}
        ...
        <div className="mt-4 text-center text-faint-blue text-sm pb-8">
          * 비과세 식대 월 20만원·본인 1인 공제 기준. 국민연금 5.0%·최저임금·건강보험
          3.595%(2027 동결)는 확정, 장기요양·고용보험은 2026 기준 준용(확정 시 갱신). 소득세는 2026년 근로소득 간이세액표 준용입니다. 각 행의 상세 페이지는 2026년
          기준입니다.
        </div>
      </div>
    </main>
