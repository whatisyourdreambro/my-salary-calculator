...
| details(장문 본문, S3-1 · 메타 무영향) 보유 | 49 (24.3%) · 중앙값 786자 · 600자 미만 0 · 1,000자 초과 0 |
...
| 보일러플레이트 멤버(그룹 1개 이상) | 97 (48.0%) · 그중 설명 자체가 공유된 것 0 |
...
- 출처 URL 총 130건 중 국내 공식(*.go.kr/*.or.kr) 98건 (75.4%) · 해외 공공(.gov/.edu 등) 20건 (15.4%) · 기타 12건
- 국내 공식 출처를 1건 이상 가진 계산기: 49 / 202 (24.3%)
- 공식 출처 보유(sourcePolicy 허용 목록·https 기준, S3-1 게이트): 계산기 49 / 202 (24.3%) · 2건 이상 49 · URL 98건
- 발견된 출처 호스트: www.law.go.kr×34(국내공식), www.fss.or.kr×14(국내공식), www.investor.gov×12(해외공공), support.microsoft.com×10, www.nts.go.kr×8(국내공식), fine.fss.or.kr×7(국내공식), mods.go.kr×5(국내공식), www.bok.or.kr×5(국내공식), easylaw.go.kr×3(국내공식), portal.kfb.or.kr×3(국내공식), www.fsc.go.kr×3(국내공식), www.hf.go.kr×3(국내공식), ktb.moef.go.kr×2(국내공식), legacy.sba.gov×2(해외공공), nhuf.molit.go.kr×2(국내공식), www.consumerfinance.gov×2(해외공공), www.moel.go.kr×2(국내공식), ext.vt.edu×1(해외공공), files.consumerfinance.gov×1(해외공공), finlife.fss.or.kr×1(국내공식), fss.or.kr×1(국내공식), fund.nps.or.kr×1(국내공식), kosis.kr×1(국내공식), ocw.ump.edu.my×1(해외공공), openstax.org×1, www.accaglobal.com×1, www.bls.gov×1(해외공공), www.korea.kr×1(국내공식), www.minimumwage.go.kr×1(국내공식), www.nps.or.kr×1(국내공식)

### 1-5. 카테고리별

| 분류 | 수 | 설명 중앙값(자) | 설명 <600자 | 출처 0건 | 보일러 멤버 | noindex | 정밀 쌍 |
|---|---|---|---|---|---|---|---|
| tax ★ | 15 | 190 | 15 | 6 | 0 | 0 | 9 |
| salary ★ | 17 | 190 | 17 | 7 | 5 | 0 | 4 |
| loan ★ | 22 | 231 | 22 | 3 | 12 | 0 | 8 |
| real-estate ★ | 18 | 219 | 18 | 11 | 8 | 0 | 1 |
| investment ★ | 31 | 229 | 31 | 3 | 13 | 0 | 3 |
...
|---|---|---|---|
| batch2.ts | 1 | 94 | 0 |
| enrichments-ext-a.ts | 26 | 181 | 5 |
| enrichments-ext-b.ts | 20 | 201 | 16 |
| enrichments-ext-c.ts | 24 | 250 | 24 |
| enrichments.ts | 30 | 190 | 11 |
| expandedFinance.ts | 51 | 237 | 22 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | salary | `weekly-pay` | 주급 계산 | 176 | 0 | 3 | 0 | - | index | - | enrichments-ext-a.ts |
| 2 | salary | `hourly-to-yearly` | 시급 → 연봉 환산 | 187 | 0 | 3 | 0 | - | index | - | enrichments.ts |
| 3 | salary | `yearly-to-hourly` | 연봉 → 시급 환산 | 199 | 0 | 3 | 0 | - | index | - | enrichments-ext-a.ts |
| 4 | investment | `sinking-fund-monthly` | 연간 비정기 지출의 월 적립 | 233 | 0 | 3 | 0 | B02 | index | - | expandedFinance.ts |
| 5 | salary | `salary-raise-timing` | 연봉 인상 적용월의 올해 소득 | 235 | 0 | 3 | 0 | B02 | index | - | expandedFinance.ts |
| 6 | salary | `bonus-versus-raise` | 일회성 보너스와 기본급 인상 비교 | 237 | 0 | 3 | 0 | B02 | index | - | expandedFinance.ts |
| 7 | salary | `split-payday-budget` | 월 2회 급여의 현금 부족일 | 238 | 0 | 3 | 0 | B02 | index | - | expandedFinance.ts |
| 8 | salary | `unpaid-leave-budget` | 무급휴가 급여 감소 예산 | 238 | 0 | 3 | 0 | B02 | index | - | expandedFinance.ts |
| 9 | investment | `emergency-fund-target` | 생활비 기준 비상금 부족액 | 239 | 0 | 3 | 0 | B02 | index | - | expandedFinance.ts |
| 10 | real-estate | `rent-free-effective-cost` | 렌트프리 실질 월 임대비용 계산기 | 244 | 0 | 3 | 0 | B01 | index | - | expandedPractical.ts |
| 11 | real-estate | `vacancy-carrying-cost` | 공실 유지비·놓친 임대료 계산기 | 248 | 0 | 3 | 0 | B01 | index | - | expandedPractical.ts |
| 12 | real-estate | `relocation-payback` | 이사 초기비용 회수기간 계산기 | 251 | 0 | 3 | 0 | B01 | index | - | expandedPractical.ts |
| 13 | real-estate | `renovation-budget-buffer` | 리모델링 예비비·추가공사 예산 계산기 | 252 | 0 | 3 | 0 | B01 | index | - | expandedPractical.ts |
| 14 | real-estate | `storage-unit-cost` | 보관창고 칸수·임대예산 계산기 | 253 | 0 | 3 | 0 | B01 | index | - | expandedPractical.ts |
| 15 | real-estate | `home-maintenance-reserve` | 집수리 준비 월 적립액 계산기 | 255 | 0 | 3 | 0 | B01 | index | - | expandedPractical.ts |
| 16 | real-estate | `rental-prorated-rent` | 월세·관리비 일할 정산 계산기 | 255 | 0 | 3 | 0 | B01 | index | - | expandedPractical.ts |
| 17 | real-estate | `roommate-utility-share` | 동거 공과금 체류일수 분담 계산기 | 272 | 0 | 3 | 0 | B01 | index | - | expandedPractical.ts |
| 18 | tax | `dividend-tax-quick` | 배당소득세 계산 | 201 | 0 | 3 | 0 | - | index | Y | enrichments-ext-a.ts |
| 19 | loan | `dsr-quick` | DSR 한도 계산 | 202 | 0 | 3 | 0 | - | index | Y | enrichments.ts |
| 20 | real-estate | `housing-affordability-quick` | 내가 살 수 있는 집값 | 203 | 0 | 3 | 0 | - | index | - | enrichments-ext-b.ts |
| 21 | tax | `inheritance-tax-sim` | 상속세 시뮬레이터 | 206 | 0 | 3 | 0 | - | index | - | enrichments.ts |
| 22 | investment | `etf-fee-impact` | ETF 운용수수료 누적 영향 | 207 | 0 | 3 | 0 | - | index | - | enrichments-ext-a.ts |
| 23 | real-estate | `moving-cost-quick` | 이사 비용 추정 | 209 | 0 | 3 | 0 | - | index | - | enrichments-ext-b.ts |
| 24 | tax | `income-tax-bracket-sim` | 소득세 누진세율 시뮬레이터 | 216 | 0 | 3 | 0 | - | index | Y | enrichments.ts |
| 25 | real-estate | `real-estate-flip-cost` | 단기 매매 부대비용 | 219 | 0 | 3 | 0 | - | index | - | enrichments-ext-b.ts |
| 26 | tax | `registration-tax-quick` | 등록면허세 계산 | 234 | 0 | 3 | 0 | - | index | - | enrichments.ts |
| 27 | loan | `ltv-quick` | LTV 한도 계산 | 238 | 0 | 3 | 0 | - | index | Y | enrichments.ts |
| 28 | tax | `retirement-income-tax-quick` | 퇴직소득세 간편 계산 | 238 | 0 | 3 | 0 | - | index | Y | enrichments-ext-a.ts |
| 29 | tax | `real-estate-capital-gains-quick` | 부동산 양도세 간편 계산 | 240 | 0 | 3 | 0 | - | index | - | enrichments.ts |
| 30 | loan | `prepayment-fee-quick` | 중도상환 수수료 계산 | 246 | 0 | 3 | 0 | - | index | - | enrichments.ts |
| 31 | loan | `extra-payment-term` | 매달 추가 상환의 기간 단축 | 225 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 32 | loan | `variable-rate-stress` | 대출 금리 상승 부담 점검 | 226 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 33 | loan | `loan-balance-after-payments` | 납입 횟수별 대출 잔액 | 227 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 34 | investment | `savings-tax-rate-compare` | 세후 이자로 예금 조건 비교 | 230 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 35 | loan | `credit-line-daily-interest` | 마이너스통장 잔액 구간별 이자 | 231 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 36 | loan | `lump-sum-prepayment-term` | 목돈 중도상환의 완납 시점 | 232 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 37 | loan | `loan-term-extension-cost` | 대출 만기 연장의 총비용 | 233 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 38 | salary | `salary-purchasing-power` | 물가 반영 실질 월급 비교 | 233 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 39 | loan | `loan-interest-principal-split` | 이번 달 원금·이자 분해 | 234 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 40 | investment | `savings-beginning-vs-end` | 월초·월말 적립 시점 비교 | 234 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 41 | investment | `savings-contribution-pause` | 저축 일시 중단의 목표 차이 | 234 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 42 | investment | `investment-fee-break-even` | 정액·정률 투자 수수료 교차점 | 235 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 43 | loan | `refinance-break-even` | 대환대출 비용 회수 기간 | 236 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 44 | loan | `loan-cashflow-effective-rate` | 선취 수수료 포함 대출 유효금리 | 237 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 45 | investment | `savings-contribution-stepup` | 매년 저축액 증액 시뮬레이션 | 237 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 46 | investment | `savings-start-delay` | 저축 시작을 미룬 기회비용 | 237 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 47 | investment | `deposit-break-switch` | 예금 중도해지 후 갈아타기 비교 | 238 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 48 | investment | `savings-required-monthly` | 목표까지 필요한 월 저축액 | 238 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 49 | loan | `debt-consolidation-payment` | 두 대출 통합 상환 비교 | 239 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
| 50 | loan | `debt-avalanche-vs-snowball` | 고금리 우선·소액 우선 상환 비교 | 240 | 0 | 3 | 1 | B02 | index | - | expandedFinance.ts |
...
| tax | `dividend-tax-quick` | 배당소득세 계산 | enrichments-ext-a.ts | 201 | 0 | Y | 44 | 3 | 343 | 0 | 0 | 3 | - | Y | index |
...
| tax | `income-tax-bracket-sim` | 소득세 누진세율 시뮬레이터 | enrichments.ts | 216 | 0 | Y | 52 | 3 | 387 | 0 | 0 | 3 | - | Y | index |
| tax | `inheritance-tax-sim` | 상속세 시뮬레이터 | enrichments.ts | 206 | 0 | Y | 62 | 3 | 342 | 0 | 0 | 3 | - | - | index |
...
| tax | `real-estate-capital-gains-quick` | 부동산 양도세 간편 계산 | enrichments.ts | 240 | 0 | Y | 83 | 3 | 383 | 0 | 0 | 3 | - | - | index |
| tax | `registration-tax-quick` | 등록면허세 계산 | enrichments.ts | 234 | 0 | Y | 93 | 3 | 433 | 0 | 0 | 3 | - | - | index |
| tax | `retirement-income-tax-quick` | 퇴직소득세 간편 계산 | enrichments-ext-a.ts | 238 | 0 | Y | 137 | 3 | 359 | 0 | 0 | 3 | - | Y | index |
...
| salary | `bonus-versus-raise` | 일회성 보너스와 기본급 인상 비교 | expandedFinance.ts | 237 | 0 | - | 46 | 3 | 93 | 0 | 0 | 1 | B02 | - | index |
| salary | `daily-pay` | 일급 계산 | enrichments-ext-a.ts | 167 | 678 | Y | 38 | 4 | 627 | 2 | 2 | 3 | - | - | index |
| salary | `holiday-allowance-quick` | 주휴수당 계산 | enrichments.ts | 185 | 728 | Y | 46 | 4 | 625 | 2 | 2 | 3 | - | Y | index |
| salary | `hourly-to-yearly` | 시급 → 연봉 환산 | enrichments.ts | 187 | 0 | Y | 110 | 3 | 478 | 0 | 0 | 3 | - | - | index |
...
| salary | `salary-purchasing-power` | 물가 반영 실질 월급 비교 | expandedFinance.ts | 233 | 0 | - | 57 | 3 | 99 | 1 | 0 | 1 | B02 | - | index |
| salary | `salary-raise-timing` | 연봉 인상 적용월의 올해 소득 | expandedFinance.ts | 235 | 0 | Y | 37 | 3 | 90 | 0 | 0 | 1 | B02 | - | index |
| salary | `severance-pay-quick` | 퇴직금 간편 계산 | enrichments.ts | 166 | 794 | Y | 89 | 4 | 671 | 2 | 2 | 4 | - | Y | index |
| salary | `split-payday-budget` | 월 2회 급여의 현금 부족일 | expandedFinance.ts | 238 | 0 | Y | 48 | 3 | 120 | 0 | 0 | 1 | B02 | - | index |
| salary | `unemployment-benefit` | 실업급여 간편 계산기 | batch2.ts | 94 | 979 | Y | 67 | 4 | 727 | 2 | 2 | 4 | - | Y | index |
| salary | `unpaid-leave-budget` | 무급휴가 급여 감소 예산 | expandedFinance.ts | 238 | 0 | - | 46 | 3 | 110 | 0 | 0 | 1 | B02 | - | index |
| salary | `weekend-pay-quick` | 휴일 근로 수당 | enrichments-ext-a.ts | 173 | 806 | Y | 98 | 4 | 690 | 2 | 2 | 3 | - | - | index |
| salary | `weekly-pay` | 주급 계산 | enrichments-ext-a.ts | 176 | 0 | Y | 50 | 3 | 392 | 0 | 0 | 3 | - | - | index |
| salary | `yearly-to-hourly` | 연봉 → 시급 환산 | enrichments-ext-a.ts | 199 | 0 | Y | 58 | 3 | 500 | 0 | 0 | 3 | - | - | index |
| loan | `bullet-loan` | 만기일시 상환 계산 | enrichments-ext-a.ts | 170 | 801 | - | 59 | 4 | 637 | 2 | 2 | 3 | - | Y | index |
| loan | `credit-line-daily-interest` | 마이너스통장 잔액 구간별 이자 | expandedFinance.ts | 231 | 0 | Y | 40 | 3 | 99 | 1 | 0 | 1 | B02 | - | index |
| loan | `debt-avalanche-vs-snowball` | 고금리 우선·소액 우선 상환 비교 | expandedFinance.ts | 240 | 0 | Y | 48 | 3 | 101 | 1 | 0 | 1 | B02 | - | index |
| loan | `debt-consolidation-payment` | 두 대출 통합 상환 비교 | expandedFinance.ts | 239 | 0 | - | 60 | 3 | 95 | 1 | 0 | 1 | B02 | - | index |
| loan | `dsr-quick` | DSR 한도 계산 | enrichments.ts | 202 | 0 | Y | 56 | 3 | 474 | 0 | 0 | 3 | - | Y | index |
| loan | `extra-payment-term` | 매달 추가 상환의 기간 단축 | expandedFinance.ts | 225 | 0 | Y | 39 | 3 | 105 | 1 | 0 | 1 | B02 | - | index |
...
| loan | `loan-balance-after-payments` | 납입 횟수별 대출 잔액 | expandedFinance.ts | 227 | 0 | - | 57 | 3 | 83 | 1 | 0 | 1 | B02 | - | index |
| loan | `loan-cashflow-effective-rate` | 선취 수수료 포함 대출 유효금리 | expandedFinance.ts | 237 | 0 | - | 54 | 3 | 126 | 1 | 0 | 1 | B02 | - | index |
| loan | `loan-interest-principal-split` | 이번 달 원금·이자 분해 | expandedFinance.ts | 234 | 0 | Y | 45 | 3 | 96 | 1 | 0 | 1 | B02 | - | index |
...
| loan | `loan-term-extension-cost` | 대출 만기 연장의 총비용 | expandedFinance.ts | 233 | 0 | - | 34 | 3 | 82 | 1 | 0 | 1 | B02 | - | index |
| loan | `loan-total-interest` | 대출 총 이자 계산 | enrichments-ext-a.ts | 178 | 767 | - | 97 | 4 | 651 | 2 | 2 | 3 | - | Y | index |
| loan | `ltv-quick` | LTV 한도 계산 | enrichments.ts | 238 | 0 | Y | 51 | 3 | 428 | 0 | 0 | 3 | - | Y | index |
| loan | `lump-sum-prepayment-term` | 목돈 중도상환의 완납 시점 | expandedFinance.ts | 232 | 0 | - | 48 | 3 | 91 | 1 | 0 | 1 | B02 | - | index |
...
| loan | `prepayment-fee-quick` | 중도상환 수수료 계산 | enrichments.ts | 246 | 0 | Y | 61 | 3 | 478 | 0 | 0 | 3 | - | - | index |
| loan | `refinance-break-even` | 대환대출 비용 회수 기간 | expandedFinance.ts | 236 | 0 | - | 40 | 3 | 116 | 1 | 0 | 1 | B02 | - | index |
| loan | `variable-rate-stress` | 대출 금리 상승 부담 점검 | expandedFinance.ts | 226 | 0 | - | 46 | 3 | 84 | 1 | 0 | 1 | B02 | - | index |
...
| real-estate | `home-maintenance-reserve` | 집수리 준비 월 적립액 계산기 | expandedPractical.ts | 255 | 0 | - | 54 | 3 | 91 | 0 | 0 | 2 | B01 | - | index |
| real-estate | `housing-affordability-quick` | 내가 살 수 있는 집값 | enrichments-ext-b.ts | 203 | 0 | Y | 112 | 3 | 415 | 0 | 0 | 3 | - | - | index |
...
| real-estate | `moving-cost-quick` | 이사 비용 추정 | enrichments-ext-b.ts | 209 | 0 | Y | 83 | 3 | 401 | 0 | 0 | 3 | - | - | index |
| real-estate | `real-estate-flip-cost` | 단기 매매 부대비용 | enrichments-ext-b.ts | 219 | 0 | Y | 113 | 3 | 401 | 0 | 0 | 3 | - | - | index |
| real-estate | `relocation-payback` | 이사 초기비용 회수기간 계산기 | expandedPractical.ts | 251 | 0 | - | 50 | 3 | 113 | 0 | 0 | 2 | B01 | - | index |
| real-estate | `renovation-budget-buffer` | 리모델링 예비비·추가공사 예산 계산기 | expandedPractical.ts | 252 | 0 | - | 58 | 3 | 104 | 0 | 0 | 2 | B01 | - | index |
| real-estate | `rent-free-effective-cost` | 렌트프리 실질 월 임대비용 계산기 | expandedPractical.ts | 244 | 0 | - | 56 | 3 | 122 | 0 | 0 | 2 | B01 | - | index |
| real-estate | `rental-prorated-rent` | 월세·관리비 일할 정산 계산기 | expandedPractical.ts | 255 | 0 | - | 50 | 3 | 103 | 0 | 0 | 2 | B01 | - | index |
| real-estate | `rental-yield` | 임대 수익률 | enrichments-ext-b.ts | 192 | 860 | Y | 35 | 4 | 593 | 2 | 2 | 3 | - | - | index |
| real-estate | `roommate-utility-share` | 동거 공과금 체류일수 분담 계산기 | expandedPractical.ts | 272 | 0 | Y | 46 | 3 | 106 | 0 | 0 | 2 | B01 | - | index |
| real-estate | `storage-unit-cost` | 보관창고 칸수·임대예산 계산기 | expandedPractical.ts | 253 | 0 | - | 53 | 3 | 88 | 0 | 0 | 2 | B01 | - | index |
| real-estate | `vacancy-carrying-cost` | 공실 유지비·놓친 임대료 계산기 | expandedPractical.ts | 248 | 0 | - | 59 | 3 | 104 | 0 | 0 | 2 | B01 | - | index |
...
| investment | `deposit-break-switch` | 예금 중도해지 후 갈아타기 비교 | expandedFinance.ts | 238 | 0 | - | 55 | 3 | 107 | 1 | 0 | 1 | B02 | - | index |
...
| investment | `emergency-fund-runway` | 현재 비상금으로 버틸 기간 | expandedFinance.ts | 231 | 840 | - | 49 | 4 | 711 | 2 | 2 | 3 | - | - | index |
| investment | `emergency-fund-target` | 생활비 기준 비상금 부족액 | expandedFinance.ts | 239 | 0 | - | 51 | 3 | 122 | 0 | 0 | 1 | B02 | - | index |
| investment | `etf-fee-impact` | ETF 운용수수료 누적 영향 | enrichments-ext-a.ts | 207 | 0 | - | 98 | 3 | 370 | 0 | 0 | 3 | - | - | index |
...
| investment | `investment-fee-break-even` | 정액·정률 투자 수수료 교차점 | expandedFinance.ts | 235 | 0 | - | 42 | 3 | 98 | 1 | 0 | 1 | B02 | - | index |
...
| investment | `savings-beginning-vs-end` | 월초·월말 적립 시점 비교 | expandedFinance.ts | 234 | 0 | - | 45 | 3 | 82 | 1 | 0 | 1 | B02 | - | index |
| investment | `savings-contribution-pause` | 저축 일시 중단의 목표 차이 | expandedFinance.ts | 234 | 0 | - | 38 | 3 | 101 | 1 | 0 | 1 | B02 | - | index |
| investment | `savings-contribution-stepup` | 매년 저축액 증액 시뮬레이션 | expandedFinance.ts | 237 | 0 | Y | 60 | 3 | 92 | 1 | 0 | 1 | B02 | - | index |
...
| investment | `savings-rate-after-raise` | 월급 인상 후 저축률 계획 | expandedFinance.ts | 229 | 958 | - | 50 | 4 | 675 | 2 | 2 | 3 | - | - | index |
| investment | `savings-required-monthly` | 목표까지 필요한 월 저축액 | expandedFinance.ts | 238 | 0 | Y | 59 | 3 | 93 | 1 | 0 | 1 | B02 | - | index |
| investment | `savings-start-delay` | 저축 시작을 미룬 기회비용 | expandedFinance.ts | 237 | 0 | - | 44 | 3 | 75 | 1 | 0 | 1 | B02 | - | index |
| investment | `savings-tax-rate-compare` | 세후 이자로 예금 조건 비교 | expandedFinance.ts | 230 | 0 | - | 33 | 3 | 107 | 1 | 0 | 1 | B02 | - | index |
| investment | `simple-interest-quick` | 단리 계산기 | enrichments-ext-a.ts | 165 | 785 | - | 42 | 4 | 698 | 2 | 2 | 3 | - | - | index |
| investment | `sinking-fund-monthly` | 연간 비정기 지출의 월 적립 | expandedFinance.ts | 233 | 0 | - | 35 | 3 | 94 | 0 | 0 | 1 | B02 | - | index |
