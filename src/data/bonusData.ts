    ...
    payouts: [
      ...
      },
      {
        ...
        note:
          ...
          "2026년분(2027년 초 지급) 현금 40%+자사주 60% 신 체계 잠정합의안은 " +
          "2026-08-25 총투표 부결(전임직 반대 50.08%·25표 차) — 노사 재협상 중",
        source:
          "SK하이닉스 사업보고서(2026-03)·한국경제 2026-08-20·머니투데이 등 2026-08-25 부결 보도 (psData.ts SOURCES)",
      },
      {
        year: 2024,
        scheme: "PI",
