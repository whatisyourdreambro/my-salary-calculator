...
<p class="lead">의료비·교육비·기부금은 모두 <strong>15% 세액공제</strong>이고 한도 구조만 다릅니다. 2026년 귀속 기준 의료비는 총급여 3%를 넘는 금액부터 공제되며 일반 부양가족분은 연 700만원 한도, 본인·6세 이하·65세 이상·장애인 의료비는 한도가 없습니다(미숙아·선천성이상아 20%, 난임시술 30%). 교육비는 본인 한도 없이, 취학 전 아동·초중고생 1명당 연 300만원, 대학생 900만원까지이고, 기부금은 1천만원을 넘는 부분에 30%를 적용하며 일반기부금은 소득금액의 30%(종교단체 기부가 있으면 10%에 추가분)가 한도입니다. 기준일은 2026년 9월 26일, 근거는 소득세법 제59조의4입니다.</p>
...
<li>일반 부양가족 의료비가 3%에 못 미치면, 모자란 금액을 본인·6세 이하·65세 이상·장애인 의료비에서 뺍니다.</li>
