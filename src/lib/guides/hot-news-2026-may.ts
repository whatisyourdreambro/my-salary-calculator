...
<li>· 2026-08-20 임단협 잠정합의안(2026년분부터 PS를 <strong>현금 40% + 자사주 60%</strong>로 지급)은 <strong>2026-08-25 조합원 총투표에서 부결</strong>되어 현재 노사가 재협상 중입니다.</li>
...
export const hotNewsMay2026: Guide[] = [
  ...
  },
  {
    ...
    description:
      "[8월 업데이트] 2025년분 PS 2,964% 확정(영업이익 47.2조)·상한 폐지. 현금 40%+자사주 60% 잠정합의안은 8/25 조합원 총투표 부결로 재협상 중 — 5월 작성 전망 글에 최신 확정치를 병기.",
    category: "연봉",
  ...
  },
  {
    ...
    description:
      "산후조리원 출산 1회당 200만원 한도 의료비 공제(소득 무관) + 출산 의료비 합산. 한계세율 24% 시 약 7만원 환급. 영수증 5년 보관 + 부부 중 총급여 낮은 쪽 공제 유리.",
    category: "세금",
