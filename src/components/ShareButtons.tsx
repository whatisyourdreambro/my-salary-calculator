...
export default function ShareButtons({
 ...
 aria-label="페이스북 공유"
 >
 <Facebook className="w-5 h-5 text-navy" fill="currentColor" />
 </motion.button>
 ...
 className="w-10 h-10 rounded-full bg-electric flex items-center justify-center shadow-lg shadow-black/30 transition-all border border-canvas"
 aria-label="트위터 공유"
 >
 <Twitter className="w-4 h-4 text-navy" fill="currentColor" />
 </motion.button>
