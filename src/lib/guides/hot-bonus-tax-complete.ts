...
<p class="lead">성과급에 국민연금 4.5% 부과? — 부분적 YES. 보수월액 상한 590만원(2026)까지만 부과. 월 보수 800만원 직원이 성과급 1억 받아도 추가 국민연금 부과 거의 없음(이미 상한 적용).</p>

<h2 class="mt-12 text-2xl font-bold text-primary">📋 2026 국민연금 상한</h2>
<ul class="space-y-2 mt-4">
<li>· 기준소득월액 상한: <strong>590만원</strong></li>
<li>· 본인 부담 4.5% × 590만 = 약 26.55만원/월</li>
<li>· 회사 부담 4.5% 동일</li>
<li>· 보수가 590만 초과해도 26.55만원 고정</li>
</ul>

<h2 class="mt-12 text-2xl font-bold text-primary">💰 성과급 영향 — 거의 없음</h2>
<p>월급 700만 직원이 성과급 5,000만 받는 경우:</p>
<ul class="space-y-2 mt-4">
<li>· 월급만으로도 이미 상한 590만 초과 → 26.55만원 매월 부과</li>
...
<p>월급 400만 직원이 한 달 성과급 200만 받으면 그 달 보수월액 600만 → 590만으로 조정 적용 → 약 9,000원 추가 부담.</p>
...
<p class="lead">성과급에 건강보험료 3.545% + 장기요양 0.459% = 본인 약 4% 부과. 국민연금과 달리 건강보험은 상한 없음. 성과급 1억 받으면 그 달 본인 건보료 약 400만원 추가 부과.</p>

<h2 class="mt-12 text-2xl font-bold text-primary">📋 건강보험료 상한 없음</h2>
<ul class="space-y-2 mt-4">
<li>· 건강보험 본인 3.545%</li>
<li>· 장기요양 건강보험의 12.95% = 약 0.459%</li>
<li>· 합산 본인 약 4.004%</li>
...
<ul class="space-y-2 mt-4">
<li>· 본인 부담: 1억 × 4.004% = <strong>약 400만원</strong></li>
<li>· 회사 부담: 동일 약 400만원</li>
<li>· 합계 800만원이 건강보험공단에 납부</li>
...
<p class="lead">4대보험 상한·하한 정리. 국민연금 보수월액 상한 590만, 건강보험 상한 없음, 고용보험 상한 없음, 산재 회사만 부담. 성과급 큰 직원에게 가장 큰 부담은 건강보험(약 4%), 그 다음 고용보험(0.9%).</p>
...
<tr class="border-t"><td class="p-3">국민연금</td><td class="p-3">4.5%</td><td class="p-3"><strong>상한 590만원</strong></td></tr>
<tr class="border-t"><td class="p-3">건강보험</td><td class="p-3">3.545%</td><td class="p-3">상한 없음</td></tr>
<tr class="border-t"><td class="p-3">장기요양</td><td class="p-3">0.459%</td><td class="p-3">상한 없음</td></tr>
...
<li>· 장기요양: 45.9만원</li>
<li>· 고용보험: 90만원</li>
<li>· <strong>합계 약 490만원</strong></li>
</ul>
...
export const hotBonusTaxComplete: Guide[] = [
  ...
  // 영역 C — 성과급 4대보험·건강보험 10편
  { slug: "bonus-pension-45-ceiling-590-2026", title: "성과급 국민연금 4.5% — 보수월액 상한 590만원 적용", description: "국민연금은 590만 상한. 월급 700만+ 직원은 성과급 받아도 국민연금 추가 부담 0원. 월급 400만 직원이 성과급 200만 받으면 9,000원 추가.", category: "기초", tags: ["국민연금", "성과급", "상한", "590만", "2026"], level: "초급", publishedDate: "2026-05-23", views: 0, content: bonusPension45, lang: "ko" },
  { slug: "bonus-health-4-percent-2026", title: "성과급 건강보험 4% — 상한 없음, 1억 시 본인 400만원", description: "건강보험 3.545% + 장기요양 0.459% = 본인 4.004%. 상한 없음. 성과급 1억 시 본인 400만 + 회사 400만 = 800만 부과. 7월 정산 추가.", category: "기초", tags: ["건강보험", "성과급", "장기요양", "정산", "2026"], level: "초급", publishedDate: "2026-05-23", views: 0, content: bonusHealth3545, lang: "ko" },
  ...
  { slug: "four-insurance-ceiling-summary-2026", title: "4대보험 상한·하한 한 번에 — 성과급 1억 시 본인 부담 490만", description: "국민연금 4.5% 상한 590만 + 건강보험 3.545% + 장기요양 0.459% + 고용보험 0.9%. 성과급 1억 시 합산 본인 부담 약 490만원.", category: "기초", tags: ["4대보험", "상한", "성과급", "건강보험", "2026"], level: "중급", publishedDate: "2026-05-23", views: 0, content: bonusInsuranceCeiling, lang: "ko" },
